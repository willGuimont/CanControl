...
bool spark_decode_STATUS_9(const uint8_t* data, uint8_t dlc, Spark_STATUS_9_t* out) {
    ...
    union { uint32_t u; float f; } _MAXMOTION_POSITION_SETPOINT = { .u = _MAXMOTION_POSITION_SETPOINT_u };
    ...
    union { uint32_t u; float f; } _MAXMOTION_VELOCITY_SETPOINT = { .u = _MAXMOTION_VELOCITY_SETPOINT_u };
