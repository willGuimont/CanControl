...
namespace CanControl::LowLevel::SparkMax
{
    ...
    // Build frame payload for Smart Velocity Setpoint: Sets the Control Type to Smart Velocity and sets the target
    // velocity
    spark_can_frame spark_build_SMART_VELOCITY_SETPOINT(uint8_t                                device_id,
                                                        const Spark_SMART_VELOCITY_SETPOINT_t* values)
    {
        spark_can_frame out{};
    ...
    SparkCanDevice::SparkCanDevice(uint8_t device_id)
        : device_id_(device_id & SPARK_DEVICE_ID_MASK), controller_(nullptr)
    {
    }

    SparkCanDevice::SparkCanDevice(MCP2515& controller, uint8_t device_id)
        : device_id_(device_id & SPARK_DEVICE_ID_MASK), controller_(&controller)
    {
    }
    ...
    // Build frame for Velocity Setpoint: Sets the Control Type to Velocity and sets the target velocity using current
    // device_id_
    ...
    // Build frame for Smart Velocity Setpoint: Sets the Control Type to Smart Velocity and sets the target velocity
    // using current device_id_
    ...
    // Build frame for Position Setpoint: Sets the Control Type to Position and sets the target position using current
    // device_id_
    ...
    // Build frame for Voltage Setpoint: Sets the Control Type to Voltage and sets the target voltage using current
    // device_id_
    ...
    // Build frame for Current Setpoint: Sets the Control Type to Current and sets the target current using current
    // device_id_
    ...
    // Build frame for Smart Motion Setpoint: Sets the Control Type to Smart Motion and sets the target position using
    // current device_id_
    ...
    // target position using current device_id_
    spark_can_frame
    SparkCanDevice::build_MAXMOTION_POSITION_SETPOINT(const Spark_MAXMOTION_POSITION_SETPOINT_t* values) const
    {
    ...
    // target velocity using current device_id_
    spark_can_frame
    SparkCanDevice::build_MAXMOTION_VELOCITY_SETPOINT(const Spark_MAXMOTION_VELOCITY_SETPOINT_t* values) const
    {
    ...
    // Response frame will be sent. using current device_id_
    ...
    // Build frame for Set Statuses Enabled Response: Response for a Set Statuses Enabled command using current
    // device_id_
    spark_can_frame
    SparkCanDevice::build_SET_STATUSES_ENABLED_RESPONSE(const Spark_SET_STATUSES_ENABLED_RESPONSE_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_PERSIST_PARAMETERS_RESPONSE(const Spark_PERSIST_PARAMETERS_RESPONSE_t* values) const
    {
    ...
    // frame is sent. using current device_id_
    ...
    // Build frame for Reset Safe Parameters Response: Response for a Reset Safe Parameters command using current
    // device_id_
    spark_can_frame
    SparkCanDevice::build_RESET_SAFE_PARAMETERS_RESPONSE(const Spark_RESET_SAFE_PARAMETERS_RESPONSE_t* values) const
    {
    ...
    // is sent. using current device_id_
    ...
    // Build frame for Complete Factory Reset Response: Response for a Complete Factory Reset command using current
    // device_id_
    spark_can_frame
    SparkCanDevice::build_COMPLETE_FACTORY_RESET_RESPONSE(const Spark_COMPLETE_FACTORY_RESET_RESPONSE_t* values) const
    {
    ...
    // have the same CAN ID) temporarily perform a special blink pattern that will make it stand out using current
    // device_id_
    ...
    // out. Use Identify Unique Device if there may be multiple SPARKs with the same CAN ID. using current device_id_
    ...
    // CAN ID using current device_id_
    ...
    // CAN ID. Under normal circumstances, the CAN ID parameter can be used. using current device_id_
    ...
    // full firmware image that was just sent using current device_id_
    ...
    // not match the firmware data they received using current device_id_
    ...
    spark_can_frame
    SparkCanDevice::build_SET_PRIMARY_ENCODER_POSITION(const Spark_SET_PRIMARY_ENCODER_POSITION_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_SET_EXT_OR_ALT_ENCODER_POSITION(const Spark_SET_EXT_OR_ALT_ENCODER_POSITION_t* values) const
    {
    ...
    // when the SPARK is not locked to the Universal Heartbeat or Primary Heartbeat using current device_id_
    ...
    // This has no relation to the normal Identify command, which displays an LED pattern. using current device_id_
    ...
    // command is received directly via USB using current device_id_
    spark_can_frame
    SparkCanDevice::build_USB_ONLY_ENTER_DFU_BOOTLOADER(const Spark_USB_ONLY_ENTER_DFU_BOOTLOADER_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_0_TO_15_TYPES(const Spark_GET_PARAMETER_0_TO_15_TYPES_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_16_TO_31_TYPES(const Spark_GET_PARAMETER_16_TO_31_TYPES_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_32_TO_47_TYPES(const Spark_GET_PARAMETER_32_TO_47_TYPES_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_48_TO_63_TYPES(const Spark_GET_PARAMETER_48_TO_63_TYPES_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_64_TO_79_TYPES(const Spark_GET_PARAMETER_64_TO_79_TYPES_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_80_TO_95_TYPES(const Spark_GET_PARAMETER_80_TO_95_TYPES_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_96_TO_111_TYPES(const Spark_GET_PARAMETER_96_TO_111_TYPES_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_112_TO_127_TYPES(const Spark_GET_PARAMETER_112_TO_127_TYPES_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_128_TO_143_TYPES(const Spark_GET_PARAMETER_128_TO_143_TYPES_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_144_TO_159_TYPES(const Spark_GET_PARAMETER_144_TO_159_TYPES_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_160_TO_175_TYPES(const Spark_GET_PARAMETER_160_TO_175_TYPES_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_176_TO_191_TYPES(const Spark_GET_PARAMETER_176_TO_191_TYPES_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_192_TO_207_TYPES(const Spark_GET_PARAMETER_192_TO_207_TYPES_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_208_TO_223_TYPES(const Spark_GET_PARAMETER_208_TO_223_TYPES_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_224_TO_239_TYPES(const Spark_GET_PARAMETER_224_TO_239_TYPES_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_GET_PARAMETER_240_TO_255_TYPES(const Spark_GET_PARAMETER_240_TO_255_TYPES_t* values) const
    {
    ...
    // will be sent. using current device_id_
    ...
    // dual-write) using current device_id_
    ...
    // support this in v25.0.0-prerelease.4 using current device_id_
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_100_AND_101(const Spark_READ_PARAMETER_100_AND_101_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_102_AND_103(const Spark_READ_PARAMETER_102_AND_103_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_104_AND_105(const Spark_READ_PARAMETER_104_AND_105_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_106_AND_107(const Spark_READ_PARAMETER_106_AND_107_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_108_AND_109(const Spark_READ_PARAMETER_108_AND_109_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_110_AND_111(const Spark_READ_PARAMETER_110_AND_111_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_112_AND_113(const Spark_READ_PARAMETER_112_AND_113_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_114_AND_115(const Spark_READ_PARAMETER_114_AND_115_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_116_AND_117(const Spark_READ_PARAMETER_116_AND_117_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_118_AND_119(const Spark_READ_PARAMETER_118_AND_119_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_120_AND_121(const Spark_READ_PARAMETER_120_AND_121_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_122_AND_123(const Spark_READ_PARAMETER_122_AND_123_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_124_AND_125(const Spark_READ_PARAMETER_124_AND_125_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_126_AND_127(const Spark_READ_PARAMETER_126_AND_127_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_128_AND_129(const Spark_READ_PARAMETER_128_AND_129_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_130_AND_131(const Spark_READ_PARAMETER_130_AND_131_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_132_AND_133(const Spark_READ_PARAMETER_132_AND_133_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_134_AND_135(const Spark_READ_PARAMETER_134_AND_135_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_136_AND_137(const Spark_READ_PARAMETER_136_AND_137_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_138_AND_139(const Spark_READ_PARAMETER_138_AND_139_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_140_AND_141(const Spark_READ_PARAMETER_140_AND_141_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_142_AND_143(const Spark_READ_PARAMETER_142_AND_143_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_144_AND_145(const Spark_READ_PARAMETER_144_AND_145_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_146_AND_147(const Spark_READ_PARAMETER_146_AND_147_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_148_AND_149(const Spark_READ_PARAMETER_148_AND_149_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_150_AND_151(const Spark_READ_PARAMETER_150_AND_151_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_152_AND_153(const Spark_READ_PARAMETER_152_AND_153_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_154_AND_155(const Spark_READ_PARAMETER_154_AND_155_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_156_AND_157(const Spark_READ_PARAMETER_156_AND_157_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_158_AND_159(const Spark_READ_PARAMETER_158_AND_159_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_160_AND_161(const Spark_READ_PARAMETER_160_AND_161_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_162_AND_163(const Spark_READ_PARAMETER_162_AND_163_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_164_AND_165(const Spark_READ_PARAMETER_164_AND_165_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_166_AND_167(const Spark_READ_PARAMETER_166_AND_167_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_168_AND_169(const Spark_READ_PARAMETER_168_AND_169_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_170_AND_171(const Spark_READ_PARAMETER_170_AND_171_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_172_AND_173(const Spark_READ_PARAMETER_172_AND_173_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_174_AND_175(const Spark_READ_PARAMETER_174_AND_175_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_176_AND_177(const Spark_READ_PARAMETER_176_AND_177_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_178_AND_179(const Spark_READ_PARAMETER_178_AND_179_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_180_AND_181(const Spark_READ_PARAMETER_180_AND_181_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_182_AND_183(const Spark_READ_PARAMETER_182_AND_183_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_184_AND_185(const Spark_READ_PARAMETER_184_AND_185_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_186_AND_187(const Spark_READ_PARAMETER_186_AND_187_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_188_AND_189(const Spark_READ_PARAMETER_188_AND_189_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_190_AND_191(const Spark_READ_PARAMETER_190_AND_191_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_192_AND_193(const Spark_READ_PARAMETER_192_AND_193_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_194_AND_195(const Spark_READ_PARAMETER_194_AND_195_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_196_AND_197(const Spark_READ_PARAMETER_196_AND_197_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_198_AND_199(const Spark_READ_PARAMETER_198_AND_199_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_200_AND_201(const Spark_READ_PARAMETER_200_AND_201_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_202_AND_203(const Spark_READ_PARAMETER_202_AND_203_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_204_AND_205(const Spark_READ_PARAMETER_204_AND_205_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_206_AND_207(const Spark_READ_PARAMETER_206_AND_207_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_208_AND_209(const Spark_READ_PARAMETER_208_AND_209_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_210_AND_211(const Spark_READ_PARAMETER_210_AND_211_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_212_AND_213(const Spark_READ_PARAMETER_212_AND_213_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_214_AND_215(const Spark_READ_PARAMETER_214_AND_215_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_216_AND_217(const Spark_READ_PARAMETER_216_AND_217_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_218_AND_219(const Spark_READ_PARAMETER_218_AND_219_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_220_AND_221(const Spark_READ_PARAMETER_220_AND_221_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_222_AND_223(const Spark_READ_PARAMETER_222_AND_223_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_224_AND_225(const Spark_READ_PARAMETER_224_AND_225_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_226_AND_227(const Spark_READ_PARAMETER_226_AND_227_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_228_AND_229(const Spark_READ_PARAMETER_228_AND_229_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_230_AND_231(const Spark_READ_PARAMETER_230_AND_231_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_232_AND_233(const Spark_READ_PARAMETER_232_AND_233_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_234_AND_235(const Spark_READ_PARAMETER_234_AND_235_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_236_AND_237(const Spark_READ_PARAMETER_236_AND_237_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_238_AND_239(const Spark_READ_PARAMETER_238_AND_239_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_240_AND_241(const Spark_READ_PARAMETER_240_AND_241_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_242_AND_243(const Spark_READ_PARAMETER_242_AND_243_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_244_AND_245(const Spark_READ_PARAMETER_244_AND_245_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_246_AND_247(const Spark_READ_PARAMETER_246_AND_247_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_248_AND_249(const Spark_READ_PARAMETER_248_AND_249_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_250_AND_251(const Spark_READ_PARAMETER_250_AND_251_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_252_AND_253(const Spark_READ_PARAMETER_252_AND_253_t* values) const
    {
    ...
    // currently support this in v25.0.0-prerelease.4 using current device_id_
    spark_can_frame
    SparkCanDevice::build_READ_PARAMETER_254_AND_255(const Spark_READ_PARAMETER_254_AND_255_t* values) const
    {
    ...
    // frames will be sent in response. using current device_id_
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_10_AND_11(const Spark_WRITE_PARAMETER_10_AND_11_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_12_AND_13(const Spark_WRITE_PARAMETER_12_AND_13_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_14_AND_15(const Spark_WRITE_PARAMETER_14_AND_15_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_16_AND_17(const Spark_WRITE_PARAMETER_16_AND_17_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_18_AND_19(const Spark_WRITE_PARAMETER_18_AND_19_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_20_AND_21(const Spark_WRITE_PARAMETER_20_AND_21_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_22_AND_23(const Spark_WRITE_PARAMETER_22_AND_23_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_24_AND_25(const Spark_WRITE_PARAMETER_24_AND_25_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_26_AND_27(const Spark_WRITE_PARAMETER_26_AND_27_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_28_AND_29(const Spark_WRITE_PARAMETER_28_AND_29_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_30_AND_31(const Spark_WRITE_PARAMETER_30_AND_31_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_32_AND_33(const Spark_WRITE_PARAMETER_32_AND_33_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_34_AND_35(const Spark_WRITE_PARAMETER_34_AND_35_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_36_AND_37(const Spark_WRITE_PARAMETER_36_AND_37_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_38_AND_39(const Spark_WRITE_PARAMETER_38_AND_39_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_40_AND_41(const Spark_WRITE_PARAMETER_40_AND_41_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_42_AND_43(const Spark_WRITE_PARAMETER_42_AND_43_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_44_AND_45(const Spark_WRITE_PARAMETER_44_AND_45_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_46_AND_47(const Spark_WRITE_PARAMETER_46_AND_47_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_48_AND_49(const Spark_WRITE_PARAMETER_48_AND_49_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_50_AND_51(const Spark_WRITE_PARAMETER_50_AND_51_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_52_AND_53(const Spark_WRITE_PARAMETER_52_AND_53_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_54_AND_55(const Spark_WRITE_PARAMETER_54_AND_55_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_56_AND_57(const Spark_WRITE_PARAMETER_56_AND_57_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_58_AND_59(const Spark_WRITE_PARAMETER_58_AND_59_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_60_AND_61(const Spark_WRITE_PARAMETER_60_AND_61_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_62_AND_63(const Spark_WRITE_PARAMETER_62_AND_63_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_64_AND_65(const Spark_WRITE_PARAMETER_64_AND_65_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_66_AND_67(const Spark_WRITE_PARAMETER_66_AND_67_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_68_AND_69(const Spark_WRITE_PARAMETER_68_AND_69_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_70_AND_71(const Spark_WRITE_PARAMETER_70_AND_71_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_72_AND_73(const Spark_WRITE_PARAMETER_72_AND_73_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_74_AND_75(const Spark_WRITE_PARAMETER_74_AND_75_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_76_AND_77(const Spark_WRITE_PARAMETER_76_AND_77_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_78_AND_79(const Spark_WRITE_PARAMETER_78_AND_79_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_80_AND_81(const Spark_WRITE_PARAMETER_80_AND_81_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_82_AND_83(const Spark_WRITE_PARAMETER_82_AND_83_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_84_AND_85(const Spark_WRITE_PARAMETER_84_AND_85_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_86_AND_87(const Spark_WRITE_PARAMETER_86_AND_87_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_88_AND_89(const Spark_WRITE_PARAMETER_88_AND_89_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_90_AND_91(const Spark_WRITE_PARAMETER_90_AND_91_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_92_AND_93(const Spark_WRITE_PARAMETER_92_AND_93_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_94_AND_95(const Spark_WRITE_PARAMETER_94_AND_95_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_96_AND_97(const Spark_WRITE_PARAMETER_96_AND_97_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_98_AND_99(const Spark_WRITE_PARAMETER_98_AND_99_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_100_AND_101(const Spark_WRITE_PARAMETER_100_AND_101_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_102_AND_103(const Spark_WRITE_PARAMETER_102_AND_103_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_104_AND_105(const Spark_WRITE_PARAMETER_104_AND_105_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_106_AND_107(const Spark_WRITE_PARAMETER_106_AND_107_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_108_AND_109(const Spark_WRITE_PARAMETER_108_AND_109_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_110_AND_111(const Spark_WRITE_PARAMETER_110_AND_111_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_112_AND_113(const Spark_WRITE_PARAMETER_112_AND_113_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_114_AND_115(const Spark_WRITE_PARAMETER_114_AND_115_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_116_AND_117(const Spark_WRITE_PARAMETER_116_AND_117_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_118_AND_119(const Spark_WRITE_PARAMETER_118_AND_119_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_120_AND_121(const Spark_WRITE_PARAMETER_120_AND_121_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_122_AND_123(const Spark_WRITE_PARAMETER_122_AND_123_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_124_AND_125(const Spark_WRITE_PARAMETER_124_AND_125_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_126_AND_127(const Spark_WRITE_PARAMETER_126_AND_127_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_128_AND_129(const Spark_WRITE_PARAMETER_128_AND_129_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_130_AND_131(const Spark_WRITE_PARAMETER_130_AND_131_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_132_AND_133(const Spark_WRITE_PARAMETER_132_AND_133_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_134_AND_135(const Spark_WRITE_PARAMETER_134_AND_135_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_136_AND_137(const Spark_WRITE_PARAMETER_136_AND_137_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_138_AND_139(const Spark_WRITE_PARAMETER_138_AND_139_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_140_AND_141(const Spark_WRITE_PARAMETER_140_AND_141_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_142_AND_143(const Spark_WRITE_PARAMETER_142_AND_143_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_144_AND_145(const Spark_WRITE_PARAMETER_144_AND_145_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_146_AND_147(const Spark_WRITE_PARAMETER_146_AND_147_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_148_AND_149(const Spark_WRITE_PARAMETER_148_AND_149_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_150_AND_151(const Spark_WRITE_PARAMETER_150_AND_151_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_152_AND_153(const Spark_WRITE_PARAMETER_152_AND_153_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_154_AND_155(const Spark_WRITE_PARAMETER_154_AND_155_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_156_AND_157(const Spark_WRITE_PARAMETER_156_AND_157_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_158_AND_159(const Spark_WRITE_PARAMETER_158_AND_159_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_160_AND_161(const Spark_WRITE_PARAMETER_160_AND_161_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_162_AND_163(const Spark_WRITE_PARAMETER_162_AND_163_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_164_AND_165(const Spark_WRITE_PARAMETER_164_AND_165_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_166_AND_167(const Spark_WRITE_PARAMETER_166_AND_167_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_168_AND_169(const Spark_WRITE_PARAMETER_168_AND_169_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_170_AND_171(const Spark_WRITE_PARAMETER_170_AND_171_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_172_AND_173(const Spark_WRITE_PARAMETER_172_AND_173_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_174_AND_175(const Spark_WRITE_PARAMETER_174_AND_175_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_176_AND_177(const Spark_WRITE_PARAMETER_176_AND_177_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_178_AND_179(const Spark_WRITE_PARAMETER_178_AND_179_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_180_AND_181(const Spark_WRITE_PARAMETER_180_AND_181_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_182_AND_183(const Spark_WRITE_PARAMETER_182_AND_183_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_184_AND_185(const Spark_WRITE_PARAMETER_184_AND_185_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_186_AND_187(const Spark_WRITE_PARAMETER_186_AND_187_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_188_AND_189(const Spark_WRITE_PARAMETER_188_AND_189_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_190_AND_191(const Spark_WRITE_PARAMETER_190_AND_191_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_192_AND_193(const Spark_WRITE_PARAMETER_192_AND_193_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_194_AND_195(const Spark_WRITE_PARAMETER_194_AND_195_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_196_AND_197(const Spark_WRITE_PARAMETER_196_AND_197_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_198_AND_199(const Spark_WRITE_PARAMETER_198_AND_199_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_200_AND_201(const Spark_WRITE_PARAMETER_200_AND_201_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_202_AND_203(const Spark_WRITE_PARAMETER_202_AND_203_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_204_AND_205(const Spark_WRITE_PARAMETER_204_AND_205_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_206_AND_207(const Spark_WRITE_PARAMETER_206_AND_207_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_208_AND_209(const Spark_WRITE_PARAMETER_208_AND_209_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_210_AND_211(const Spark_WRITE_PARAMETER_210_AND_211_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_212_AND_213(const Spark_WRITE_PARAMETER_212_AND_213_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_214_AND_215(const Spark_WRITE_PARAMETER_214_AND_215_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_216_AND_217(const Spark_WRITE_PARAMETER_216_AND_217_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_218_AND_219(const Spark_WRITE_PARAMETER_218_AND_219_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_220_AND_221(const Spark_WRITE_PARAMETER_220_AND_221_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_222_AND_223(const Spark_WRITE_PARAMETER_222_AND_223_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_224_AND_225(const Spark_WRITE_PARAMETER_224_AND_225_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_226_AND_227(const Spark_WRITE_PARAMETER_226_AND_227_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_228_AND_229(const Spark_WRITE_PARAMETER_228_AND_229_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_230_AND_231(const Spark_WRITE_PARAMETER_230_AND_231_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_232_AND_233(const Spark_WRITE_PARAMETER_232_AND_233_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_234_AND_235(const Spark_WRITE_PARAMETER_234_AND_235_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_236_AND_237(const Spark_WRITE_PARAMETER_236_AND_237_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_238_AND_239(const Spark_WRITE_PARAMETER_238_AND_239_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_240_AND_241(const Spark_WRITE_PARAMETER_240_AND_241_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_242_AND_243(const Spark_WRITE_PARAMETER_242_AND_243_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_244_AND_245(const Spark_WRITE_PARAMETER_244_AND_245_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_246_AND_247(const Spark_WRITE_PARAMETER_246_AND_247_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_248_AND_249(const Spark_WRITE_PARAMETER_248_AND_249_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_250_AND_251(const Spark_WRITE_PARAMETER_250_AND_251_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_252_AND_253(const Spark_WRITE_PARAMETER_252_AND_253_t* values) const
    {
    ...
    // Response frames will be sent in response. using current device_id_
    spark_can_frame
    SparkCanDevice::build_WRITE_PARAMETER_254_AND_255(const Spark_WRITE_PARAMETER_254_AND_255_t* values) const
    {
    ...
    // Follower Mode Leader ID parameter is set to a non-zero value. using current device_id_
    ...
    spark_can_frame
    SparkCanDevice::build_START_FOLLOWER_MODE_RESPONSE(const Spark_START_FOLLOWER_MODE_RESPONSE_t* values) const
    {
    ...
    // addressed directly to it. In response, a Stop Follower Mode Response frame will be sent. using current device_id_
    ...
    spark_can_frame
    SparkCanDevice::build_STOP_FOLLOWER_MODE_RESPONSE(const Spark_STOP_FOLLOWER_MODE_RESPONSE_t* values) const
    {
    ...
    spark_can_frame
    SparkCanDevice::build_ENTER_SWDL_CAN_BOOTLOADER(const Spark_ENTER_SWDL_CAN_BOOTLOADER_t* values) const
    {
    ...
    // operation (which may take up to a second) completes, a Persist Parameters Response frame will be sent. using
    // current device_id_
    ...
    // Build and send Velocity Setpoint: Sets the Control Type to Velocity and sets the target velocity via MCP2515
    // controller
    ...
    // Build and send Duty Cycle Setpoint: Sets the Control Type to Duty Cycle and sets the target duty cycle (from -1
    // to 1) via MCP2515 controller
    ...
    // Build and send Smart Velocity Setpoint: Sets the Control Type to Smart Velocity and sets the target velocity via
    // MCP2515 controller
    ...
    // Build and send Position Setpoint: Sets the Control Type to Position and sets the target position via MCP2515
    // controller
    ...
    // Build and send Voltage Setpoint: Sets the Control Type to Voltage and sets the target voltage via MCP2515
    // controller
    ...
    // Build and send Current Setpoint: Sets the Control Type to Current and sets the target current via MCP2515
    // controller
    ...
    // Build and send Smart Motion Setpoint: Sets the Control Type to Smart Motion and sets the target position via
    // MCP2515 controller
    ...
    // Build and send MAXMotion Position Setpoint: Sets the Control Type to MAXMotion Position Control and sets the
    // target position via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_maxmotion_position_setpoint(const Spark_MAXMOTION_POSITION_SETPOINT_t* values) const
    {
        return dispatch_frame(spark_build_MAXMOTION_POSITION_SETPOINT(device_id_, values));
    }

    // Build and send MAXMotion Velocity Setpoint: Sets the Control Type to MAXMotion Velocity Control and sets the
    // target velocity via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_maxmotion_velocity_setpoint(const Spark_MAXMOTION_VELOCITY_SETPOINT_t* values) const
    {
        return dispatch_frame(spark_build_MAXMOTION_VELOCITY_SETPOINT(device_id_, values));
    }

    // Build and send Set Statuses Enabled: Enable or disable status frames. In response, a Set Statuses Enabled
    // Response frame will be sent. via MCP2515 controller
    ...
    MCP2515::ERROR
    SparkCanDevice::send_set_statuses_enabled_response(const Spark_SET_STATUSES_ENABLED_RESPONSE_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_persist_parameters_response(const Spark_PERSIST_PARAMETERS_RESPONSE_t* values) const
    {
        return dispatch_frame(spark_build_PERSIST_PARAMETERS_RESPONSE(device_id_, values));
    }

    // Build and send Reset Safe Parameters: Resets most writable parameters to their default values, except CAN ID,
    // Motor Type, Idle Mode, PWM Input Deadband, and Duty Cycle Offset. In response, a Reset Safe Parameters Response
    // frame is sent. via MCP2515 controller
    ...
    // Build and send Reset Safe Parameters Response: Response for a Reset Safe Parameters command via MCP2515
    // controller
    MCP2515::ERROR
    SparkCanDevice::send_reset_safe_parameters_response(const Spark_RESET_SAFE_PARAMETERS_RESPONSE_t* values) const
    {
        return dispatch_frame(spark_build_RESET_SAFE_PARAMETERS_RESPONSE(device_id_, values));
    }

    // Build and send Complete Factory Reset: Resets all writable parameters to default values, even CAN ID, Motor Type,
    // Idle Mode, PWM Input Deadband, and Duty Cycle Offset. In response, a Complete Factory Reset Response frame is
    // sent. via MCP2515 controller
    ...
    // Build and send Complete Factory Reset Response: Response for a Complete Factory Reset command via MCP2515
    // controller
    MCP2515::ERROR
    SparkCanDevice::send_complete_factory_reset_response(const Spark_COMPLETE_FACTORY_RESET_RESPONSE_t* values) const
    {
    ...
    // Build and send Identify Unique SPARK: Makes the specified, single SPARK (even if there are multiple SPARKs that
    // have the same CAN ID) temporarily perform a special blink pattern that will make it stand out via MCP2515
    // controller
    ...
    // Build and send Identify: Makes the SPARK temporarily perform a special blink pattern that will make it stand out.
    // Use Identify Unique Device if there may be multiple SPARKs with the same CAN ID. via MCP2515 controller
    ...
    // Build and send Nack: As of SPARK MAX firmware 1.6.3, this is only used as a potential response to setting the CAN
    // ID via MCP2515 controller
    ...
    // Build and send Ack: As of SPARK MAX firmware 1.6.3, this is only used as a potential response to setting the CAN
    // ID via MCP2515 controller
    ...
    // Build and send Set CAN ID: Allows changing the CAN ID when multiple devices on the bus currently have the same
    // CAN ID. Under normal circumstances, the CAN ID parameter can be used. via MCP2515 controller
    ...
    // Build and send SWDL Data: Broadcast from the host to all SPARKs in SWDL mode, containing a slice of firmware data
    // via MCP2515 controller
    ...
    // Build and send SWDL Checksum: Broadcast from the host to all SPARKs in SWDL mode, containing the checksum of the
    // full firmware image that was just sent via MCP2515 controller
    ...
    // Build and send SWDL Retransmit: Sent by SPARK devices in response to receiving an SWDL Checksum frame that does
    // not match the firmware data they received via MCP2515 controller
    ...
    MCP2515::ERROR
    SparkCanDevice::send_set_primary_encoder_position(const Spark_SET_PRIMARY_ENCODER_POSITION_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_set_ext_or_alt_encoder_position(const Spark_SET_EXT_OR_ALT_ENCODER_POSITION_t* values) const
    {
    ...
    // Build and send Secondary Heartbeat: Heartbeat that allows enabling only specific SPARKs, but only gets respected
    // when the SPARK is not locked to the Universal Heartbeat or Primary Heartbeat via MCP2515 controller
    ...
    // Build and send USB Only Identify: The response will only be sent if this command is received directly via USB.
    // This has no relation to the normal Identify command, which displays an LED pattern. via MCP2515 controller
    ...
    // Build and send USB Only Enter DFU Bootloader: Causes the device to reboot into the DFU bootloader if this command
    // is received directly via USB via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_usb_only_enter_dfu_bootloader(const Spark_USB_ONLY_ENTER_DFU_BOOTLOADER_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_0_to_15_types(const Spark_GET_PARAMETER_0_TO_15_TYPES_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_16_to_31_types(const Spark_GET_PARAMETER_16_TO_31_TYPES_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_32_to_47_types(const Spark_GET_PARAMETER_32_TO_47_TYPES_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_48_to_63_types(const Spark_GET_PARAMETER_48_TO_63_TYPES_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_64_to_79_types(const Spark_GET_PARAMETER_64_TO_79_TYPES_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_80_to_95_types(const Spark_GET_PARAMETER_80_TO_95_TYPES_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_96_to_111_types(const Spark_GET_PARAMETER_96_TO_111_TYPES_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_112_to_127_types(const Spark_GET_PARAMETER_112_TO_127_TYPES_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_128_to_143_types(const Spark_GET_PARAMETER_128_TO_143_TYPES_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_144_to_159_types(const Spark_GET_PARAMETER_144_TO_159_TYPES_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_160_to_175_types(const Spark_GET_PARAMETER_160_TO_175_TYPES_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_176_to_191_types(const Spark_GET_PARAMETER_176_TO_191_TYPES_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_192_to_207_types(const Spark_GET_PARAMETER_192_TO_207_TYPES_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_208_to_223_types(const Spark_GET_PARAMETER_208_TO_223_TYPES_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_224_to_239_types(const Spark_GET_PARAMETER_224_TO_239_TYPES_t* values) const
    {
    ...
    MCP2515::ERROR
    SparkCanDevice::send_get_parameter_240_to_255_types(const Spark_GET_PARAMETER_240_TO_255_TYPES_t* values) const
    {
        return dispatch_frame(spark_build_GET_PARAMETER_240_TO_255_TYPES(device_id_, values));
    }

    // Build and send Parameter Write: Write a single parameter value. In response, a Parameter Write Response frame
    // will be sent. via MCP2515 controller
    ...
    // Build and send Parameter Write Response: Response for a parameter write (including a write done as part of a
    // dual-write) via MCP2515 controller
    ...
    // Build and send Read Parameter 0 and 1: Read parameter 0 and 1 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 2 and 3: Read parameter 2 and 3 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 4 and 5: Read parameter 4 and 5 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 6 and 7: Read parameter 6 and 7 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 8 and 9: Read parameter 8 and 9 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 10 and 11: Read parameter 10 and 11 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 12 and 13: Read parameter 12 and 13 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 14 and 15: Read parameter 14 and 15 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 16 and 17: Read parameter 16 and 17 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 18 and 19: Read parameter 18 and 19 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 20 and 21: Read parameter 20 and 21 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 22 and 23: Read parameter 22 and 23 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 24 and 25: Read parameter 24 and 25 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 26 and 27: Read parameter 26 and 27 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 28 and 29: Read parameter 28 and 29 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 30 and 31: Read parameter 30 and 31 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 32 and 33: Read parameter 32 and 33 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 34 and 35: Read parameter 34 and 35 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 36 and 37: Read parameter 36 and 37 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 38 and 39: Read parameter 38 and 39 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 40 and 41: Read parameter 40 and 41 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 42 and 43: Read parameter 42 and 43 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 44 and 45: Read parameter 44 and 45 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 46 and 47: Read parameter 46 and 47 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 48 and 49: Read parameter 48 and 49 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 50 and 51: Read parameter 50 and 51 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 52 and 53: Read parameter 52 and 53 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 54 and 55: Read parameter 54 and 55 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 56 and 57: Read parameter 56 and 57 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 58 and 59: Read parameter 58 and 59 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 60 and 61: Read parameter 60 and 61 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 62 and 63: Read parameter 62 and 63 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 64 and 65: Read parameter 64 and 65 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 66 and 67: Read parameter 66 and 67 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 68 and 69: Read parameter 68 and 69 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 70 and 71: Read parameter 70 and 71 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 72 and 73: Read parameter 72 and 73 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 74 and 75: Read parameter 74 and 75 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 76 and 77: Read parameter 76 and 77 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 78 and 79: Read parameter 78 and 79 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 80 and 81: Read parameter 80 and 81 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 82 and 83: Read parameter 82 and 83 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 84 and 85: Read parameter 84 and 85 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 86 and 87: Read parameter 86 and 87 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 88 and 89: Read parameter 88 and 89 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 90 and 91: Read parameter 90 and 91 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 92 and 93: Read parameter 92 and 93 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 94 and 95: Read parameter 94 and 95 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 96 and 97: Read parameter 96 and 97 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 98 and 99: Read parameter 98 and 99 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4 via MCP2515 controller
    ...
    // Build and send Read Parameter 100 and 101: Read parameter 100 and 101 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_100_and_101(const Spark_READ_PARAMETER_100_AND_101_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_100_AND_101(device_id_, values));
    }

    // Build and send Read Parameter 102 and 103: Read parameter 102 and 103 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_102_and_103(const Spark_READ_PARAMETER_102_AND_103_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_102_AND_103(device_id_, values));
    }

    // Build and send Read Parameter 104 and 105: Read parameter 104 and 105 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_104_and_105(const Spark_READ_PARAMETER_104_AND_105_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_104_AND_105(device_id_, values));
    }

    // Build and send Read Parameter 106 and 107: Read parameter 106 and 107 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_106_and_107(const Spark_READ_PARAMETER_106_AND_107_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_106_AND_107(device_id_, values));
    }

    // Build and send Read Parameter 108 and 109: Read parameter 108 and 109 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_108_and_109(const Spark_READ_PARAMETER_108_AND_109_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_108_AND_109(device_id_, values));
    }

    // Build and send Read Parameter 110 and 111: Read parameter 110 and 111 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_110_and_111(const Spark_READ_PARAMETER_110_AND_111_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_110_AND_111(device_id_, values));
    }

    // Build and send Read Parameter 112 and 113: Read parameter 112 and 113 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_112_and_113(const Spark_READ_PARAMETER_112_AND_113_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_112_AND_113(device_id_, values));
    }

    // Build and send Read Parameter 114 and 115: Read parameter 114 and 115 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_114_and_115(const Spark_READ_PARAMETER_114_AND_115_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_114_AND_115(device_id_, values));
    }

    // Build and send Read Parameter 116 and 117: Read parameter 116 and 117 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_116_and_117(const Spark_READ_PARAMETER_116_AND_117_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_116_AND_117(device_id_, values));
    }

    // Build and send Read Parameter 118 and 119: Read parameter 118 and 119 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_118_and_119(const Spark_READ_PARAMETER_118_AND_119_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_118_AND_119(device_id_, values));
    }

    // Build and send Read Parameter 120 and 121: Read parameter 120 and 121 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_120_and_121(const Spark_READ_PARAMETER_120_AND_121_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_120_AND_121(device_id_, values));
    }

    // Build and send Read Parameter 122 and 123: Read parameter 122 and 123 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_122_and_123(const Spark_READ_PARAMETER_122_AND_123_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_122_AND_123(device_id_, values));
    }

    // Build and send Read Parameter 124 and 125: Read parameter 124 and 125 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_124_and_125(const Spark_READ_PARAMETER_124_AND_125_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_124_AND_125(device_id_, values));
    }

    // Build and send Read Parameter 126 and 127: Read parameter 126 and 127 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_126_and_127(const Spark_READ_PARAMETER_126_AND_127_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_126_AND_127(device_id_, values));
    }

    // Build and send Read Parameter 128 and 129: Read parameter 128 and 129 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_128_and_129(const Spark_READ_PARAMETER_128_AND_129_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_128_AND_129(device_id_, values));
    }

    // Build and send Read Parameter 130 and 131: Read parameter 130 and 131 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_130_and_131(const Spark_READ_PARAMETER_130_AND_131_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_130_AND_131(device_id_, values));
    }

    // Build and send Read Parameter 132 and 133: Read parameter 132 and 133 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_132_and_133(const Spark_READ_PARAMETER_132_AND_133_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_132_AND_133(device_id_, values));
    }

    // Build and send Read Parameter 134 and 135: Read parameter 134 and 135 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_134_and_135(const Spark_READ_PARAMETER_134_AND_135_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_134_AND_135(device_id_, values));
    }

    // Build and send Read Parameter 136 and 137: Read parameter 136 and 137 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_136_and_137(const Spark_READ_PARAMETER_136_AND_137_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_136_AND_137(device_id_, values));
    }

    // Build and send Read Parameter 138 and 139: Read parameter 138 and 139 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_138_and_139(const Spark_READ_PARAMETER_138_AND_139_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_138_AND_139(device_id_, values));
    }

    // Build and send Read Parameter 140 and 141: Read parameter 140 and 141 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_140_and_141(const Spark_READ_PARAMETER_140_AND_141_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_140_AND_141(device_id_, values));
    }

    // Build and send Read Parameter 142 and 143: Read parameter 142 and 143 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_142_and_143(const Spark_READ_PARAMETER_142_AND_143_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_142_AND_143(device_id_, values));
    }

    // Build and send Read Parameter 144 and 145: Read parameter 144 and 145 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_144_and_145(const Spark_READ_PARAMETER_144_AND_145_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_144_AND_145(device_id_, values));
    }

    // Build and send Read Parameter 146 and 147: Read parameter 146 and 147 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_146_and_147(const Spark_READ_PARAMETER_146_AND_147_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_146_AND_147(device_id_, values));
    }

    // Build and send Read Parameter 148 and 149: Read parameter 148 and 149 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_148_and_149(const Spark_READ_PARAMETER_148_AND_149_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_148_AND_149(device_id_, values));
    }

    // Build and send Read Parameter 150 and 151: Read parameter 150 and 151 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_150_and_151(const Spark_READ_PARAMETER_150_AND_151_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_150_AND_151(device_id_, values));
    }

    // Build and send Read Parameter 152 and 153: Read parameter 152 and 153 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_152_and_153(const Spark_READ_PARAMETER_152_AND_153_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_152_AND_153(device_id_, values));
    }

    // Build and send Read Parameter 154 and 155: Read parameter 154 and 155 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_154_and_155(const Spark_READ_PARAMETER_154_AND_155_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_154_AND_155(device_id_, values));
    }

    // Build and send Read Parameter 156 and 157: Read parameter 156 and 157 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_156_and_157(const Spark_READ_PARAMETER_156_AND_157_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_156_AND_157(device_id_, values));
    }

    // Build and send Read Parameter 158 and 159: Read parameter 158 and 159 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_158_and_159(const Spark_READ_PARAMETER_158_AND_159_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_158_AND_159(device_id_, values));
    }

    // Build and send Read Parameter 160 and 161: Read parameter 160 and 161 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_160_and_161(const Spark_READ_PARAMETER_160_AND_161_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_160_AND_161(device_id_, values));
    }

    // Build and send Read Parameter 162 and 163: Read parameter 162 and 163 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_162_and_163(const Spark_READ_PARAMETER_162_AND_163_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_162_AND_163(device_id_, values));
    }

    // Build and send Read Parameter 164 and 165: Read parameter 164 and 165 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_164_and_165(const Spark_READ_PARAMETER_164_AND_165_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_164_AND_165(device_id_, values));
    }

    // Build and send Read Parameter 166 and 167: Read parameter 166 and 167 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_166_and_167(const Spark_READ_PARAMETER_166_AND_167_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_166_AND_167(device_id_, values));
    }

    // Build and send Read Parameter 168 and 169: Read parameter 168 and 169 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_168_and_169(const Spark_READ_PARAMETER_168_AND_169_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_168_AND_169(device_id_, values));
    }

    // Build and send Read Parameter 170 and 171: Read parameter 170 and 171 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_170_and_171(const Spark_READ_PARAMETER_170_AND_171_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_170_AND_171(device_id_, values));
    }

    // Build and send Read Parameter 172 and 173: Read parameter 172 and 173 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_172_and_173(const Spark_READ_PARAMETER_172_AND_173_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_172_AND_173(device_id_, values));
    }

    // Build and send Read Parameter 174 and 175: Read parameter 174 and 175 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_174_and_175(const Spark_READ_PARAMETER_174_AND_175_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_174_AND_175(device_id_, values));
    }

    // Build and send Read Parameter 176 and 177: Read parameter 176 and 177 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_176_and_177(const Spark_READ_PARAMETER_176_AND_177_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_176_AND_177(device_id_, values));
    }

    // Build and send Read Parameter 178 and 179: Read parameter 178 and 179 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_178_and_179(const Spark_READ_PARAMETER_178_AND_179_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_178_AND_179(device_id_, values));
    }

    // Build and send Read Parameter 180 and 181: Read parameter 180 and 181 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_180_and_181(const Spark_READ_PARAMETER_180_AND_181_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_180_AND_181(device_id_, values));
    }

    // Build and send Read Parameter 182 and 183: Read parameter 182 and 183 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_182_and_183(const Spark_READ_PARAMETER_182_AND_183_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_182_AND_183(device_id_, values));
    }

    // Build and send Read Parameter 184 and 185: Read parameter 184 and 185 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_184_and_185(const Spark_READ_PARAMETER_184_AND_185_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_184_AND_185(device_id_, values));
    }

    // Build and send Read Parameter 186 and 187: Read parameter 186 and 187 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_186_and_187(const Spark_READ_PARAMETER_186_AND_187_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_186_AND_187(device_id_, values));
    }

    // Build and send Read Parameter 188 and 189: Read parameter 188 and 189 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_188_and_189(const Spark_READ_PARAMETER_188_AND_189_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_188_AND_189(device_id_, values));
    }

    // Build and send Read Parameter 190 and 191: Read parameter 190 and 191 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_190_and_191(const Spark_READ_PARAMETER_190_AND_191_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_190_AND_191(device_id_, values));
    }

    // Build and send Read Parameter 192 and 193: Read parameter 192 and 193 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_192_and_193(const Spark_READ_PARAMETER_192_AND_193_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_192_AND_193(device_id_, values));
    }

    // Build and send Read Parameter 194 and 195: Read parameter 194 and 195 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_194_and_195(const Spark_READ_PARAMETER_194_AND_195_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_194_AND_195(device_id_, values));
    }

    // Build and send Read Parameter 196 and 197: Read parameter 196 and 197 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_196_and_197(const Spark_READ_PARAMETER_196_AND_197_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_196_AND_197(device_id_, values));
    }

    // Build and send Read Parameter 198 and 199: Read parameter 198 and 199 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_198_and_199(const Spark_READ_PARAMETER_198_AND_199_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_198_AND_199(device_id_, values));
    }

    // Build and send Read Parameter 200 and 201: Read parameter 200 and 201 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_200_and_201(const Spark_READ_PARAMETER_200_AND_201_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_200_AND_201(device_id_, values));
    }

    // Build and send Read Parameter 202 and 203: Read parameter 202 and 203 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_202_and_203(const Spark_READ_PARAMETER_202_AND_203_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_202_AND_203(device_id_, values));
    }

    // Build and send Read Parameter 204 and 205: Read parameter 204 and 205 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_204_and_205(const Spark_READ_PARAMETER_204_AND_205_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_204_AND_205(device_id_, values));
    }

    // Build and send Read Parameter 206 and 207: Read parameter 206 and 207 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_206_and_207(const Spark_READ_PARAMETER_206_AND_207_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_206_AND_207(device_id_, values));
    }

    // Build and send Read Parameter 208 and 209: Read parameter 208 and 209 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_208_and_209(const Spark_READ_PARAMETER_208_AND_209_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_208_AND_209(device_id_, values));
    }

    // Build and send Read Parameter 210 and 211: Read parameter 210 and 211 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_210_and_211(const Spark_READ_PARAMETER_210_AND_211_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_210_AND_211(device_id_, values));
    }

    // Build and send Read Parameter 212 and 213: Read parameter 212 and 213 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_212_and_213(const Spark_READ_PARAMETER_212_AND_213_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_212_AND_213(device_id_, values));
    }

    // Build and send Read Parameter 214 and 215: Read parameter 214 and 215 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_214_and_215(const Spark_READ_PARAMETER_214_AND_215_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_214_AND_215(device_id_, values));
    }

    // Build and send Read Parameter 216 and 217: Read parameter 216 and 217 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_216_and_217(const Spark_READ_PARAMETER_216_AND_217_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_216_AND_217(device_id_, values));
    }

    // Build and send Read Parameter 218 and 219: Read parameter 218 and 219 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_218_and_219(const Spark_READ_PARAMETER_218_AND_219_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_218_AND_219(device_id_, values));
    }

    // Build and send Read Parameter 220 and 221: Read parameter 220 and 221 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_220_and_221(const Spark_READ_PARAMETER_220_AND_221_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_220_AND_221(device_id_, values));
    }

    // Build and send Read Parameter 222 and 223: Read parameter 222 and 223 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_222_and_223(const Spark_READ_PARAMETER_222_AND_223_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_222_AND_223(device_id_, values));
    }

    // Build and send Read Parameter 224 and 225: Read parameter 224 and 225 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_224_and_225(const Spark_READ_PARAMETER_224_AND_225_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_224_AND_225(device_id_, values));
    }

    // Build and send Read Parameter 226 and 227: Read parameter 226 and 227 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_226_and_227(const Spark_READ_PARAMETER_226_AND_227_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_226_AND_227(device_id_, values));
    }

    // Build and send Read Parameter 228 and 229: Read parameter 228 and 229 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_228_and_229(const Spark_READ_PARAMETER_228_AND_229_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_228_AND_229(device_id_, values));
    }

    // Build and send Read Parameter 230 and 231: Read parameter 230 and 231 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_230_and_231(const Spark_READ_PARAMETER_230_AND_231_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_230_AND_231(device_id_, values));
    }

    // Build and send Read Parameter 232 and 233: Read parameter 232 and 233 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_232_and_233(const Spark_READ_PARAMETER_232_AND_233_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_232_AND_233(device_id_, values));
    }

    // Build and send Read Parameter 234 and 235: Read parameter 234 and 235 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_234_and_235(const Spark_READ_PARAMETER_234_AND_235_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_234_AND_235(device_id_, values));
    }

    // Build and send Read Parameter 236 and 237: Read parameter 236 and 237 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_236_and_237(const Spark_READ_PARAMETER_236_AND_237_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_236_AND_237(device_id_, values));
    }

    // Build and send Read Parameter 238 and 239: Read parameter 238 and 239 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_238_and_239(const Spark_READ_PARAMETER_238_AND_239_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_238_AND_239(device_id_, values));
    }

    // Build and send Read Parameter 240 and 241: Read parameter 240 and 241 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_240_and_241(const Spark_READ_PARAMETER_240_AND_241_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_240_AND_241(device_id_, values));
    }

    // Build and send Read Parameter 242 and 243: Read parameter 242 and 243 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_242_and_243(const Spark_READ_PARAMETER_242_AND_243_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_242_AND_243(device_id_, values));
    }

    // Build and send Read Parameter 244 and 245: Read parameter 244 and 245 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_244_and_245(const Spark_READ_PARAMETER_244_AND_245_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_244_AND_245(device_id_, values));
    }

    // Build and send Read Parameter 246 and 247: Read parameter 246 and 247 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_246_and_247(const Spark_READ_PARAMETER_246_AND_247_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_246_AND_247(device_id_, values));
    }

    // Build and send Read Parameter 248 and 249: Read parameter 248 and 249 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_248_and_249(const Spark_READ_PARAMETER_248_AND_249_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_248_AND_249(device_id_, values));
    }

    // Build and send Read Parameter 250 and 251: Read parameter 250 and 251 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_250_and_251(const Spark_READ_PARAMETER_250_AND_251_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_250_AND_251(device_id_, values));
    }

    // Build and send Read Parameter 252 and 253: Read parameter 252 and 253 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_252_and_253(const Spark_READ_PARAMETER_252_AND_253_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_252_AND_253(device_id_, values));
    }

    // Build and send Read Parameter 254 and 255: Read parameter 254 and 255 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4 via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_read_parameter_254_and_255(const Spark_READ_PARAMETER_254_AND_255_t* values) const
    {
        return dispatch_frame(spark_build_READ_PARAMETER_254_AND_255(device_id_, values));
    }

    // Build and send Write Parameter 0 and 1: Write Parameter 0 and 1 at the same time. Two Write Parameter Response
    // frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 2 and 3: Write Parameter 2 and 3 at the same time. Two Write Parameter Response
    // frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 4 and 5: Write Parameter 4 and 5 at the same time. Two Write Parameter Response
    // frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 6 and 7: Write Parameter 6 and 7 at the same time. Two Write Parameter Response
    // frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 8 and 9: Write Parameter 8 and 9 at the same time. Two Write Parameter Response
    // frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 10 and 11: Write Parameter 10 and 11 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 12 and 13: Write Parameter 12 and 13 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 14 and 15: Write Parameter 14 and 15 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 16 and 17: Write Parameter 16 and 17 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 18 and 19: Write Parameter 18 and 19 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 20 and 21: Write Parameter 20 and 21 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 22 and 23: Write Parameter 22 and 23 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 24 and 25: Write Parameter 24 and 25 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 26 and 27: Write Parameter 26 and 27 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 28 and 29: Write Parameter 28 and 29 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 30 and 31: Write Parameter 30 and 31 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 32 and 33: Write Parameter 32 and 33 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 34 and 35: Write Parameter 34 and 35 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 36 and 37: Write Parameter 36 and 37 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 38 and 39: Write Parameter 38 and 39 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 40 and 41: Write Parameter 40 and 41 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 42 and 43: Write Parameter 42 and 43 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 44 and 45: Write Parameter 44 and 45 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 46 and 47: Write Parameter 46 and 47 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 48 and 49: Write Parameter 48 and 49 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 50 and 51: Write Parameter 50 and 51 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 52 and 53: Write Parameter 52 and 53 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 54 and 55: Write Parameter 54 and 55 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 56 and 57: Write Parameter 56 and 57 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 58 and 59: Write Parameter 58 and 59 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 60 and 61: Write Parameter 60 and 61 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 62 and 63: Write Parameter 62 and 63 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 64 and 65: Write Parameter 64 and 65 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 66 and 67: Write Parameter 66 and 67 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 68 and 69: Write Parameter 68 and 69 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 70 and 71: Write Parameter 70 and 71 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 72 and 73: Write Parameter 72 and 73 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 74 and 75: Write Parameter 74 and 75 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 76 and 77: Write Parameter 76 and 77 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 78 and 79: Write Parameter 78 and 79 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 80 and 81: Write Parameter 80 and 81 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 82 and 83: Write Parameter 82 and 83 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 84 and 85: Write Parameter 84 and 85 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 86 and 87: Write Parameter 86 and 87 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 88 and 89: Write Parameter 88 and 89 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 90 and 91: Write Parameter 90 and 91 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 92 and 93: Write Parameter 92 and 93 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 94 and 95: Write Parameter 94 and 95 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 96 and 97: Write Parameter 96 and 97 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 98 and 99: Write Parameter 98 and 99 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    ...
    // Build and send Write Parameter 100 and 101: Write Parameter 100 and 101 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_100_and_101(const Spark_WRITE_PARAMETER_100_AND_101_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_100_AND_101(device_id_, values));
    }

    // Build and send Write Parameter 102 and 103: Write Parameter 102 and 103 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_102_and_103(const Spark_WRITE_PARAMETER_102_AND_103_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_102_AND_103(device_id_, values));
    }

    // Build and send Write Parameter 104 and 105: Write Parameter 104 and 105 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_104_and_105(const Spark_WRITE_PARAMETER_104_AND_105_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_104_AND_105(device_id_, values));
    }

    // Build and send Write Parameter 106 and 107: Write Parameter 106 and 107 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_106_and_107(const Spark_WRITE_PARAMETER_106_AND_107_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_106_AND_107(device_id_, values));
    }

    // Build and send Write Parameter 108 and 109: Write Parameter 108 and 109 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_108_and_109(const Spark_WRITE_PARAMETER_108_AND_109_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_108_AND_109(device_id_, values));
    }

    // Build and send Write Parameter 110 and 111: Write Parameter 110 and 111 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_110_and_111(const Spark_WRITE_PARAMETER_110_AND_111_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_110_AND_111(device_id_, values));
    }

    // Build and send Write Parameter 112 and 113: Write Parameter 112 and 113 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_112_and_113(const Spark_WRITE_PARAMETER_112_AND_113_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_112_AND_113(device_id_, values));
    }

    // Build and send Write Parameter 114 and 115: Write Parameter 114 and 115 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_114_and_115(const Spark_WRITE_PARAMETER_114_AND_115_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_114_AND_115(device_id_, values));
    }

    // Build and send Write Parameter 116 and 117: Write Parameter 116 and 117 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_116_and_117(const Spark_WRITE_PARAMETER_116_AND_117_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_116_AND_117(device_id_, values));
    }

    // Build and send Write Parameter 118 and 119: Write Parameter 118 and 119 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_118_and_119(const Spark_WRITE_PARAMETER_118_AND_119_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_118_AND_119(device_id_, values));
    }

    // Build and send Write Parameter 120 and 121: Write Parameter 120 and 121 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_120_and_121(const Spark_WRITE_PARAMETER_120_AND_121_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_120_AND_121(device_id_, values));
    }

    // Build and send Write Parameter 122 and 123: Write Parameter 122 and 123 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_122_and_123(const Spark_WRITE_PARAMETER_122_AND_123_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_122_AND_123(device_id_, values));
    }

    // Build and send Write Parameter 124 and 125: Write Parameter 124 and 125 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_124_and_125(const Spark_WRITE_PARAMETER_124_AND_125_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_124_AND_125(device_id_, values));
    }

    // Build and send Write Parameter 126 and 127: Write Parameter 126 and 127 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_126_and_127(const Spark_WRITE_PARAMETER_126_AND_127_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_126_AND_127(device_id_, values));
    }

    // Build and send Write Parameter 128 and 129: Write Parameter 128 and 129 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_128_and_129(const Spark_WRITE_PARAMETER_128_AND_129_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_128_AND_129(device_id_, values));
    }

    // Build and send Write Parameter 130 and 131: Write Parameter 130 and 131 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_130_and_131(const Spark_WRITE_PARAMETER_130_AND_131_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_130_AND_131(device_id_, values));
    }

    // Build and send Write Parameter 132 and 133: Write Parameter 132 and 133 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_132_and_133(const Spark_WRITE_PARAMETER_132_AND_133_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_132_AND_133(device_id_, values));
    }

    // Build and send Write Parameter 134 and 135: Write Parameter 134 and 135 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_134_and_135(const Spark_WRITE_PARAMETER_134_AND_135_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_134_AND_135(device_id_, values));
    }

    // Build and send Write Parameter 136 and 137: Write Parameter 136 and 137 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_136_and_137(const Spark_WRITE_PARAMETER_136_AND_137_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_136_AND_137(device_id_, values));
    }

    // Build and send Write Parameter 138 and 139: Write Parameter 138 and 139 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_138_and_139(const Spark_WRITE_PARAMETER_138_AND_139_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_138_AND_139(device_id_, values));
    }

    // Build and send Write Parameter 140 and 141: Write Parameter 140 and 141 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_140_and_141(const Spark_WRITE_PARAMETER_140_AND_141_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_140_AND_141(device_id_, values));
    }

    // Build and send Write Parameter 142 and 143: Write Parameter 142 and 143 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_142_and_143(const Spark_WRITE_PARAMETER_142_AND_143_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_142_AND_143(device_id_, values));
    }

    // Build and send Write Parameter 144 and 145: Write Parameter 144 and 145 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_144_and_145(const Spark_WRITE_PARAMETER_144_AND_145_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_144_AND_145(device_id_, values));
    }

    // Build and send Write Parameter 146 and 147: Write Parameter 146 and 147 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_146_and_147(const Spark_WRITE_PARAMETER_146_AND_147_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_146_AND_147(device_id_, values));
    }

    // Build and send Write Parameter 148 and 149: Write Parameter 148 and 149 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_148_and_149(const Spark_WRITE_PARAMETER_148_AND_149_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_148_AND_149(device_id_, values));
    }

    // Build and send Write Parameter 150 and 151: Write Parameter 150 and 151 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_150_and_151(const Spark_WRITE_PARAMETER_150_AND_151_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_150_AND_151(device_id_, values));
    }

    // Build and send Write Parameter 152 and 153: Write Parameter 152 and 153 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_152_and_153(const Spark_WRITE_PARAMETER_152_AND_153_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_152_AND_153(device_id_, values));
    }

    // Build and send Write Parameter 154 and 155: Write Parameter 154 and 155 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_154_and_155(const Spark_WRITE_PARAMETER_154_AND_155_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_154_AND_155(device_id_, values));
    }

    // Build and send Write Parameter 156 and 157: Write Parameter 156 and 157 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_156_and_157(const Spark_WRITE_PARAMETER_156_AND_157_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_156_AND_157(device_id_, values));
    }

    // Build and send Write Parameter 158 and 159: Write Parameter 158 and 159 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_158_and_159(const Spark_WRITE_PARAMETER_158_AND_159_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_158_AND_159(device_id_, values));
    }

    // Build and send Write Parameter 160 and 161: Write Parameter 160 and 161 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_160_and_161(const Spark_WRITE_PARAMETER_160_AND_161_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_160_AND_161(device_id_, values));
    }

    // Build and send Write Parameter 162 and 163: Write Parameter 162 and 163 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_162_and_163(const Spark_WRITE_PARAMETER_162_AND_163_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_162_AND_163(device_id_, values));
    }

    // Build and send Write Parameter 164 and 165: Write Parameter 164 and 165 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_164_and_165(const Spark_WRITE_PARAMETER_164_AND_165_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_164_AND_165(device_id_, values));
    }

    // Build and send Write Parameter 166 and 167: Write Parameter 166 and 167 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_166_and_167(const Spark_WRITE_PARAMETER_166_AND_167_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_166_AND_167(device_id_, values));
    }

    // Build and send Write Parameter 168 and 169: Write Parameter 168 and 169 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_168_and_169(const Spark_WRITE_PARAMETER_168_AND_169_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_168_AND_169(device_id_, values));
    }

    // Build and send Write Parameter 170 and 171: Write Parameter 170 and 171 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_170_and_171(const Spark_WRITE_PARAMETER_170_AND_171_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_170_AND_171(device_id_, values));
    }

    // Build and send Write Parameter 172 and 173: Write Parameter 172 and 173 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_172_and_173(const Spark_WRITE_PARAMETER_172_AND_173_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_172_AND_173(device_id_, values));
    }

    // Build and send Write Parameter 174 and 175: Write Parameter 174 and 175 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_174_and_175(const Spark_WRITE_PARAMETER_174_AND_175_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_174_AND_175(device_id_, values));
    }

    // Build and send Write Parameter 176 and 177: Write Parameter 176 and 177 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_176_and_177(const Spark_WRITE_PARAMETER_176_AND_177_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_176_AND_177(device_id_, values));
    }

    // Build and send Write Parameter 178 and 179: Write Parameter 178 and 179 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_178_and_179(const Spark_WRITE_PARAMETER_178_AND_179_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_178_AND_179(device_id_, values));
    }

    // Build and send Write Parameter 180 and 181: Write Parameter 180 and 181 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_180_and_181(const Spark_WRITE_PARAMETER_180_AND_181_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_180_AND_181(device_id_, values));
    }

    // Build and send Write Parameter 182 and 183: Write Parameter 182 and 183 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_182_and_183(const Spark_WRITE_PARAMETER_182_AND_183_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_182_AND_183(device_id_, values));
    }

    // Build and send Write Parameter 184 and 185: Write Parameter 184 and 185 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_184_and_185(const Spark_WRITE_PARAMETER_184_AND_185_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_184_AND_185(device_id_, values));
    }

    // Build and send Write Parameter 186 and 187: Write Parameter 186 and 187 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_186_and_187(const Spark_WRITE_PARAMETER_186_AND_187_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_186_AND_187(device_id_, values));
    }

    // Build and send Write Parameter 188 and 189: Write Parameter 188 and 189 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_188_and_189(const Spark_WRITE_PARAMETER_188_AND_189_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_188_AND_189(device_id_, values));
    }

    // Build and send Write Parameter 190 and 191: Write Parameter 190 and 191 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_190_and_191(const Spark_WRITE_PARAMETER_190_AND_191_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_190_AND_191(device_id_, values));
    }

    // Build and send Write Parameter 192 and 193: Write Parameter 192 and 193 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_192_and_193(const Spark_WRITE_PARAMETER_192_AND_193_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_192_AND_193(device_id_, values));
    }

    // Build and send Write Parameter 194 and 195: Write Parameter 194 and 195 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_194_and_195(const Spark_WRITE_PARAMETER_194_AND_195_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_194_AND_195(device_id_, values));
    }

    // Build and send Write Parameter 196 and 197: Write Parameter 196 and 197 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_196_and_197(const Spark_WRITE_PARAMETER_196_AND_197_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_196_AND_197(device_id_, values));
    }

    // Build and send Write Parameter 198 and 199: Write Parameter 198 and 199 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_198_and_199(const Spark_WRITE_PARAMETER_198_AND_199_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_198_AND_199(device_id_, values));
    }

    // Build and send Write Parameter 200 and 201: Write Parameter 200 and 201 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_200_and_201(const Spark_WRITE_PARAMETER_200_AND_201_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_200_AND_201(device_id_, values));
    }

    // Build and send Write Parameter 202 and 203: Write Parameter 202 and 203 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_202_and_203(const Spark_WRITE_PARAMETER_202_AND_203_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_202_AND_203(device_id_, values));
    }

    // Build and send Write Parameter 204 and 205: Write Parameter 204 and 205 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_204_and_205(const Spark_WRITE_PARAMETER_204_AND_205_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_204_AND_205(device_id_, values));
    }

    // Build and send Write Parameter 206 and 207: Write Parameter 206 and 207 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_206_and_207(const Spark_WRITE_PARAMETER_206_AND_207_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_206_AND_207(device_id_, values));
    }

    // Build and send Write Parameter 208 and 209: Write Parameter 208 and 209 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_208_and_209(const Spark_WRITE_PARAMETER_208_AND_209_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_208_AND_209(device_id_, values));
    }

    // Build and send Write Parameter 210 and 211: Write Parameter 210 and 211 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_210_and_211(const Spark_WRITE_PARAMETER_210_AND_211_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_210_AND_211(device_id_, values));
    }

    // Build and send Write Parameter 212 and 213: Write Parameter 212 and 213 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_212_and_213(const Spark_WRITE_PARAMETER_212_AND_213_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_212_AND_213(device_id_, values));
    }

    // Build and send Write Parameter 214 and 215: Write Parameter 214 and 215 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_214_and_215(const Spark_WRITE_PARAMETER_214_AND_215_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_214_AND_215(device_id_, values));
    }

    // Build and send Write Parameter 216 and 217: Write Parameter 216 and 217 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_216_and_217(const Spark_WRITE_PARAMETER_216_AND_217_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_216_AND_217(device_id_, values));
    }

    // Build and send Write Parameter 218 and 219: Write Parameter 218 and 219 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_218_and_219(const Spark_WRITE_PARAMETER_218_AND_219_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_218_AND_219(device_id_, values));
    }

    // Build and send Write Parameter 220 and 221: Write Parameter 220 and 221 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_220_and_221(const Spark_WRITE_PARAMETER_220_AND_221_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_220_AND_221(device_id_, values));
    }

    // Build and send Write Parameter 222 and 223: Write Parameter 222 and 223 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_222_and_223(const Spark_WRITE_PARAMETER_222_AND_223_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_222_AND_223(device_id_, values));
    }

    // Build and send Write Parameter 224 and 225: Write Parameter 224 and 225 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_224_and_225(const Spark_WRITE_PARAMETER_224_AND_225_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_224_AND_225(device_id_, values));
    }

    // Build and send Write Parameter 226 and 227: Write Parameter 226 and 227 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_226_and_227(const Spark_WRITE_PARAMETER_226_AND_227_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_226_AND_227(device_id_, values));
    }

    // Build and send Write Parameter 228 and 229: Write Parameter 228 and 229 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_228_and_229(const Spark_WRITE_PARAMETER_228_AND_229_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_228_AND_229(device_id_, values));
    }

    // Build and send Write Parameter 230 and 231: Write Parameter 230 and 231 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_230_and_231(const Spark_WRITE_PARAMETER_230_AND_231_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_230_AND_231(device_id_, values));
    }

    // Build and send Write Parameter 232 and 233: Write Parameter 232 and 233 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_232_and_233(const Spark_WRITE_PARAMETER_232_AND_233_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_232_AND_233(device_id_, values));
    }

    // Build and send Write Parameter 234 and 235: Write Parameter 234 and 235 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_234_and_235(const Spark_WRITE_PARAMETER_234_AND_235_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_234_AND_235(device_id_, values));
    }

    // Build and send Write Parameter 236 and 237: Write Parameter 236 and 237 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_236_and_237(const Spark_WRITE_PARAMETER_236_AND_237_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_236_AND_237(device_id_, values));
    }

    // Build and send Write Parameter 238 and 239: Write Parameter 238 and 239 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_238_and_239(const Spark_WRITE_PARAMETER_238_AND_239_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_238_AND_239(device_id_, values));
    }

    // Build and send Write Parameter 240 and 241: Write Parameter 240 and 241 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_240_and_241(const Spark_WRITE_PARAMETER_240_AND_241_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_240_AND_241(device_id_, values));
    }

    // Build and send Write Parameter 242 and 243: Write Parameter 242 and 243 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_242_and_243(const Spark_WRITE_PARAMETER_242_AND_243_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_242_AND_243(device_id_, values));
    }

    // Build and send Write Parameter 244 and 245: Write Parameter 244 and 245 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_244_and_245(const Spark_WRITE_PARAMETER_244_AND_245_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_244_AND_245(device_id_, values));
    }

    // Build and send Write Parameter 246 and 247: Write Parameter 246 and 247 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_246_and_247(const Spark_WRITE_PARAMETER_246_AND_247_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_246_AND_247(device_id_, values));
    }

    // Build and send Write Parameter 248 and 249: Write Parameter 248 and 249 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_248_and_249(const Spark_WRITE_PARAMETER_248_AND_249_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_248_AND_249(device_id_, values));
    }

    // Build and send Write Parameter 250 and 251: Write Parameter 250 and 251 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_250_and_251(const Spark_WRITE_PARAMETER_250_AND_251_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_250_AND_251(device_id_, values));
    }

    // Build and send Write Parameter 252 and 253: Write Parameter 252 and 253 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_252_and_253(const Spark_WRITE_PARAMETER_252_AND_253_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_252_AND_253(device_id_, values));
    }

    // Build and send Write Parameter 254 and 255: Write Parameter 254 and 255 at the same time. Two Write Parameter
    // Response frames will be sent in response. via MCP2515 controller
    MCP2515::ERROR
    SparkCanDevice::send_write_parameter_254_and_255(const Spark_WRITE_PARAMETER_254_AND_255_t* values) const
    {
        return dispatch_frame(spark_build_WRITE_PARAMETER_254_AND_255(device_id_, values));
    }

    // Build and send Start Follower Mode: Starts follower mode. The relevant parameters must already be configured. In
    // response, a Start Follower Mode Response frame will be sent. Follower mode will be auto-started on boot if the
    // Follower Mode Leader ID parameter is set to a non-zero value. via MCP2515 controller
    ...
    MCP2515::ERROR
    SparkCanDevice::send_start_follower_mode_response(const Spark_START_FOLLOWER_MODE_RESPONSE_t* values) const
    {
        return dispatch_frame(spark_build_START_FOLLOWER_MODE_RESPONSE(device_id_, values));
    }

    // Build and send Stop Follower Mode: Exits follower mode and causes the device to resume listening for setpoints
    // addressed directly to it. In response, a Stop Follower Mode Response frame will be sent. via MCP2515 controller
    ...
    MCP2515::ERROR
    SparkCanDevice::send_stop_follower_mode_response(const Spark_STOP_FOLLOWER_MODE_RESPONSE_t* values) const
    {
    ...
    // Build and send Persist Parameters: Causes all parameters to be written to non-volatile storage. After the
    // operation (which may take up to a second) completes, a Persist Parameters Response frame will be sent. via
    // MCP2515 controller
    ...
    // Decode frame payload for Smart Velocity Setpoint: Sets the Control Type to Smart Velocity and sets the target
    // velocity
    ...
    // Decode frame payload for Smart Motion Setpoint: Sets the Control Type to Smart Motion and sets the target
    // position
