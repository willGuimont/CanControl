...
// Smart Velocity Setpoint: Sets the Control Type to Smart Velocity and sets the target velocity
...
// Smart Motion Setpoint: Sets the Control Type to Smart Motion and sets the target position
...
// Match arbitration ID for frame Smart Velocity Setpoint: Sets the Control Type to Smart Velocity and sets the target velocity
...
// Match arbitration ID for frame Smart Motion Setpoint: Sets the Control Type to Smart Motion and sets the target position
...
// Frame values for Smart Velocity Setpoint: Sets the Control Type to Smart Velocity and sets the target velocity
typedef struct {
    // Setpoint: By default, the unit is RPM, but it can be changed implicitly using the Velocity Conversion Factor parameter
    float SETPOINT;
    // Arbitrary Feedforward
...
// Frame values for Smart Motion Setpoint: Sets the Control Type to Smart Motion and sets the target position
typedef struct {
    // Setpoint: By default, the unit is rotations, but it can be changed implicitly using the Position Conversion Factor parameter
    float SETPOINT;
    // Arbitrary Feedforward
...
// Build frame for Smart Motion Setpoint: Sets the Control Type to Smart Motion and sets the target position
...
public:
    ...
    // Build CAN frame for Smart Velocity Setpoint: Sets the Control Type to Smart Velocity and sets the target velocity
    ...
    // Build CAN frame for Smart Motion Setpoint: Sets the Control Type to Smart Motion and sets the target position
    ...
    // Build and send Smart Velocity Setpoint: Sets the Control Type to Smart Velocity and sets the target velocity (pointer overload)
    MCP2515::ERROR send_smart_velocity_setpoint(const Spark_SMART_VELOCITY_SETPOINT_t* values = nullptr) const;
    // Build and send Smart Velocity Setpoint: Sets the Control Type to Smart Velocity and sets the target velocity (by-value overload)
    ...
    // Build and send Smart Velocity Setpoint: Sets the Control Type to Smart Velocity and sets the target velocity via alias 'set_smart_velocity_setpoint' (pointer overload)
    ...
    // Build and send Smart Velocity Setpoint: Sets the Control Type to Smart Velocity and sets the target velocity via alias 'set_smart_velocity_setpoint' (by-value overload)
    ...
    // Build and send Smart Motion Setpoint: Sets the Control Type to Smart Motion and sets the target position (pointer overload)
    MCP2515::ERROR send_smart_motion_setpoint(const Spark_SMART_MOTION_SETPOINT_t* values = nullptr) const;
    // Build and send Smart Motion Setpoint: Sets the Control Type to Smart Motion and sets the target position (by-value overload)
    ...
    // Build and send Smart Motion Setpoint: Sets the Control Type to Smart Motion and sets the target position via alias 'set_smart_motion_setpoint' (pointer overload)
    ...
    // Build and send Smart Motion Setpoint: Sets the Control Type to Smart Motion and sets the target position via alias 'set_smart_motion_setpoint' (by-value overload)
