...
#define SPARK_MATCH_LEGACY_STATUS_0(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_LEGACY_STATUS_0)
// Match arbitration ID for frame Bootloader 0: Periodic frame when device is in the bootloader
#define SPARK_MATCH_BOOTLOADER_0(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_BOOTLOADER_0)
// Match arbitration ID for frame Status 0: Includes general data that is likely to need frequent refreshing
#define SPARK_MATCH_STATUS_0(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_STATUS_0)
// Match arbitration ID for frame Status 1: Includes general data that can likely tolerate infrequent refreshing
#define SPARK_MATCH_STATUS_1(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_STATUS_1)
...
#define SPARK_MATCH_STATUS_2(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_STATUS_2)
// Match arbitration ID for frame Status 3: Includes data from an analog sensor
#define SPARK_MATCH_STATUS_3(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_STATUS_3)
...
#define SPARK_MATCH_STATUS_4(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_STATUS_4)
// Match arbitration ID for frame Status 5: Includes velocity and position data from a duty-cycle absolute encoder
#define SPARK_MATCH_STATUS_5(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_STATUS_5)
// Match arbitration ID for frame Status 6: Includes other data from a duty-cycle absolute encoder
#define SPARK_MATCH_STATUS_6(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_STATUS_6)
// Match arbitration ID for frame Status 7: Includes diagnostic data for closed-loop control
#define SPARK_MATCH_STATUS_7(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_STATUS_7)
// Match arbitration ID for frame Status 8: Includes additional diagnostic data for closed-loop control
#define SPARK_MATCH_STATUS_8(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_STATUS_8)
// Match arbitration ID for frame Status 9: Includes diagnostic data for MAXMotion closed-loop control
#define SPARK_MATCH_STATUS_9(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_STATUS_9)
...
#define SPARK_MATCH_UNIQUE_ID_BROADCAST(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_UNIQUE_ID_BROADCAST)
// Match arbitration ID for frame Velocity Setpoint: Sets the Control Type to Velocity and sets the target velocity
#define SPARK_MATCH_VELOCITY_SETPOINT(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_VELOCITY_SETPOINT)
...
#define SPARK_MATCH_DUTY_CYCLE_SETPOINT(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_DUTY_CYCLE_SETPOINT)
// Match arbitration ID for frame Position Setpoint: Sets the Control Type to Position and sets the target position
#define SPARK_MATCH_POSITION_SETPOINT(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_POSITION_SETPOINT)
// Match arbitration ID for frame Voltage Setpoint: Sets the Control Type to Voltage and sets the target voltage
#define SPARK_MATCH_VOLTAGE_SETPOINT(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_VOLTAGE_SETPOINT)
// Match arbitration ID for frame Current Setpoint: Sets the Control Type to Current and sets the target current
#define SPARK_MATCH_CURRENT_SETPOINT(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_CURRENT_SETPOINT)
...
#define SPARK_MATCH_MAXMOTION_POSITION_SETPOINT(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_MAXMOTION_POSITION_SETPOINT)
...
#define SPARK_MATCH_MAXMOTION_VELOCITY_SETPOINT(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_MAXMOTION_VELOCITY_SETPOINT)
...
#define SPARK_MATCH_SET_STATUSES_ENABLED(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_SET_STATUSES_ENABLED)
// Match arbitration ID for frame Set Statuses Enabled Response: Response for a Set Statuses Enabled command
#define SPARK_MATCH_SET_STATUSES_ENABLED_RESPONSE(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_SET_STATUSES_ENABLED_RESPONSE)
// Match arbitration ID for frame Persist Parameters Response
#define SPARK_MATCH_PERSIST_PARAMETERS_RESPONSE(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_PERSIST_PARAMETERS_RESPONSE)
...
#define SPARK_MATCH_RESET_SAFE_PARAMETERS(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_RESET_SAFE_PARAMETERS)
// Match arbitration ID for frame Reset Safe Parameters Response: Response for a Reset Safe Parameters command
#define SPARK_MATCH_RESET_SAFE_PARAMETERS_RESPONSE(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_RESET_SAFE_PARAMETERS_RESPONSE)
...
#define SPARK_MATCH_COMPLETE_FACTORY_RESET(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_COMPLETE_FACTORY_RESET)
// Match arbitration ID for frame Complete Factory Reset Response: Response for a Complete Factory Reset command
#define SPARK_MATCH_COMPLETE_FACTORY_RESET_RESPONSE(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_COMPLETE_FACTORY_RESET_RESPONSE)
// Match arbitration ID for frame Clear Faults
#define SPARK_MATCH_CLEAR_FAULTS(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_CLEAR_FAULTS)
...
#define SPARK_MATCH_IDENTIFY_UNIQUE_SPARK(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_IDENTIFY_UNIQUE_SPARK)
...
#define SPARK_MATCH_IDENTIFY(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_IDENTIFY)
...
#define SPARK_MATCH_LED_SYNC(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_LED_SYNC)
...
#define SPARK_MATCH_SET_CAN_ID(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_SET_CAN_ID)
// Match arbitration ID for frame Get Firmware Version
#define SPARK_MATCH_GET_FIRMWARE_VERSION(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_FIRMWARE_VERSION)
...
#define SPARK_MATCH_SWDL_DATA(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_SWDL_DATA)
...
#define SPARK_MATCH_SWDL_CHECKSUM(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_SWDL_CHECKSUM)
...
#define SPARK_MATCH_SWDL_RETRANSMIT(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_SWDL_RETRANSMIT)
// Match arbitration ID for frame Set Primary Encoder Position
#define SPARK_MATCH_SET_PRIMARY_ENCODER_POSITION(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_SET_PRIMARY_ENCODER_POSITION)
// Match arbitration ID for frame Set I Accumulation
#define SPARK_MATCH_SET_I_ACCUMULATION(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_SET_I_ACCUMULATION)
// Match arbitration ID for frame Set Analog Position
#define SPARK_MATCH_SET_ANALOG_POSITION(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_SET_ANALOG_POSITION)
// Match arbitration ID for frame Set Ext or Alt Encoder Position
#define SPARK_MATCH_SET_EXT_OR_ALT_ENCODER_POSITION(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_SET_EXT_OR_ALT_ENCODER_POSITION)
// Match arbitration ID for frame Set Duty Cycle Position
#define SPARK_MATCH_SET_DUTY_CYCLE_POSITION(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_SET_DUTY_CYCLE_POSITION)
...
#define SPARK_MATCH_SECONDARY_HEARTBEAT(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_SECONDARY_HEARTBEAT)
...
#define SPARK_MATCH_USB_ONLY_IDENTIFY(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_USB_ONLY_IDENTIFY)
...
#define SPARK_MATCH_USB_ONLY_ENTER_DFU_BOOTLOADER(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_USB_ONLY_ENTER_DFU_BOOTLOADER)
// Match arbitration ID for frame Get Temperatures
#define SPARK_MATCH_GET_TEMPERATURES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_TEMPERATURES)
// Match arbitration ID for frame Get Motor Interface
#define SPARK_MATCH_GET_MOTOR_INTERFACE(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_MOTOR_INTERFACE)
// Match arbitration ID for frame Get Parameter 0 to 15 Types: Get types of parameters 0 to 15
#define SPARK_MATCH_GET_PARAMETER_0_TO_15_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_0_TO_15_TYPES)
// Match arbitration ID for frame Get Parameter 16 to 31 Types: Get types of parameters 16 to 31
#define SPARK_MATCH_GET_PARAMETER_16_TO_31_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_16_TO_31_TYPES)
// Match arbitration ID for frame Get Parameter 32 to 47 Types: Get types of parameters 32 to 47
#define SPARK_MATCH_GET_PARAMETER_32_TO_47_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_32_TO_47_TYPES)
// Match arbitration ID for frame Get Parameter 48 to 63 Types: Get types of parameters 48 to 63
#define SPARK_MATCH_GET_PARAMETER_48_TO_63_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_48_TO_63_TYPES)
// Match arbitration ID for frame Get Parameter 64 to 79 Types: Get types of parameters 64 to 79
#define SPARK_MATCH_GET_PARAMETER_64_TO_79_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_64_TO_79_TYPES)
// Match arbitration ID for frame Get Parameter 80 to 95 Types: Get types of parameters 80 to 95
#define SPARK_MATCH_GET_PARAMETER_80_TO_95_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_80_TO_95_TYPES)
// Match arbitration ID for frame Get Parameter 96 to 111 Types: Get types of parameters 96 to 111
#define SPARK_MATCH_GET_PARAMETER_96_TO_111_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_96_TO_111_TYPES)
// Match arbitration ID for frame Get Parameter 112 to 127 Types: Get types of parameters 112 to 127
#define SPARK_MATCH_GET_PARAMETER_112_TO_127_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_112_TO_127_TYPES)
// Match arbitration ID for frame Get Parameter 128 to 143 Types: Get types of parameters 128 to 143
#define SPARK_MATCH_GET_PARAMETER_128_TO_143_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_128_TO_143_TYPES)
// Match arbitration ID for frame Get Parameter 144 to 159 Types: Get types of parameters 144 to 159
#define SPARK_MATCH_GET_PARAMETER_144_TO_159_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_144_TO_159_TYPES)
// Match arbitration ID for frame Get Parameter 160 to 175 Types: Get types of parameters 160 to 175
#define SPARK_MATCH_GET_PARAMETER_160_TO_175_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_160_TO_175_TYPES)
// Match arbitration ID for frame Get Parameter 176 to 191 Types: Get types of parameters 176 to 191
#define SPARK_MATCH_GET_PARAMETER_176_TO_191_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_176_TO_191_TYPES)
// Match arbitration ID for frame Get Parameter 192 to 207 Types: Get types of parameters 192 to 207
#define SPARK_MATCH_GET_PARAMETER_192_TO_207_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_192_TO_207_TYPES)
// Match arbitration ID for frame Get Parameter 208 to 223 Types: Get types of parameters 208 to 223
#define SPARK_MATCH_GET_PARAMETER_208_TO_223_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_208_TO_223_TYPES)
// Match arbitration ID for frame Get Parameter 224 to 239 Types: Get types of parameters 224 to 239
#define SPARK_MATCH_GET_PARAMETER_224_TO_239_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_224_TO_239_TYPES)
// Match arbitration ID for frame Get Parameter 240 to 255 Types: Get types of parameters 240 to 255
#define SPARK_MATCH_GET_PARAMETER_240_TO_255_TYPES(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_GET_PARAMETER_240_TO_255_TYPES)
...
#define SPARK_MATCH_PARAMETER_WRITE(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_PARAMETER_WRITE)
...
#define SPARK_MATCH_PARAMETER_WRITE_RESPONSE(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_PARAMETER_WRITE_RESPONSE)
...
#define SPARK_MATCH_READ_PARAMETER_0_AND_1(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_0_AND_1)
...
#define SPARK_MATCH_READ_PARAMETER_2_AND_3(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_2_AND_3)
...
#define SPARK_MATCH_READ_PARAMETER_4_AND_5(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_4_AND_5)
...
#define SPARK_MATCH_READ_PARAMETER_6_AND_7(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_6_AND_7)
...
#define SPARK_MATCH_READ_PARAMETER_8_AND_9(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_8_AND_9)
...
#define SPARK_MATCH_READ_PARAMETER_10_AND_11(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_10_AND_11)
...
#define SPARK_MATCH_READ_PARAMETER_12_AND_13(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_12_AND_13)
...
#define SPARK_MATCH_READ_PARAMETER_14_AND_15(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_14_AND_15)
...
#define SPARK_MATCH_READ_PARAMETER_16_AND_17(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_16_AND_17)
...
#define SPARK_MATCH_READ_PARAMETER_18_AND_19(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_18_AND_19)
...
#define SPARK_MATCH_READ_PARAMETER_20_AND_21(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_20_AND_21)
...
#define SPARK_MATCH_READ_PARAMETER_22_AND_23(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_22_AND_23)
...
#define SPARK_MATCH_READ_PARAMETER_24_AND_25(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_24_AND_25)
...
#define SPARK_MATCH_READ_PARAMETER_26_AND_27(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_26_AND_27)
...
#define SPARK_MATCH_READ_PARAMETER_28_AND_29(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_28_AND_29)
...
#define SPARK_MATCH_READ_PARAMETER_30_AND_31(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_30_AND_31)
...
#define SPARK_MATCH_READ_PARAMETER_32_AND_33(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_32_AND_33)
...
#define SPARK_MATCH_READ_PARAMETER_34_AND_35(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_34_AND_35)
...
#define SPARK_MATCH_READ_PARAMETER_36_AND_37(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_36_AND_37)
...
#define SPARK_MATCH_READ_PARAMETER_38_AND_39(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_38_AND_39)
...
#define SPARK_MATCH_READ_PARAMETER_40_AND_41(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_40_AND_41)
...
#define SPARK_MATCH_READ_PARAMETER_42_AND_43(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_42_AND_43)
...
#define SPARK_MATCH_READ_PARAMETER_44_AND_45(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_44_AND_45)
...
#define SPARK_MATCH_READ_PARAMETER_46_AND_47(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_46_AND_47)
...
#define SPARK_MATCH_READ_PARAMETER_48_AND_49(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_48_AND_49)
...
#define SPARK_MATCH_READ_PARAMETER_50_AND_51(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_50_AND_51)
...
#define SPARK_MATCH_READ_PARAMETER_52_AND_53(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_52_AND_53)
...
#define SPARK_MATCH_READ_PARAMETER_54_AND_55(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_54_AND_55)
...
#define SPARK_MATCH_READ_PARAMETER_56_AND_57(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_56_AND_57)
...
#define SPARK_MATCH_READ_PARAMETER_58_AND_59(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_58_AND_59)
...
#define SPARK_MATCH_READ_PARAMETER_60_AND_61(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_60_AND_61)
...
#define SPARK_MATCH_READ_PARAMETER_62_AND_63(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_62_AND_63)
...
#define SPARK_MATCH_READ_PARAMETER_64_AND_65(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_64_AND_65)
...
#define SPARK_MATCH_READ_PARAMETER_66_AND_67(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_66_AND_67)
...
#define SPARK_MATCH_READ_PARAMETER_68_AND_69(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_68_AND_69)
...
#define SPARK_MATCH_READ_PARAMETER_70_AND_71(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_70_AND_71)
...
#define SPARK_MATCH_READ_PARAMETER_72_AND_73(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_72_AND_73)
...
#define SPARK_MATCH_READ_PARAMETER_74_AND_75(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_74_AND_75)
...
#define SPARK_MATCH_READ_PARAMETER_76_AND_77(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_76_AND_77)
...
#define SPARK_MATCH_READ_PARAMETER_78_AND_79(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_78_AND_79)
...
#define SPARK_MATCH_READ_PARAMETER_80_AND_81(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_80_AND_81)
...
#define SPARK_MATCH_READ_PARAMETER_82_AND_83(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_82_AND_83)
...
#define SPARK_MATCH_READ_PARAMETER_84_AND_85(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_84_AND_85)
...
#define SPARK_MATCH_READ_PARAMETER_86_AND_87(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_86_AND_87)
...
#define SPARK_MATCH_READ_PARAMETER_88_AND_89(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_88_AND_89)
...
#define SPARK_MATCH_READ_PARAMETER_90_AND_91(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_90_AND_91)
...
#define SPARK_MATCH_READ_PARAMETER_92_AND_93(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_92_AND_93)
...
#define SPARK_MATCH_READ_PARAMETER_94_AND_95(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_94_AND_95)
...
#define SPARK_MATCH_READ_PARAMETER_96_AND_97(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_96_AND_97)
...
#define SPARK_MATCH_READ_PARAMETER_98_AND_99(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_98_AND_99)
...
#define SPARK_MATCH_READ_PARAMETER_100_AND_101(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_100_AND_101)
...
#define SPARK_MATCH_READ_PARAMETER_102_AND_103(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_102_AND_103)
...
#define SPARK_MATCH_READ_PARAMETER_104_AND_105(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_104_AND_105)
...
#define SPARK_MATCH_READ_PARAMETER_106_AND_107(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_106_AND_107)
...
#define SPARK_MATCH_READ_PARAMETER_108_AND_109(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_108_AND_109)
...
#define SPARK_MATCH_READ_PARAMETER_110_AND_111(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_110_AND_111)
...
#define SPARK_MATCH_READ_PARAMETER_112_AND_113(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_112_AND_113)
...
#define SPARK_MATCH_READ_PARAMETER_114_AND_115(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_114_AND_115)
...
#define SPARK_MATCH_READ_PARAMETER_116_AND_117(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_116_AND_117)
...
#define SPARK_MATCH_READ_PARAMETER_118_AND_119(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_118_AND_119)
...
#define SPARK_MATCH_READ_PARAMETER_120_AND_121(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_120_AND_121)
...
#define SPARK_MATCH_READ_PARAMETER_122_AND_123(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_122_AND_123)
...
#define SPARK_MATCH_READ_PARAMETER_124_AND_125(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_124_AND_125)
...
#define SPARK_MATCH_READ_PARAMETER_126_AND_127(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_126_AND_127)
...
#define SPARK_MATCH_READ_PARAMETER_128_AND_129(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_128_AND_129)
...
#define SPARK_MATCH_READ_PARAMETER_130_AND_131(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_130_AND_131)
...
#define SPARK_MATCH_READ_PARAMETER_132_AND_133(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_132_AND_133)
...
#define SPARK_MATCH_READ_PARAMETER_134_AND_135(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_134_AND_135)
...
#define SPARK_MATCH_READ_PARAMETER_136_AND_137(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_136_AND_137)
...
#define SPARK_MATCH_READ_PARAMETER_138_AND_139(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_138_AND_139)
...
#define SPARK_MATCH_READ_PARAMETER_140_AND_141(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_140_AND_141)
...
#define SPARK_MATCH_READ_PARAMETER_142_AND_143(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_142_AND_143)
...
#define SPARK_MATCH_READ_PARAMETER_144_AND_145(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_144_AND_145)
...
#define SPARK_MATCH_READ_PARAMETER_146_AND_147(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_146_AND_147)
...
#define SPARK_MATCH_READ_PARAMETER_148_AND_149(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_148_AND_149)
...
#define SPARK_MATCH_READ_PARAMETER_150_AND_151(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_150_AND_151)
...
#define SPARK_MATCH_READ_PARAMETER_152_AND_153(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_152_AND_153)
...
#define SPARK_MATCH_READ_PARAMETER_154_AND_155(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_154_AND_155)
...
#define SPARK_MATCH_READ_PARAMETER_156_AND_157(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_156_AND_157)
...
#define SPARK_MATCH_READ_PARAMETER_158_AND_159(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_158_AND_159)
...
#define SPARK_MATCH_READ_PARAMETER_160_AND_161(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_160_AND_161)
...
#define SPARK_MATCH_READ_PARAMETER_162_AND_163(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_162_AND_163)
...
#define SPARK_MATCH_READ_PARAMETER_164_AND_165(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_164_AND_165)
...
#define SPARK_MATCH_READ_PARAMETER_166_AND_167(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_166_AND_167)
...
#define SPARK_MATCH_READ_PARAMETER_168_AND_169(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_168_AND_169)
...
#define SPARK_MATCH_READ_PARAMETER_170_AND_171(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_170_AND_171)
...
#define SPARK_MATCH_READ_PARAMETER_172_AND_173(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_172_AND_173)
...
#define SPARK_MATCH_READ_PARAMETER_174_AND_175(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_174_AND_175)
...
#define SPARK_MATCH_READ_PARAMETER_176_AND_177(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_176_AND_177)
...
#define SPARK_MATCH_READ_PARAMETER_178_AND_179(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_178_AND_179)
...
#define SPARK_MATCH_READ_PARAMETER_180_AND_181(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_180_AND_181)
...
#define SPARK_MATCH_READ_PARAMETER_182_AND_183(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_182_AND_183)
...
#define SPARK_MATCH_READ_PARAMETER_184_AND_185(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_184_AND_185)
...
#define SPARK_MATCH_READ_PARAMETER_186_AND_187(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_186_AND_187)
...
#define SPARK_MATCH_READ_PARAMETER_188_AND_189(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_188_AND_189)
...
#define SPARK_MATCH_READ_PARAMETER_190_AND_191(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_190_AND_191)
...
#define SPARK_MATCH_READ_PARAMETER_192_AND_193(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_192_AND_193)
...
#define SPARK_MATCH_READ_PARAMETER_194_AND_195(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_194_AND_195)
...
#define SPARK_MATCH_READ_PARAMETER_196_AND_197(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_196_AND_197)
...
#define SPARK_MATCH_READ_PARAMETER_198_AND_199(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_198_AND_199)
...
#define SPARK_MATCH_READ_PARAMETER_200_AND_201(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_200_AND_201)
...
#define SPARK_MATCH_READ_PARAMETER_202_AND_203(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_202_AND_203)
...
#define SPARK_MATCH_READ_PARAMETER_204_AND_205(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_204_AND_205)
...
#define SPARK_MATCH_READ_PARAMETER_206_AND_207(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_206_AND_207)
...
#define SPARK_MATCH_READ_PARAMETER_208_AND_209(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_208_AND_209)
...
#define SPARK_MATCH_READ_PARAMETER_210_AND_211(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_210_AND_211)
...
#define SPARK_MATCH_READ_PARAMETER_212_AND_213(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_212_AND_213)
...
#define SPARK_MATCH_READ_PARAMETER_214_AND_215(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_214_AND_215)
...
#define SPARK_MATCH_READ_PARAMETER_216_AND_217(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_216_AND_217)
...
#define SPARK_MATCH_READ_PARAMETER_218_AND_219(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_218_AND_219)
...
#define SPARK_MATCH_READ_PARAMETER_220_AND_221(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_220_AND_221)
...
#define SPARK_MATCH_READ_PARAMETER_222_AND_223(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_222_AND_223)
...
#define SPARK_MATCH_READ_PARAMETER_224_AND_225(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_224_AND_225)
...
#define SPARK_MATCH_READ_PARAMETER_226_AND_227(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_226_AND_227)
...
#define SPARK_MATCH_READ_PARAMETER_228_AND_229(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_228_AND_229)
...
#define SPARK_MATCH_READ_PARAMETER_230_AND_231(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_230_AND_231)
...
#define SPARK_MATCH_READ_PARAMETER_232_AND_233(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_232_AND_233)
...
#define SPARK_MATCH_READ_PARAMETER_234_AND_235(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_234_AND_235)
...
#define SPARK_MATCH_READ_PARAMETER_236_AND_237(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_236_AND_237)
...
#define SPARK_MATCH_READ_PARAMETER_238_AND_239(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_238_AND_239)
...
#define SPARK_MATCH_READ_PARAMETER_240_AND_241(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_240_AND_241)
...
#define SPARK_MATCH_READ_PARAMETER_242_AND_243(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_242_AND_243)
...
#define SPARK_MATCH_READ_PARAMETER_244_AND_245(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_244_AND_245)
...
#define SPARK_MATCH_READ_PARAMETER_246_AND_247(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_246_AND_247)
...
#define SPARK_MATCH_READ_PARAMETER_248_AND_249(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_248_AND_249)
...
#define SPARK_MATCH_READ_PARAMETER_250_AND_251(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_250_AND_251)
...
#define SPARK_MATCH_READ_PARAMETER_252_AND_253(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_252_AND_253)
...
#define SPARK_MATCH_READ_PARAMETER_254_AND_255(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_READ_PARAMETER_254_AND_255)
...
#define SPARK_MATCH_WRITE_PARAMETER_0_AND_1(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_0_AND_1)
...
#define SPARK_MATCH_WRITE_PARAMETER_2_AND_3(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_2_AND_3)
...
#define SPARK_MATCH_WRITE_PARAMETER_4_AND_5(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_4_AND_5)
...
#define SPARK_MATCH_WRITE_PARAMETER_6_AND_7(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_6_AND_7)
...
#define SPARK_MATCH_WRITE_PARAMETER_8_AND_9(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_8_AND_9)
...
#define SPARK_MATCH_WRITE_PARAMETER_10_AND_11(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_10_AND_11)
...
#define SPARK_MATCH_WRITE_PARAMETER_12_AND_13(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_12_AND_13)
...
#define SPARK_MATCH_WRITE_PARAMETER_14_AND_15(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_14_AND_15)
...
#define SPARK_MATCH_WRITE_PARAMETER_16_AND_17(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_16_AND_17)
...
#define SPARK_MATCH_WRITE_PARAMETER_18_AND_19(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_18_AND_19)
...
#define SPARK_MATCH_WRITE_PARAMETER_20_AND_21(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_20_AND_21)
...
#define SPARK_MATCH_WRITE_PARAMETER_22_AND_23(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_22_AND_23)
...
#define SPARK_MATCH_WRITE_PARAMETER_24_AND_25(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_24_AND_25)
...
#define SPARK_MATCH_WRITE_PARAMETER_26_AND_27(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_26_AND_27)
...
#define SPARK_MATCH_WRITE_PARAMETER_28_AND_29(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_28_AND_29)
...
#define SPARK_MATCH_WRITE_PARAMETER_30_AND_31(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_30_AND_31)
...
#define SPARK_MATCH_WRITE_PARAMETER_32_AND_33(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_32_AND_33)
...
#define SPARK_MATCH_WRITE_PARAMETER_34_AND_35(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_34_AND_35)
...
#define SPARK_MATCH_WRITE_PARAMETER_36_AND_37(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_36_AND_37)
...
#define SPARK_MATCH_WRITE_PARAMETER_38_AND_39(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_38_AND_39)
...
#define SPARK_MATCH_WRITE_PARAMETER_40_AND_41(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_40_AND_41)
...
#define SPARK_MATCH_WRITE_PARAMETER_42_AND_43(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_42_AND_43)
...
#define SPARK_MATCH_WRITE_PARAMETER_44_AND_45(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_44_AND_45)
...
#define SPARK_MATCH_WRITE_PARAMETER_46_AND_47(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_46_AND_47)
...
#define SPARK_MATCH_WRITE_PARAMETER_48_AND_49(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_48_AND_49)
...
#define SPARK_MATCH_WRITE_PARAMETER_50_AND_51(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_50_AND_51)
...
#define SPARK_MATCH_WRITE_PARAMETER_52_AND_53(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_52_AND_53)
...
#define SPARK_MATCH_WRITE_PARAMETER_54_AND_55(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_54_AND_55)
...
#define SPARK_MATCH_WRITE_PARAMETER_56_AND_57(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_56_AND_57)
...
#define SPARK_MATCH_WRITE_PARAMETER_58_AND_59(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_58_AND_59)
...
#define SPARK_MATCH_WRITE_PARAMETER_60_AND_61(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_60_AND_61)
...
#define SPARK_MATCH_WRITE_PARAMETER_62_AND_63(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_62_AND_63)
...
#define SPARK_MATCH_WRITE_PARAMETER_64_AND_65(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_64_AND_65)
...
#define SPARK_MATCH_WRITE_PARAMETER_66_AND_67(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_66_AND_67)
...
#define SPARK_MATCH_WRITE_PARAMETER_68_AND_69(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_68_AND_69)
...
#define SPARK_MATCH_WRITE_PARAMETER_70_AND_71(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_70_AND_71)
...
#define SPARK_MATCH_WRITE_PARAMETER_72_AND_73(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_72_AND_73)
...
#define SPARK_MATCH_WRITE_PARAMETER_74_AND_75(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_74_AND_75)
...
#define SPARK_MATCH_WRITE_PARAMETER_76_AND_77(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_76_AND_77)
...
#define SPARK_MATCH_WRITE_PARAMETER_78_AND_79(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_78_AND_79)
...
#define SPARK_MATCH_WRITE_PARAMETER_80_AND_81(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_80_AND_81)
...
#define SPARK_MATCH_WRITE_PARAMETER_82_AND_83(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_82_AND_83)
...
#define SPARK_MATCH_WRITE_PARAMETER_84_AND_85(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_84_AND_85)
...
#define SPARK_MATCH_WRITE_PARAMETER_86_AND_87(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_86_AND_87)
...
#define SPARK_MATCH_WRITE_PARAMETER_88_AND_89(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_88_AND_89)
...
#define SPARK_MATCH_WRITE_PARAMETER_90_AND_91(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_90_AND_91)
...
#define SPARK_MATCH_WRITE_PARAMETER_92_AND_93(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_92_AND_93)
...
#define SPARK_MATCH_WRITE_PARAMETER_94_AND_95(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_94_AND_95)
...
#define SPARK_MATCH_WRITE_PARAMETER_96_AND_97(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_96_AND_97)
...
#define SPARK_MATCH_WRITE_PARAMETER_98_AND_99(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_98_AND_99)
...
#define SPARK_MATCH_WRITE_PARAMETER_100_AND_101(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_100_AND_101)
...
#define SPARK_MATCH_WRITE_PARAMETER_102_AND_103(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_102_AND_103)
...
#define SPARK_MATCH_WRITE_PARAMETER_104_AND_105(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_104_AND_105)
...
#define SPARK_MATCH_WRITE_PARAMETER_106_AND_107(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_106_AND_107)
...
#define SPARK_MATCH_WRITE_PARAMETER_108_AND_109(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_108_AND_109)
...
#define SPARK_MATCH_WRITE_PARAMETER_110_AND_111(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_110_AND_111)
...
#define SPARK_MATCH_WRITE_PARAMETER_112_AND_113(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_112_AND_113)
...
#define SPARK_MATCH_WRITE_PARAMETER_114_AND_115(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_114_AND_115)
...
#define SPARK_MATCH_WRITE_PARAMETER_116_AND_117(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_116_AND_117)
...
#define SPARK_MATCH_WRITE_PARAMETER_118_AND_119(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_118_AND_119)
...
#define SPARK_MATCH_WRITE_PARAMETER_120_AND_121(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_120_AND_121)
...
#define SPARK_MATCH_WRITE_PARAMETER_122_AND_123(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_122_AND_123)
...
#define SPARK_MATCH_WRITE_PARAMETER_124_AND_125(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_124_AND_125)
...
#define SPARK_MATCH_WRITE_PARAMETER_126_AND_127(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_126_AND_127)
...
#define SPARK_MATCH_WRITE_PARAMETER_128_AND_129(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_128_AND_129)
...
#define SPARK_MATCH_WRITE_PARAMETER_130_AND_131(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_130_AND_131)
...
#define SPARK_MATCH_WRITE_PARAMETER_132_AND_133(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_132_AND_133)
...
#define SPARK_MATCH_WRITE_PARAMETER_134_AND_135(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_134_AND_135)
...
#define SPARK_MATCH_WRITE_PARAMETER_136_AND_137(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_136_AND_137)
...
#define SPARK_MATCH_WRITE_PARAMETER_138_AND_139(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_138_AND_139)
...
#define SPARK_MATCH_WRITE_PARAMETER_140_AND_141(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_140_AND_141)
...
#define SPARK_MATCH_WRITE_PARAMETER_142_AND_143(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_142_AND_143)
...
#define SPARK_MATCH_WRITE_PARAMETER_144_AND_145(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_144_AND_145)
...
#define SPARK_MATCH_WRITE_PARAMETER_146_AND_147(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_146_AND_147)
...
#define SPARK_MATCH_WRITE_PARAMETER_148_AND_149(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_148_AND_149)
...
#define SPARK_MATCH_WRITE_PARAMETER_150_AND_151(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_150_AND_151)
...
#define SPARK_MATCH_WRITE_PARAMETER_152_AND_153(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_152_AND_153)
...
#define SPARK_MATCH_WRITE_PARAMETER_154_AND_155(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_154_AND_155)
...
#define SPARK_MATCH_WRITE_PARAMETER_156_AND_157(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_156_AND_157)
...
#define SPARK_MATCH_WRITE_PARAMETER_158_AND_159(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_158_AND_159)
...
#define SPARK_MATCH_WRITE_PARAMETER_160_AND_161(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_160_AND_161)
...
#define SPARK_MATCH_WRITE_PARAMETER_162_AND_163(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_162_AND_163)
...
#define SPARK_MATCH_WRITE_PARAMETER_164_AND_165(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_164_AND_165)
...
#define SPARK_MATCH_WRITE_PARAMETER_166_AND_167(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_166_AND_167)
...
#define SPARK_MATCH_WRITE_PARAMETER_168_AND_169(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_168_AND_169)
...
#define SPARK_MATCH_WRITE_PARAMETER_170_AND_171(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_170_AND_171)
...
#define SPARK_MATCH_WRITE_PARAMETER_172_AND_173(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_172_AND_173)
...
#define SPARK_MATCH_WRITE_PARAMETER_174_AND_175(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_174_AND_175)
...
#define SPARK_MATCH_WRITE_PARAMETER_176_AND_177(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_176_AND_177)
...
#define SPARK_MATCH_WRITE_PARAMETER_178_AND_179(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_178_AND_179)
...
#define SPARK_MATCH_WRITE_PARAMETER_180_AND_181(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_180_AND_181)
...
#define SPARK_MATCH_WRITE_PARAMETER_182_AND_183(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_182_AND_183)
...
#define SPARK_MATCH_WRITE_PARAMETER_184_AND_185(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_184_AND_185)
...
#define SPARK_MATCH_WRITE_PARAMETER_186_AND_187(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_186_AND_187)
...
#define SPARK_MATCH_WRITE_PARAMETER_188_AND_189(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_188_AND_189)
...
#define SPARK_MATCH_WRITE_PARAMETER_190_AND_191(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_190_AND_191)
...
#define SPARK_MATCH_WRITE_PARAMETER_192_AND_193(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_192_AND_193)
...
#define SPARK_MATCH_WRITE_PARAMETER_194_AND_195(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_194_AND_195)
...
#define SPARK_MATCH_WRITE_PARAMETER_196_AND_197(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_196_AND_197)
...
#define SPARK_MATCH_WRITE_PARAMETER_198_AND_199(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_198_AND_199)
...
#define SPARK_MATCH_WRITE_PARAMETER_200_AND_201(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_200_AND_201)
...
#define SPARK_MATCH_WRITE_PARAMETER_202_AND_203(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_202_AND_203)
...
#define SPARK_MATCH_WRITE_PARAMETER_204_AND_205(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_204_AND_205)
...
#define SPARK_MATCH_WRITE_PARAMETER_206_AND_207(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_206_AND_207)
...
#define SPARK_MATCH_WRITE_PARAMETER_208_AND_209(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_208_AND_209)
...
#define SPARK_MATCH_WRITE_PARAMETER_210_AND_211(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_210_AND_211)
...
#define SPARK_MATCH_WRITE_PARAMETER_212_AND_213(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_212_AND_213)
...
#define SPARK_MATCH_WRITE_PARAMETER_214_AND_215(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_214_AND_215)
...
#define SPARK_MATCH_WRITE_PARAMETER_216_AND_217(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_216_AND_217)
...
#define SPARK_MATCH_WRITE_PARAMETER_218_AND_219(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_218_AND_219)
...
#define SPARK_MATCH_WRITE_PARAMETER_220_AND_221(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_220_AND_221)
...
#define SPARK_MATCH_WRITE_PARAMETER_222_AND_223(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_222_AND_223)
...
#define SPARK_MATCH_WRITE_PARAMETER_224_AND_225(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_224_AND_225)
...
#define SPARK_MATCH_WRITE_PARAMETER_226_AND_227(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_226_AND_227)
...
#define SPARK_MATCH_WRITE_PARAMETER_228_AND_229(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_228_AND_229)
...
#define SPARK_MATCH_WRITE_PARAMETER_230_AND_231(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_230_AND_231)
...
#define SPARK_MATCH_WRITE_PARAMETER_232_AND_233(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_232_AND_233)
...
#define SPARK_MATCH_WRITE_PARAMETER_234_AND_235(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_234_AND_235)
...
#define SPARK_MATCH_WRITE_PARAMETER_236_AND_237(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_236_AND_237)
...
#define SPARK_MATCH_WRITE_PARAMETER_238_AND_239(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_238_AND_239)
...
#define SPARK_MATCH_WRITE_PARAMETER_240_AND_241(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_240_AND_241)
...
#define SPARK_MATCH_WRITE_PARAMETER_242_AND_243(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_242_AND_243)
...
#define SPARK_MATCH_WRITE_PARAMETER_244_AND_245(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_244_AND_245)
...
#define SPARK_MATCH_WRITE_PARAMETER_246_AND_247(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_246_AND_247)
...
#define SPARK_MATCH_WRITE_PARAMETER_248_AND_249(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_248_AND_249)
...
#define SPARK_MATCH_WRITE_PARAMETER_250_AND_251(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_250_AND_251)
...
#define SPARK_MATCH_WRITE_PARAMETER_252_AND_253(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_252_AND_253)
...
#define SPARK_MATCH_WRITE_PARAMETER_254_AND_255(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_254_AND_255)
...
#define SPARK_MATCH_START_FOLLOWER_MODE(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_START_FOLLOWER_MODE)
// Match arbitration ID for frame Start Follower Mode Response: Response for a Start Follower Mode command
#define SPARK_MATCH_START_FOLLOWER_MODE_RESPONSE(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_START_FOLLOWER_MODE_RESPONSE)
...
#define SPARK_MATCH_STOP_FOLLOWER_MODE(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_STOP_FOLLOWER_MODE)
// Match arbitration ID for frame Stop Follower Mode Response: Response for a Stop Follower Mode Command
#define SPARK_MATCH_STOP_FOLLOWER_MODE_RESPONSE(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_STOP_FOLLOWER_MODE_RESPONSE)
// Match arbitration ID for frame Enter SWDL CAN Bootloader
#define SPARK_MATCH_ENTER_SWDL_CAN_BOOTLOADER(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_ENTER_SWDL_CAN_BOOTLOADER)
...
#define SPARK_MATCH_PERSIST_PARAMETERS(id) ((((uint32_t)(id)) & ~((uint32_t)SPARK_DEVICE_ID_MASK)) == (uint32_t)SPARK_ARB_PERSIST_PARAMETERS)
