...
#define SPARK_MATCH_LEGACY_STATUS_0(id)                                                                                \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_LEGACY_STATUS_0)
...
#define SPARK_MATCH_UNIQUE_ID_BROADCAST(id)                                                                            \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_UNIQUE_ID_BROADCAST)
...
#define SPARK_MATCH_VELOCITY_SETPOINT(id)                                                                              \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_VELOCITY_SETPOINT)
...
#define SPARK_MATCH_DUTY_CYCLE_SETPOINT(id)                                                                            \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_DUTY_CYCLE_SETPOINT)
...
#define SPARK_MATCH_POSITION_SETPOINT(id)                                                                              \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_POSITION_SETPOINT)
...
#define SPARK_MATCH_VOLTAGE_SETPOINT(id)                                                                               \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_VOLTAGE_SETPOINT)
...
#define SPARK_MATCH_CURRENT_SETPOINT(id)                                                                               \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_CURRENT_SETPOINT)
...
#define SPARK_MATCH_MAXMOTION_POSITION_SETPOINT(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_MAXMOTION_POSITION_SETPOINT)
...
#define SPARK_MATCH_MAXMOTION_VELOCITY_SETPOINT(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_MAXMOTION_VELOCITY_SETPOINT)
...
#define SPARK_MATCH_SET_STATUSES_ENABLED(id)                                                                           \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_SET_STATUSES_ENABLED)
...
#define SPARK_MATCH_SET_STATUSES_ENABLED_RESPONSE(id)                                                                  \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_SET_STATUSES_ENABLED_RESPONSE)
// Match arbitration ID for frame Persist Parameters Response
#define SPARK_MATCH_PERSIST_PARAMETERS_RESPONSE(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_PERSIST_PARAMETERS_RESPONSE)
...
#define SPARK_MATCH_RESET_SAFE_PARAMETERS(id)                                                                          \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_RESET_SAFE_PARAMETERS)
...
#define SPARK_MATCH_RESET_SAFE_PARAMETERS_RESPONSE(id)                                                                 \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_RESET_SAFE_PARAMETERS_RESPONSE)
...
#define SPARK_MATCH_COMPLETE_FACTORY_RESET(id)                                                                         \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_COMPLETE_FACTORY_RESET)
...
#define SPARK_MATCH_COMPLETE_FACTORY_RESET_RESPONSE(id)                                                                \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_COMPLETE_FACTORY_RESET_RESPONSE)
...
#define SPARK_MATCH_IDENTIFY_UNIQUE_SPARK(id)                                                                          \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_IDENTIFY_UNIQUE_SPARK)
...
#define SPARK_MATCH_GET_FIRMWARE_VERSION(id)                                                                           \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_FIRMWARE_VERSION)
...
#define SPARK_MATCH_SECONDARY_HEARTBEAT(id)                                                                            \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_SECONDARY_HEARTBEAT)
...
#define SPARK_MATCH_USB_ONLY_IDENTIFY(id)                                                                              \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_USB_ONLY_IDENTIFY)
...
#define SPARK_MATCH_USB_ONLY_ENTER_DFU_BOOTLOADER(id)                                                                  \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_USB_ONLY_ENTER_DFU_BOOTLOADER)
// Match arbitration ID for frame Get Temperatures
#define SPARK_MATCH_GET_TEMPERATURES(id)                                                                               \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_TEMPERATURES)
// Match arbitration ID for frame Get Motor Interface
#define SPARK_MATCH_GET_MOTOR_INTERFACE(id)                                                                            \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_MOTOR_INTERFACE)
...
#define SPARK_MATCH_GET_PARAMETER_0_TO_15_TYPES(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_0_TO_15_TYPES)
...
#define SPARK_MATCH_GET_PARAMETER_16_TO_31_TYPES(id)                                                                   \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_16_TO_31_TYPES)
...
#define SPARK_MATCH_GET_PARAMETER_32_TO_47_TYPES(id)                                                                   \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_32_TO_47_TYPES)
...
#define SPARK_MATCH_GET_PARAMETER_48_TO_63_TYPES(id)                                                                   \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_48_TO_63_TYPES)
...
#define SPARK_MATCH_GET_PARAMETER_64_TO_79_TYPES(id)                                                                   \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_64_TO_79_TYPES)
...
#define SPARK_MATCH_GET_PARAMETER_80_TO_95_TYPES(id)                                                                   \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_80_TO_95_TYPES)
...
#define SPARK_MATCH_GET_PARAMETER_96_TO_111_TYPES(id)                                                                  \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_96_TO_111_TYPES)
...
#define SPARK_MATCH_GET_PARAMETER_112_TO_127_TYPES(id)                                                                 \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_112_TO_127_TYPES)
...
#define SPARK_MATCH_GET_PARAMETER_128_TO_143_TYPES(id)                                                                 \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_128_TO_143_TYPES)
...
#define SPARK_MATCH_GET_PARAMETER_144_TO_159_TYPES(id)                                                                 \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_144_TO_159_TYPES)
...
#define SPARK_MATCH_GET_PARAMETER_160_TO_175_TYPES(id)                                                                 \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_160_TO_175_TYPES)
...
#define SPARK_MATCH_GET_PARAMETER_176_TO_191_TYPES(id)                                                                 \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_176_TO_191_TYPES)
...
#define SPARK_MATCH_GET_PARAMETER_192_TO_207_TYPES(id)                                                                 \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_192_TO_207_TYPES)
...
#define SPARK_MATCH_GET_PARAMETER_208_TO_223_TYPES(id)                                                                 \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_208_TO_223_TYPES)
...
#define SPARK_MATCH_GET_PARAMETER_224_TO_239_TYPES(id)                                                                 \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_224_TO_239_TYPES)
...
#define SPARK_MATCH_GET_PARAMETER_240_TO_255_TYPES(id)                                                                 \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_GET_PARAMETER_240_TO_255_TYPES)
...
#define SPARK_MATCH_PARAMETER_WRITE(id)                                                                                \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_PARAMETER_WRITE)
...
#define SPARK_MATCH_PARAMETER_WRITE_RESPONSE(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_PARAMETER_WRITE_RESPONSE)
...
#define SPARK_MATCH_READ_PARAMETER_0_AND_1(id)                                                                         \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_0_AND_1)
...
#define SPARK_MATCH_READ_PARAMETER_2_AND_3(id)                                                                         \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_2_AND_3)
...
#define SPARK_MATCH_READ_PARAMETER_4_AND_5(id)                                                                         \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_4_AND_5)
...
#define SPARK_MATCH_READ_PARAMETER_6_AND_7(id)                                                                         \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_6_AND_7)
...
#define SPARK_MATCH_READ_PARAMETER_8_AND_9(id)                                                                         \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_8_AND_9)
...
#define SPARK_MATCH_READ_PARAMETER_10_AND_11(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_10_AND_11)
...
#define SPARK_MATCH_READ_PARAMETER_12_AND_13(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_12_AND_13)
...
#define SPARK_MATCH_READ_PARAMETER_14_AND_15(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_14_AND_15)
...
#define SPARK_MATCH_READ_PARAMETER_16_AND_17(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_16_AND_17)
...
#define SPARK_MATCH_READ_PARAMETER_18_AND_19(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_18_AND_19)
...
#define SPARK_MATCH_READ_PARAMETER_20_AND_21(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_20_AND_21)
...
#define SPARK_MATCH_READ_PARAMETER_22_AND_23(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_22_AND_23)
...
#define SPARK_MATCH_READ_PARAMETER_24_AND_25(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_24_AND_25)
...
#define SPARK_MATCH_READ_PARAMETER_26_AND_27(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_26_AND_27)
...
#define SPARK_MATCH_READ_PARAMETER_28_AND_29(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_28_AND_29)
...
#define SPARK_MATCH_READ_PARAMETER_30_AND_31(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_30_AND_31)
...
#define SPARK_MATCH_READ_PARAMETER_32_AND_33(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_32_AND_33)
...
#define SPARK_MATCH_READ_PARAMETER_34_AND_35(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_34_AND_35)
...
#define SPARK_MATCH_READ_PARAMETER_36_AND_37(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_36_AND_37)
...
#define SPARK_MATCH_READ_PARAMETER_38_AND_39(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_38_AND_39)
...
#define SPARK_MATCH_READ_PARAMETER_40_AND_41(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_40_AND_41)
...
#define SPARK_MATCH_READ_PARAMETER_42_AND_43(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_42_AND_43)
...
#define SPARK_MATCH_READ_PARAMETER_44_AND_45(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_44_AND_45)
...
#define SPARK_MATCH_READ_PARAMETER_46_AND_47(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_46_AND_47)
...
#define SPARK_MATCH_READ_PARAMETER_48_AND_49(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_48_AND_49)
...
#define SPARK_MATCH_READ_PARAMETER_50_AND_51(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_50_AND_51)
...
#define SPARK_MATCH_READ_PARAMETER_52_AND_53(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_52_AND_53)
...
#define SPARK_MATCH_READ_PARAMETER_54_AND_55(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_54_AND_55)
...
#define SPARK_MATCH_READ_PARAMETER_56_AND_57(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_56_AND_57)
...
#define SPARK_MATCH_READ_PARAMETER_58_AND_59(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_58_AND_59)
...
#define SPARK_MATCH_READ_PARAMETER_60_AND_61(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_60_AND_61)
...
#define SPARK_MATCH_READ_PARAMETER_62_AND_63(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_62_AND_63)
...
#define SPARK_MATCH_READ_PARAMETER_64_AND_65(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_64_AND_65)
...
#define SPARK_MATCH_READ_PARAMETER_66_AND_67(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_66_AND_67)
...
#define SPARK_MATCH_READ_PARAMETER_68_AND_69(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_68_AND_69)
...
#define SPARK_MATCH_READ_PARAMETER_70_AND_71(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_70_AND_71)
...
#define SPARK_MATCH_READ_PARAMETER_72_AND_73(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_72_AND_73)
...
#define SPARK_MATCH_READ_PARAMETER_74_AND_75(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_74_AND_75)
...
#define SPARK_MATCH_READ_PARAMETER_76_AND_77(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_76_AND_77)
...
#define SPARK_MATCH_READ_PARAMETER_78_AND_79(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_78_AND_79)
...
#define SPARK_MATCH_READ_PARAMETER_80_AND_81(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_80_AND_81)
...
#define SPARK_MATCH_READ_PARAMETER_82_AND_83(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_82_AND_83)
...
#define SPARK_MATCH_READ_PARAMETER_84_AND_85(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_84_AND_85)
...
#define SPARK_MATCH_READ_PARAMETER_86_AND_87(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_86_AND_87)
...
#define SPARK_MATCH_READ_PARAMETER_88_AND_89(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_88_AND_89)
...
#define SPARK_MATCH_READ_PARAMETER_90_AND_91(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_90_AND_91)
...
#define SPARK_MATCH_READ_PARAMETER_92_AND_93(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_92_AND_93)
...
#define SPARK_MATCH_READ_PARAMETER_94_AND_95(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_94_AND_95)
...
#define SPARK_MATCH_READ_PARAMETER_96_AND_97(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_96_AND_97)
...
#define SPARK_MATCH_READ_PARAMETER_98_AND_99(id)                                                                       \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_98_AND_99)
...
#define SPARK_MATCH_READ_PARAMETER_100_AND_101(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_100_AND_101)
...
#define SPARK_MATCH_READ_PARAMETER_102_AND_103(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_102_AND_103)
...
#define SPARK_MATCH_READ_PARAMETER_104_AND_105(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_104_AND_105)
...
#define SPARK_MATCH_READ_PARAMETER_106_AND_107(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_106_AND_107)
...
#define SPARK_MATCH_READ_PARAMETER_108_AND_109(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_108_AND_109)
...
#define SPARK_MATCH_READ_PARAMETER_110_AND_111(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_110_AND_111)
...
#define SPARK_MATCH_READ_PARAMETER_112_AND_113(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_112_AND_113)
...
#define SPARK_MATCH_READ_PARAMETER_114_AND_115(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_114_AND_115)
...
#define SPARK_MATCH_READ_PARAMETER_116_AND_117(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_116_AND_117)
...
#define SPARK_MATCH_READ_PARAMETER_118_AND_119(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_118_AND_119)
...
#define SPARK_MATCH_READ_PARAMETER_120_AND_121(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_120_AND_121)
...
#define SPARK_MATCH_READ_PARAMETER_122_AND_123(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_122_AND_123)
...
#define SPARK_MATCH_READ_PARAMETER_124_AND_125(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_124_AND_125)
...
#define SPARK_MATCH_READ_PARAMETER_126_AND_127(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_126_AND_127)
...
#define SPARK_MATCH_READ_PARAMETER_128_AND_129(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_128_AND_129)
...
#define SPARK_MATCH_READ_PARAMETER_130_AND_131(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_130_AND_131)
...
#define SPARK_MATCH_READ_PARAMETER_132_AND_133(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_132_AND_133)
...
#define SPARK_MATCH_READ_PARAMETER_134_AND_135(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_134_AND_135)
...
#define SPARK_MATCH_READ_PARAMETER_136_AND_137(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_136_AND_137)
...
#define SPARK_MATCH_READ_PARAMETER_138_AND_139(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_138_AND_139)
...
#define SPARK_MATCH_READ_PARAMETER_140_AND_141(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_140_AND_141)
...
#define SPARK_MATCH_READ_PARAMETER_142_AND_143(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_142_AND_143)
...
#define SPARK_MATCH_READ_PARAMETER_144_AND_145(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_144_AND_145)
...
#define SPARK_MATCH_READ_PARAMETER_146_AND_147(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_146_AND_147)
...
#define SPARK_MATCH_READ_PARAMETER_148_AND_149(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_148_AND_149)
...
#define SPARK_MATCH_READ_PARAMETER_150_AND_151(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_150_AND_151)
...
#define SPARK_MATCH_READ_PARAMETER_152_AND_153(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_152_AND_153)
...
#define SPARK_MATCH_READ_PARAMETER_154_AND_155(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_154_AND_155)
...
#define SPARK_MATCH_READ_PARAMETER_156_AND_157(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_156_AND_157)
...
#define SPARK_MATCH_READ_PARAMETER_158_AND_159(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_158_AND_159)
...
#define SPARK_MATCH_READ_PARAMETER_160_AND_161(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_160_AND_161)
...
#define SPARK_MATCH_READ_PARAMETER_162_AND_163(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_162_AND_163)
...
#define SPARK_MATCH_READ_PARAMETER_164_AND_165(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_164_AND_165)
...
#define SPARK_MATCH_READ_PARAMETER_166_AND_167(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_166_AND_167)
...
#define SPARK_MATCH_READ_PARAMETER_168_AND_169(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_168_AND_169)
...
#define SPARK_MATCH_READ_PARAMETER_170_AND_171(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_170_AND_171)
...
#define SPARK_MATCH_READ_PARAMETER_172_AND_173(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_172_AND_173)
...
#define SPARK_MATCH_READ_PARAMETER_174_AND_175(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_174_AND_175)
...
#define SPARK_MATCH_READ_PARAMETER_176_AND_177(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_176_AND_177)
...
#define SPARK_MATCH_READ_PARAMETER_178_AND_179(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_178_AND_179)
...
#define SPARK_MATCH_READ_PARAMETER_180_AND_181(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_180_AND_181)
...
#define SPARK_MATCH_READ_PARAMETER_182_AND_183(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_182_AND_183)
...
#define SPARK_MATCH_READ_PARAMETER_184_AND_185(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_184_AND_185)
...
#define SPARK_MATCH_READ_PARAMETER_186_AND_187(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_186_AND_187)
...
#define SPARK_MATCH_READ_PARAMETER_188_AND_189(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_188_AND_189)
...
#define SPARK_MATCH_READ_PARAMETER_190_AND_191(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_190_AND_191)
...
#define SPARK_MATCH_READ_PARAMETER_192_AND_193(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_192_AND_193)
...
#define SPARK_MATCH_READ_PARAMETER_194_AND_195(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_194_AND_195)
...
#define SPARK_MATCH_READ_PARAMETER_196_AND_197(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_196_AND_197)
...
#define SPARK_MATCH_READ_PARAMETER_198_AND_199(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_198_AND_199)
...
#define SPARK_MATCH_READ_PARAMETER_200_AND_201(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_200_AND_201)
...
#define SPARK_MATCH_READ_PARAMETER_202_AND_203(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_202_AND_203)
...
#define SPARK_MATCH_READ_PARAMETER_204_AND_205(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_204_AND_205)
...
#define SPARK_MATCH_READ_PARAMETER_206_AND_207(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_206_AND_207)
...
#define SPARK_MATCH_READ_PARAMETER_208_AND_209(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_208_AND_209)
...
#define SPARK_MATCH_READ_PARAMETER_210_AND_211(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_210_AND_211)
...
#define SPARK_MATCH_READ_PARAMETER_212_AND_213(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_212_AND_213)
...
#define SPARK_MATCH_READ_PARAMETER_214_AND_215(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_214_AND_215)
...
#define SPARK_MATCH_READ_PARAMETER_216_AND_217(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_216_AND_217)
...
#define SPARK_MATCH_READ_PARAMETER_218_AND_219(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_218_AND_219)
...
#define SPARK_MATCH_READ_PARAMETER_220_AND_221(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_220_AND_221)
...
#define SPARK_MATCH_READ_PARAMETER_222_AND_223(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_222_AND_223)
...
#define SPARK_MATCH_READ_PARAMETER_224_AND_225(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_224_AND_225)
...
#define SPARK_MATCH_READ_PARAMETER_226_AND_227(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_226_AND_227)
...
#define SPARK_MATCH_READ_PARAMETER_228_AND_229(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_228_AND_229)
...
#define SPARK_MATCH_READ_PARAMETER_230_AND_231(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_230_AND_231)
...
#define SPARK_MATCH_READ_PARAMETER_232_AND_233(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_232_AND_233)
...
#define SPARK_MATCH_READ_PARAMETER_234_AND_235(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_234_AND_235)
...
#define SPARK_MATCH_READ_PARAMETER_236_AND_237(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_236_AND_237)
...
#define SPARK_MATCH_READ_PARAMETER_238_AND_239(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_238_AND_239)
...
#define SPARK_MATCH_READ_PARAMETER_240_AND_241(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_240_AND_241)
...
#define SPARK_MATCH_READ_PARAMETER_242_AND_243(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_242_AND_243)
...
#define SPARK_MATCH_READ_PARAMETER_244_AND_245(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_244_AND_245)
...
#define SPARK_MATCH_READ_PARAMETER_246_AND_247(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_246_AND_247)
...
#define SPARK_MATCH_READ_PARAMETER_248_AND_249(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_248_AND_249)
...
#define SPARK_MATCH_READ_PARAMETER_250_AND_251(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_250_AND_251)
...
#define SPARK_MATCH_READ_PARAMETER_252_AND_253(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_252_AND_253)
...
#define SPARK_MATCH_READ_PARAMETER_254_AND_255(id)                                                                     \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_READ_PARAMETER_254_AND_255)
...
#define SPARK_MATCH_WRITE_PARAMETER_0_AND_1(id)                                                                        \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_0_AND_1)
...
#define SPARK_MATCH_WRITE_PARAMETER_2_AND_3(id)                                                                        \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_2_AND_3)
...
#define SPARK_MATCH_WRITE_PARAMETER_4_AND_5(id)                                                                        \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_4_AND_5)
...
#define SPARK_MATCH_WRITE_PARAMETER_6_AND_7(id)                                                                        \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_6_AND_7)
...
#define SPARK_MATCH_WRITE_PARAMETER_8_AND_9(id)                                                                        \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_8_AND_9)
...
#define SPARK_MATCH_WRITE_PARAMETER_10_AND_11(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_10_AND_11)
...
#define SPARK_MATCH_WRITE_PARAMETER_12_AND_13(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_12_AND_13)
...
#define SPARK_MATCH_WRITE_PARAMETER_14_AND_15(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_14_AND_15)
...
#define SPARK_MATCH_WRITE_PARAMETER_16_AND_17(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_16_AND_17)
...
#define SPARK_MATCH_WRITE_PARAMETER_18_AND_19(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_18_AND_19)
...
#define SPARK_MATCH_WRITE_PARAMETER_20_AND_21(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_20_AND_21)
...
#define SPARK_MATCH_WRITE_PARAMETER_22_AND_23(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_22_AND_23)
...
#define SPARK_MATCH_WRITE_PARAMETER_24_AND_25(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_24_AND_25)
...
#define SPARK_MATCH_WRITE_PARAMETER_26_AND_27(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_26_AND_27)
...
#define SPARK_MATCH_WRITE_PARAMETER_28_AND_29(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_28_AND_29)
...
#define SPARK_MATCH_WRITE_PARAMETER_30_AND_31(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_30_AND_31)
...
#define SPARK_MATCH_WRITE_PARAMETER_32_AND_33(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_32_AND_33)
...
#define SPARK_MATCH_WRITE_PARAMETER_34_AND_35(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_34_AND_35)
...
#define SPARK_MATCH_WRITE_PARAMETER_36_AND_37(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_36_AND_37)
...
#define SPARK_MATCH_WRITE_PARAMETER_38_AND_39(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_38_AND_39)
...
#define SPARK_MATCH_WRITE_PARAMETER_40_AND_41(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_40_AND_41)
...
#define SPARK_MATCH_WRITE_PARAMETER_42_AND_43(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_42_AND_43)
...
#define SPARK_MATCH_WRITE_PARAMETER_44_AND_45(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_44_AND_45)
...
#define SPARK_MATCH_WRITE_PARAMETER_46_AND_47(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_46_AND_47)
...
#define SPARK_MATCH_WRITE_PARAMETER_48_AND_49(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_48_AND_49)
...
#define SPARK_MATCH_WRITE_PARAMETER_50_AND_51(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_50_AND_51)
...
#define SPARK_MATCH_WRITE_PARAMETER_52_AND_53(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_52_AND_53)
...
#define SPARK_MATCH_WRITE_PARAMETER_54_AND_55(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_54_AND_55)
...
#define SPARK_MATCH_WRITE_PARAMETER_56_AND_57(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_56_AND_57)
...
#define SPARK_MATCH_WRITE_PARAMETER_58_AND_59(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_58_AND_59)
...
#define SPARK_MATCH_WRITE_PARAMETER_60_AND_61(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_60_AND_61)
...
#define SPARK_MATCH_WRITE_PARAMETER_62_AND_63(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_62_AND_63)
...
#define SPARK_MATCH_WRITE_PARAMETER_64_AND_65(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_64_AND_65)
...
#define SPARK_MATCH_WRITE_PARAMETER_66_AND_67(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_66_AND_67)
...
#define SPARK_MATCH_WRITE_PARAMETER_68_AND_69(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_68_AND_69)
...
#define SPARK_MATCH_WRITE_PARAMETER_70_AND_71(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_70_AND_71)
...
#define SPARK_MATCH_WRITE_PARAMETER_72_AND_73(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_72_AND_73)
...
#define SPARK_MATCH_WRITE_PARAMETER_74_AND_75(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_74_AND_75)
...
#define SPARK_MATCH_WRITE_PARAMETER_76_AND_77(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_76_AND_77)
...
#define SPARK_MATCH_WRITE_PARAMETER_78_AND_79(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_78_AND_79)
...
#define SPARK_MATCH_WRITE_PARAMETER_80_AND_81(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_80_AND_81)
...
#define SPARK_MATCH_WRITE_PARAMETER_82_AND_83(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_82_AND_83)
...
#define SPARK_MATCH_WRITE_PARAMETER_84_AND_85(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_84_AND_85)
...
#define SPARK_MATCH_WRITE_PARAMETER_86_AND_87(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_86_AND_87)
...
#define SPARK_MATCH_WRITE_PARAMETER_88_AND_89(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_88_AND_89)
...
#define SPARK_MATCH_WRITE_PARAMETER_90_AND_91(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_90_AND_91)
...
#define SPARK_MATCH_WRITE_PARAMETER_92_AND_93(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_92_AND_93)
...
#define SPARK_MATCH_WRITE_PARAMETER_94_AND_95(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_94_AND_95)
...
#define SPARK_MATCH_WRITE_PARAMETER_96_AND_97(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_96_AND_97)
...
#define SPARK_MATCH_WRITE_PARAMETER_98_AND_99(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_98_AND_99)
...
#define SPARK_MATCH_WRITE_PARAMETER_100_AND_101(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_100_AND_101)
...
#define SPARK_MATCH_WRITE_PARAMETER_102_AND_103(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_102_AND_103)
...
#define SPARK_MATCH_WRITE_PARAMETER_104_AND_105(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_104_AND_105)
...
#define SPARK_MATCH_WRITE_PARAMETER_106_AND_107(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_106_AND_107)
...
#define SPARK_MATCH_WRITE_PARAMETER_108_AND_109(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_108_AND_109)
...
#define SPARK_MATCH_WRITE_PARAMETER_110_AND_111(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_110_AND_111)
...
#define SPARK_MATCH_WRITE_PARAMETER_112_AND_113(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_112_AND_113)
...
#define SPARK_MATCH_WRITE_PARAMETER_114_AND_115(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_114_AND_115)
...
#define SPARK_MATCH_WRITE_PARAMETER_116_AND_117(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_116_AND_117)
...
#define SPARK_MATCH_WRITE_PARAMETER_118_AND_119(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_118_AND_119)
...
#define SPARK_MATCH_WRITE_PARAMETER_120_AND_121(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_120_AND_121)
...
#define SPARK_MATCH_WRITE_PARAMETER_122_AND_123(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_122_AND_123)
...
#define SPARK_MATCH_WRITE_PARAMETER_124_AND_125(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_124_AND_125)
...
#define SPARK_MATCH_WRITE_PARAMETER_126_AND_127(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_126_AND_127)
...
#define SPARK_MATCH_WRITE_PARAMETER_128_AND_129(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_128_AND_129)
...
#define SPARK_MATCH_WRITE_PARAMETER_130_AND_131(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_130_AND_131)
...
#define SPARK_MATCH_WRITE_PARAMETER_132_AND_133(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_132_AND_133)
...
#define SPARK_MATCH_WRITE_PARAMETER_134_AND_135(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_134_AND_135)
...
#define SPARK_MATCH_WRITE_PARAMETER_136_AND_137(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_136_AND_137)
...
#define SPARK_MATCH_WRITE_PARAMETER_138_AND_139(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_138_AND_139)
...
#define SPARK_MATCH_WRITE_PARAMETER_140_AND_141(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_140_AND_141)
...
#define SPARK_MATCH_WRITE_PARAMETER_142_AND_143(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_142_AND_143)
...
#define SPARK_MATCH_WRITE_PARAMETER_144_AND_145(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_144_AND_145)
...
#define SPARK_MATCH_WRITE_PARAMETER_146_AND_147(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_146_AND_147)
...
#define SPARK_MATCH_WRITE_PARAMETER_148_AND_149(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_148_AND_149)
...
#define SPARK_MATCH_WRITE_PARAMETER_150_AND_151(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_150_AND_151)
...
#define SPARK_MATCH_WRITE_PARAMETER_152_AND_153(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_152_AND_153)
...
#define SPARK_MATCH_WRITE_PARAMETER_154_AND_155(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_154_AND_155)
...
#define SPARK_MATCH_WRITE_PARAMETER_156_AND_157(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_156_AND_157)
...
#define SPARK_MATCH_WRITE_PARAMETER_158_AND_159(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_158_AND_159)
...
#define SPARK_MATCH_WRITE_PARAMETER_160_AND_161(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_160_AND_161)
...
#define SPARK_MATCH_WRITE_PARAMETER_162_AND_163(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_162_AND_163)
...
#define SPARK_MATCH_WRITE_PARAMETER_164_AND_165(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_164_AND_165)
...
#define SPARK_MATCH_WRITE_PARAMETER_166_AND_167(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_166_AND_167)
...
#define SPARK_MATCH_WRITE_PARAMETER_168_AND_169(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_168_AND_169)
...
#define SPARK_MATCH_WRITE_PARAMETER_170_AND_171(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_170_AND_171)
...
#define SPARK_MATCH_WRITE_PARAMETER_172_AND_173(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_172_AND_173)
...
#define SPARK_MATCH_WRITE_PARAMETER_174_AND_175(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_174_AND_175)
...
#define SPARK_MATCH_WRITE_PARAMETER_176_AND_177(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_176_AND_177)
...
#define SPARK_MATCH_WRITE_PARAMETER_178_AND_179(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_178_AND_179)
...
#define SPARK_MATCH_WRITE_PARAMETER_180_AND_181(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_180_AND_181)
...
#define SPARK_MATCH_WRITE_PARAMETER_182_AND_183(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_182_AND_183)
...
#define SPARK_MATCH_WRITE_PARAMETER_184_AND_185(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_184_AND_185)
...
#define SPARK_MATCH_WRITE_PARAMETER_186_AND_187(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_186_AND_187)
...
#define SPARK_MATCH_WRITE_PARAMETER_188_AND_189(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_188_AND_189)
...
#define SPARK_MATCH_WRITE_PARAMETER_190_AND_191(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_190_AND_191)
...
#define SPARK_MATCH_WRITE_PARAMETER_192_AND_193(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_192_AND_193)
...
#define SPARK_MATCH_WRITE_PARAMETER_194_AND_195(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_194_AND_195)
...
#define SPARK_MATCH_WRITE_PARAMETER_196_AND_197(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_196_AND_197)
...
#define SPARK_MATCH_WRITE_PARAMETER_198_AND_199(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_198_AND_199)
...
#define SPARK_MATCH_WRITE_PARAMETER_200_AND_201(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_200_AND_201)
...
#define SPARK_MATCH_WRITE_PARAMETER_202_AND_203(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_202_AND_203)
...
#define SPARK_MATCH_WRITE_PARAMETER_204_AND_205(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_204_AND_205)
...
#define SPARK_MATCH_WRITE_PARAMETER_206_AND_207(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_206_AND_207)
...
#define SPARK_MATCH_WRITE_PARAMETER_208_AND_209(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_208_AND_209)
...
#define SPARK_MATCH_WRITE_PARAMETER_210_AND_211(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_210_AND_211)
...
#define SPARK_MATCH_WRITE_PARAMETER_212_AND_213(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_212_AND_213)
...
#define SPARK_MATCH_WRITE_PARAMETER_214_AND_215(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_214_AND_215)
...
#define SPARK_MATCH_WRITE_PARAMETER_216_AND_217(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_216_AND_217)
...
#define SPARK_MATCH_WRITE_PARAMETER_218_AND_219(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_218_AND_219)
...
#define SPARK_MATCH_WRITE_PARAMETER_220_AND_221(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_220_AND_221)
...
#define SPARK_MATCH_WRITE_PARAMETER_222_AND_223(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_222_AND_223)
...
#define SPARK_MATCH_WRITE_PARAMETER_224_AND_225(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_224_AND_225)
...
#define SPARK_MATCH_WRITE_PARAMETER_226_AND_227(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_226_AND_227)
...
#define SPARK_MATCH_WRITE_PARAMETER_228_AND_229(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_228_AND_229)
...
#define SPARK_MATCH_WRITE_PARAMETER_230_AND_231(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_230_AND_231)
...
#define SPARK_MATCH_WRITE_PARAMETER_232_AND_233(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_232_AND_233)
...
#define SPARK_MATCH_WRITE_PARAMETER_234_AND_235(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_234_AND_235)
...
#define SPARK_MATCH_WRITE_PARAMETER_236_AND_237(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_236_AND_237)
...
#define SPARK_MATCH_WRITE_PARAMETER_238_AND_239(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_238_AND_239)
...
#define SPARK_MATCH_WRITE_PARAMETER_240_AND_241(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_240_AND_241)
...
#define SPARK_MATCH_WRITE_PARAMETER_242_AND_243(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_242_AND_243)
...
#define SPARK_MATCH_WRITE_PARAMETER_244_AND_245(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_244_AND_245)
...
#define SPARK_MATCH_WRITE_PARAMETER_246_AND_247(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_246_AND_247)
...
#define SPARK_MATCH_WRITE_PARAMETER_248_AND_249(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_248_AND_249)
...
#define SPARK_MATCH_WRITE_PARAMETER_250_AND_251(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_250_AND_251)
...
#define SPARK_MATCH_WRITE_PARAMETER_252_AND_253(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_252_AND_253)
...
#define SPARK_MATCH_WRITE_PARAMETER_254_AND_255(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_WRITE_PARAMETER_254_AND_255)
...
#define SPARK_MATCH_START_FOLLOWER_MODE(id)                                                                            \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_START_FOLLOWER_MODE)
...
#define SPARK_MATCH_START_FOLLOWER_MODE_RESPONSE(id)                                                                   \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_START_FOLLOWER_MODE_RESPONSE)
...
#define SPARK_MATCH_STOP_FOLLOWER_MODE(id)                                                                             \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_STOP_FOLLOWER_MODE)
...
#define SPARK_MATCH_STOP_FOLLOWER_MODE_RESPONSE(id)                                                                    \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_STOP_FOLLOWER_MODE_RESPONSE)
// Match arbitration ID for frame Enter SWDL CAN Bootloader
#define SPARK_MATCH_ENTER_SWDL_CAN_BOOTLOADER(id)                                                                      \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_ENTER_SWDL_CAN_BOOTLOADER)
...
#define SPARK_MATCH_PERSIST_PARAMETERS(id)                                                                             \
    ((((uint32_t)(id)) & ~SPARK_DEVICE_ID_MASK) == (uint32_t)SPARK_ARB_PERSIST_PARAMETERS)
    ...
    static inline bool spark_decode_LEGACY_STATUS_0_frame(const spark_can_frame& in, Spark_LEGACY_STATUS_0_t* out)
    {
        return spark_decode_LEGACY_STATUS_0(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_BOOTLOADER_0_frame(const spark_can_frame& in, Spark_BOOTLOADER_0_t* out)
    {
        return spark_decode_BOOTLOADER_0(in.data, in.dlc, out);
    }
    ...
    typedef struct
    {
        ...
        // Inverted
        bool INVERTED;
        // Primary Heartbeat Lock: Indicates that the SPARK is in competition mode and will ignore the Secondary
        // Heartbeat until it is power cycled
    ...
    static inline bool spark_decode_STATUS_0_frame(const spark_can_frame& in, Spark_STATUS_0_t* out)
    {
        return spark_decode_STATUS_0(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_STATUS_1_frame(const spark_can_frame& in, Spark_STATUS_1_t* out)
    {
        return spark_decode_STATUS_1(in.data, in.dlc, out);
    }

    // Frame values for Status 2: Includes data from the primary encoder (either a brushless motor's internal encoder,
    // or the primary encoder associated with a brushed motor)
    typedef struct
    {
        // Primary Encoder Velocity: By default, the unit is RPM, but it can be changed implicitly using the Velocity
        // Conversion Factor parameter
        float PRIMARY_ENCODER_VELOCITY;
        // Primary Encoder Position: By default, the unit is rotations, but it can be changed implicitly using the
        // Position Conversion Factor parameter
    ...
    static inline bool spark_decode_STATUS_2_frame(const spark_can_frame& in, Spark_STATUS_2_t* out)
    {
        return spark_decode_STATUS_2(in.data, in.dlc, out);
    }
    ...
    typedef struct
    {
        ...
        // Analog Velocity: By default, the unit is RPM, but it can be changed implicitly using the Analog Velocity
        // Conversion Factor parameter
        int32_t ANALOG_VELOCITY;
        // Analog Position: By default, the unit is rotations, but it can be changed implicitly using the Analog
        // Position Conversion Factor parameter
    ...
    static inline bool spark_decode_STATUS_3_frame(const spark_can_frame& in, Spark_STATUS_3_t* out)
    {
        return spark_decode_STATUS_3(in.data, in.dlc, out);
    }

    // Frame values for Status 4: Includes data from the External Encoder (on SPARK MAX, this is the Alternate Encoder)
    typedef struct
    {
        // External or Alt Encoder Velocity: By default, the unit is RPM, but it can be changed implicitly using the
        // External/Alternate Encoder Velocity Conversion Factor parameter
        float EXTERNAL_OR_ALT_ENCODER_VELOCITY;
        // External or Alt Encoder Position: By default, the unit is rotations, but it can be changed implicitly using
    ...
    static inline bool spark_decode_STATUS_4_frame(const spark_can_frame& in, Spark_STATUS_4_t* out)
    {
        return spark_decode_STATUS_4(in.data, in.dlc, out);
    }

    // Frame values for Status 5: Includes velocity and position data from a duty-cycle absolute encoder
    typedef struct
    {
        // Duty Cycle Encoder Velocity: By default, the unit is RPM, but it can be changed implicitly using the Duty
        // Cycle Velocity Conversion Factor parameter
        float DUTY_CYCLE_ENCODER_VELOCITY;
        // Duty Cycle Encoder Position: By default, the unit is rotations, but it can be changed implicitly using the
        // Duty Cycle Position Conversion Factor parameter
    ...
    static inline bool spark_decode_STATUS_5_frame(const spark_can_frame& in, Spark_STATUS_5_t* out)
    {
        return spark_decode_STATUS_5(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_STATUS_6_frame(const spark_can_frame& in, Spark_STATUS_6_t* out)
    {
        return spark_decode_STATUS_6(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_STATUS_7_frame(const spark_can_frame& in, Spark_STATUS_7_t* out)
    {
        return spark_decode_STATUS_7(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_STATUS_8_frame(const spark_can_frame& in, Spark_STATUS_8_t* out)
    {
        return spark_decode_STATUS_8(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_STATUS_9_frame(const spark_can_frame& in, Spark_STATUS_9_t* out)
    {
        return spark_decode_STATUS_9(in.data, in.dlc, out);
    }

    // Frame values for Unique ID Broadcast: Contains the unique ID of the device, to allow detecting duplicate CAN IDs.
    // To avoid collisions, the SPARK Flex firmware will send this at an irregular period between 1000ms and 2000ms.
    // SPARK MAX may use a constant period of 1000ms.
    typedef struct
    {
        // Unique ID
        uint32_t UNIQUE_ID;
    ...
    static inline bool spark_decode_UNIQUE_ID_BROADCAST_frame(const spark_can_frame&       in,
                                                              Spark_UNIQUE_ID_BROADCAST_t* out)
    {
        return spark_decode_UNIQUE_ID_BROADCAST(in.data, in.dlc, out);
    }

    // Frame values for Velocity Setpoint: Sets the Control Type to Velocity and sets the target velocity
    typedef struct
    {
        // Setpoint: By default, the unit is RPM, but it can be changed implicitly using the Velocity Conversion Factor
        // parameter
        float SETPOINT;
    ...
    static inline bool spark_decode_VELOCITY_SETPOINT_frame(const spark_can_frame& in, Spark_VELOCITY_SETPOINT_t* out)
    {
        return spark_decode_VELOCITY_SETPOINT(in.data, in.dlc, out);
    }

    // Frame values for Duty Cycle Setpoint: Sets the Control Type to Duty Cycle and sets the target duty cycle (from -1
    // to 1)
    typedef struct
    {
        // Setpoint
    ...
    static inline bool spark_decode_DUTY_CYCLE_SETPOINT_frame(const spark_can_frame&       in,
                                                              Spark_DUTY_CYCLE_SETPOINT_t* out)
    {
        return spark_decode_DUTY_CYCLE_SETPOINT(in.data, in.dlc, out);
    }

    // Frame values for Position Setpoint: Sets the Control Type to Position and sets the target position
    typedef struct
    {
        // Setpoint: By default, the unit is rotations, but it can be changed implicitly using the Position Conversion
        // Factor parameter
        float SETPOINT;
        // Arbitrary Feedforward
        int16_t ARBITRARY_FEEDFORWARD;
    ...
    static inline bool spark_decode_POSITION_SETPOINT_frame(const spark_can_frame& in, Spark_POSITION_SETPOINT_t* out)
    {
        return spark_decode_POSITION_SETPOINT(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_VOLTAGE_SETPOINT_frame(const spark_can_frame& in, Spark_VOLTAGE_SETPOINT_t* out)
    {
        return spark_decode_VOLTAGE_SETPOINT(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_CURRENT_SETPOINT_frame(const spark_can_frame& in, Spark_CURRENT_SETPOINT_t* out)
    {
        return spark_decode_CURRENT_SETPOINT(in.data, in.dlc, out);
    }

    // Frame values for MAXMotion Position Setpoint: Sets the Control Type to MAXMotion Position Control and sets the
    // target position
    typedef struct
    {
        // Setpoint: By default, the unit is rotations, but it can be changed implicitly using the Position Conversion
    ...
    static inline bool spark_decode_MAXMOTION_POSITION_SETPOINT_frame(const spark_can_frame&               in,
                                                                      Spark_MAXMOTION_POSITION_SETPOINT_t* out)
    {
        return spark_decode_MAXMOTION_POSITION_SETPOINT(in.data, in.dlc, out);
    }

    // Frame values for MAXMotion Velocity Setpoint: Sets the Control Type to MAXMotion Velocity Control and sets the
    // target velocity
    typedef struct
    {
        // Setpoint: By default, the unit is RPM, but it can be changed implicitly using the Velocity Conversion Factor
    ...
    static inline bool spark_decode_MAXMOTION_VELOCITY_SETPOINT_frame(const spark_can_frame&               in,
                                                                      Spark_MAXMOTION_VELOCITY_SETPOINT_t* out)
    {
        return spark_decode_MAXMOTION_VELOCITY_SETPOINT(in.data, in.dlc, out);
    }

    // Frame values for Set Statuses Enabled: Enable or disable status frames. In response, a Set Statuses Enabled
    // Response frame will be sent.
    typedef struct
    {
        // Mask
    ...
    static inline bool spark_decode_SET_STATUSES_ENABLED_frame(const spark_can_frame&        in,
                                                               Spark_SET_STATUSES_ENABLED_t* out)
    {
        return spark_decode_SET_STATUSES_ENABLED(in.data, in.dlc, out);
    }
    ...
    typedef struct
    {
        ...
        // Enabled Bitfield: Contains the full bitfield specifying which status frames are currently enabled, without
        // any masking
        uint16_t ENABLED_BITFIELD;
    ...
    static inline bool spark_decode_SET_STATUSES_ENABLED_RESPONSE_frame(const spark_can_frame&                 in,
                                                                        Spark_SET_STATUSES_ENABLED_RESPONSE_t* out)
    {
        return spark_decode_SET_STATUSES_ENABLED_RESPONSE(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_PERSIST_PARAMETERS_RESPONSE_frame(const spark_can_frame&               in,
                                                                      Spark_PERSIST_PARAMETERS_RESPONSE_t* out)
    {
        return spark_decode_PERSIST_PARAMETERS_RESPONSE(in.data, in.dlc, out);
    }

    // Frame values for Reset Safe Parameters: Resets most writable parameters to their default values, except CAN ID,
    // Motor Type, Idle Mode, PWM Input Deadband, and Duty Cycle Offset. In response, a Reset Safe Parameters Response
    // frame is sent.
    typedef struct
    {
        // Magic Number
    ...
    static inline bool spark_decode_RESET_SAFE_PARAMETERS_frame(const spark_can_frame&         in,
                                                                Spark_RESET_SAFE_PARAMETERS_t* out)
    {
        return spark_decode_RESET_SAFE_PARAMETERS(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_RESET_SAFE_PARAMETERS_RESPONSE_frame(const spark_can_frame&                  in,
                                                                         Spark_RESET_SAFE_PARAMETERS_RESPONSE_t* out)
    {
        return spark_decode_RESET_SAFE_PARAMETERS_RESPONSE(in.data, in.dlc, out);
    }

    // Frame values for Complete Factory Reset: Resets all writable parameters to default values, even CAN ID, Motor
    // Type, Idle Mode, PWM Input Deadband, and Duty Cycle Offset. In response, a Complete Factory Reset Response frame
    // is sent.
    typedef struct
    {
        // Magic Number
    ...
    static inline bool spark_decode_COMPLETE_FACTORY_RESET_frame(const spark_can_frame&          in,
                                                                 Spark_COMPLETE_FACTORY_RESET_t* out)
    {
        return spark_decode_COMPLETE_FACTORY_RESET(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_COMPLETE_FACTORY_RESET_RESPONSE_frame(const spark_can_frame&                   in,
                                                                          Spark_COMPLETE_FACTORY_RESET_RESPONSE_t* out)
    {
        return spark_decode_COMPLETE_FACTORY_RESET_RESPONSE(in.data, in.dlc, out);
    }
    ...
    // Frame values for Identify Unique SPARK: Makes the specified, single SPARK (even if there are multiple SPARKs that
    // have the same CAN ID) temporarily perform a special blink pattern that will make it stand out
    typedef struct
    {
        // Unique ID
        uint32_t UNIQUE_ID;
    ...
    static inline bool spark_decode_IDENTIFY_UNIQUE_SPARK_frame(const spark_can_frame&         in,
                                                                Spark_IDENTIFY_UNIQUE_SPARK_t* out)
    {
        return spark_decode_IDENTIFY_UNIQUE_SPARK(in.data, in.dlc, out);
    }

    // Frame values for Identify: Makes the SPARK temporarily perform a special blink pattern that will make it stand
    // out. Use Identify Unique Device if there may be multiple SPARKs with the same CAN ID.
    typedef struct
    {
        uint8_t _reserved0; // no payload fields
    } Spark_IDENTIFY_t;

    // Frame values for Nack: As of SPARK MAX firmware 1.6.3, this is only used as a potential response to setting the
    // CAN ID
    typedef struct
    {
        uint8_t _reserved0; // no payload fields
    ...
    // Frame values for Ack: As of SPARK MAX firmware 1.6.3, this is only used as a potential response to setting the
    // CAN ID
    typedef struct
    {
        uint8_t _reserved0; // no payload fields
    ...
    // Frame values for Set CAN ID: Allows changing the CAN ID when multiple devices on the bus currently have the same
    // CAN ID. Under normal circumstances, the CAN ID parameter can be used.
    typedef struct
    {
        // Unique ID
        uint32_t UNIQUE_ID;
    ...
    static inline bool spark_decode_SET_CAN_ID_frame(const spark_can_frame& in, Spark_SET_CAN_ID_t* out)
    {
        return spark_decode_SET_CAN_ID(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_FIRMWARE_VERSION_frame(const spark_can_frame&        in,
                                                               Spark_GET_FIRMWARE_VERSION_t* out)
    {
        return spark_decode_GET_FIRMWARE_VERSION(in.data, in.dlc, out);
    }

    // Frame values for SWDL Data: Broadcast from the host to all SPARKs in SWDL mode, containing a slice of firmware
    // data
    typedef struct
    {
        // Data
    ...
    static inline bool spark_decode_SWDL_DATA_frame(const spark_can_frame& in, Spark_SWDL_DATA_t* out)
    {
        return spark_decode_SWDL_DATA(in.data, in.dlc, out);
    }

    // Frame values for SWDL Checksum: Broadcast from the host to all SPARKs in SWDL mode, containing the checksum of
    // the full firmware image that was just sent
    typedef struct
    {
        // Checksum
        uint64_t CHECKSUM;
    ...
    static inline bool spark_decode_SWDL_CHECKSUM_frame(const spark_can_frame& in, Spark_SWDL_CHECKSUM_t* out)
    {
        return spark_decode_SWDL_CHECKSUM(in.data, in.dlc, out);
    }

    // Frame values for SWDL Retransmit: Sent by SPARK devices in response to receiving an SWDL Checksum frame that does
    // not match the firmware data they received
    typedef struct
    {
        uint8_t _reserved0; // no payload fields
    ...
    typedef struct
    {
        // Position: By default, the unit is rotations, but it can be changed implicitly using the Position Conversion
        // Factor parameter
        float POSITION;
        // Data Type
        uint8_t DATA_TYPE;
    ...
    static inline bool spark_decode_SET_PRIMARY_ENCODER_POSITION_frame(const spark_can_frame&                in,
                                                                       Spark_SET_PRIMARY_ENCODER_POSITION_t* out)
    {
        return spark_decode_SET_PRIMARY_ENCODER_POSITION(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_SET_I_ACCUMULATION_frame(const spark_can_frame& in, Spark_SET_I_ACCUMULATION_t* out)
    {
        return spark_decode_SET_I_ACCUMULATION(in.data, in.dlc, out);
    }

    // Frame values for Set Analog Position
    typedef struct
    {
        // Position: By default, the unit is rotations, but it can be changed implicitly using the Analog Position
        // Conversion Factor parameter
        float POSITION;
        // Data Type
        uint8_t DATA_TYPE;
    ...
    static inline bool spark_decode_SET_ANALOG_POSITION_frame(const spark_can_frame&       in,
                                                              Spark_SET_ANALOG_POSITION_t* out)
    {
        return spark_decode_SET_ANALOG_POSITION(in.data, in.dlc, out);
    }

    // Frame values for Set Ext or Alt Encoder Position
    typedef struct
    {
        // Position: By default, the unit is rotations, but it can be changed implicitly using the External/Alternate
        // Encoder Position Conversion Factor parameter
        float POSITION;
        // Data Type
        uint8_t DATA_TYPE;
    ...
    static inline bool spark_decode_SET_EXT_OR_ALT_ENCODER_POSITION_frame(const spark_can_frame&                   in,
                                                                          Spark_SET_EXT_OR_ALT_ENCODER_POSITION_t* out)
    {
        return spark_decode_SET_EXT_OR_ALT_ENCODER_POSITION(in.data, in.dlc, out);
    }

    // Frame values for Set Duty Cycle Position
    typedef struct
    {
        // Position: By default, the unit is rotations, but it can be changed implicitly using the Duty Cycle Position
        // Conversion Factor parameter
        float POSITION;
        // Data Type
        uint8_t DATA_TYPE;
    ...
    static inline bool spark_decode_SET_DUTY_CYCLE_POSITION_frame(const spark_can_frame&           in,
                                                                  Spark_SET_DUTY_CYCLE_POSITION_t* out)
    {
        return spark_decode_SET_DUTY_CYCLE_POSITION(in.data, in.dlc, out);
    }

    // Frame values for Secondary Heartbeat: Heartbeat that allows enabling only specific SPARKs, but only gets
    ...
    static inline bool spark_decode_SECONDARY_HEARTBEAT_frame(const spark_can_frame&       in,
                                                              Spark_SECONDARY_HEARTBEAT_t* out)
    {
        return spark_decode_SECONDARY_HEARTBEAT(in.data, in.dlc, out);
    }

    // Frame values for USB Only Identify: The response will only be sent if this command is received directly via USB.
    // This has no relation to the normal Identify command, which displays an LED pattern.
    typedef struct
    {
        uint8_t _reserved0; // no payload fields
    } Spark_USB_ONLY_IDENTIFY_t;

    // Frame values for USB Only Enter DFU Bootloader: Causes the device to reboot into the DFU bootloader if this
    // command is received directly via USB
    typedef struct
    {
        // Magic Number
        uint16_t MAGIC_NUMBER;
    ...
    static inline bool spark_decode_USB_ONLY_ENTER_DFU_BOOTLOADER_frame(const spark_can_frame&                 in,
                                                                        Spark_USB_ONLY_ENTER_DFU_BOOTLOADER_t* out)
    {
        return spark_decode_USB_ONLY_ENTER_DFU_BOOTLOADER(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_TEMPERATURES_frame(const spark_can_frame& in, Spark_GET_TEMPERATURES_t* out)
    {
        return spark_decode_GET_TEMPERATURES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_MOTOR_INTERFACE_frame(const spark_can_frame&       in,
                                                              Spark_GET_MOTOR_INTERFACE_t* out)
    {
        return spark_decode_GET_MOTOR_INTERFACE(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_0_TO_15_TYPES_frame(const spark_can_frame&               in,
                                                                      Spark_GET_PARAMETER_0_TO_15_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_0_TO_15_TYPES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_16_TO_31_TYPES_frame(const spark_can_frame&                in,
                                                                       Spark_GET_PARAMETER_16_TO_31_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_16_TO_31_TYPES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_32_TO_47_TYPES_frame(const spark_can_frame&                in,
                                                                       Spark_GET_PARAMETER_32_TO_47_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_32_TO_47_TYPES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_48_TO_63_TYPES_frame(const spark_can_frame&                in,
                                                                       Spark_GET_PARAMETER_48_TO_63_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_48_TO_63_TYPES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_64_TO_79_TYPES_frame(const spark_can_frame&                in,
                                                                       Spark_GET_PARAMETER_64_TO_79_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_64_TO_79_TYPES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_80_TO_95_TYPES_frame(const spark_can_frame&                in,
                                                                       Spark_GET_PARAMETER_80_TO_95_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_80_TO_95_TYPES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_96_TO_111_TYPES_frame(const spark_can_frame&                 in,
                                                                        Spark_GET_PARAMETER_96_TO_111_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_96_TO_111_TYPES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_112_TO_127_TYPES_frame(const spark_can_frame&                  in,
                                                                         Spark_GET_PARAMETER_112_TO_127_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_112_TO_127_TYPES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_128_TO_143_TYPES_frame(const spark_can_frame&                  in,
                                                                         Spark_GET_PARAMETER_128_TO_143_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_128_TO_143_TYPES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_144_TO_159_TYPES_frame(const spark_can_frame&                  in,
                                                                         Spark_GET_PARAMETER_144_TO_159_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_144_TO_159_TYPES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_160_TO_175_TYPES_frame(const spark_can_frame&                  in,
                                                                         Spark_GET_PARAMETER_160_TO_175_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_160_TO_175_TYPES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_176_TO_191_TYPES_frame(const spark_can_frame&                  in,
                                                                         Spark_GET_PARAMETER_176_TO_191_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_176_TO_191_TYPES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_192_TO_207_TYPES_frame(const spark_can_frame&                  in,
                                                                         Spark_GET_PARAMETER_192_TO_207_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_192_TO_207_TYPES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_208_TO_223_TYPES_frame(const spark_can_frame&                  in,
                                                                         Spark_GET_PARAMETER_208_TO_223_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_208_TO_223_TYPES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_224_TO_239_TYPES_frame(const spark_can_frame&                  in,
                                                                         Spark_GET_PARAMETER_224_TO_239_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_224_TO_239_TYPES(in.data, in.dlc, out);
    }
    ...
    static inline bool spark_decode_GET_PARAMETER_240_TO_255_TYPES_frame(const spark_can_frame&                  in,
                                                                         Spark_GET_PARAMETER_240_TO_255_TYPES_t* out)
    {
        return spark_decode_GET_PARAMETER_240_TO_255_TYPES(in.data, in.dlc, out);
    }

    // Frame values for Parameter Write: Write a single parameter value. In response, a Parameter Write Response frame
    // will be sent.
    typedef struct
    {
        // Parameter ID
    ...
    static inline bool spark_decode_PARAMETER_WRITE_frame(const spark_can_frame& in, Spark_PARAMETER_WRITE_t* out)
    {
        return spark_decode_PARAMETER_WRITE(in.data, in.dlc, out);
    }

    // Frame values for Parameter Write Response: Response for a parameter write (including a write done as part of a
    // dual-write)
    typedef struct
    {
        // Parameter ID
        ...
        // Value: The actual type of this field is specified by the Parameter Type field. Contains the current value of
        // the parameter, which will not match what was specified in the write command if the write failed.
        uint32_t VALUE;
    ...
    static inline bool spark_decode_PARAMETER_WRITE_RESPONSE_frame(const spark_can_frame&            in,
                                                                   Spark_PARAMETER_WRITE_RESPONSE_t* out)
    {
        return spark_decode_PARAMETER_WRITE_RESPONSE(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 0 and 1: Read parameter 0 and 1 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
        // question
        uint32_t FIRST_PARAMETER_VALUE;
        // Second Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
        // question
    ...
    static inline bool spark_decode_READ_PARAMETER_0_AND_1_frame(const spark_can_frame&          in,
                                                                 Spark_READ_PARAMETER_0_AND_1_t* out)
    {
        return spark_decode_READ_PARAMETER_0_AND_1(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 2 and 3: Read parameter 2 and 3 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_2_AND_3_frame(const spark_can_frame&          in,
                                                                 Spark_READ_PARAMETER_2_AND_3_t* out)
    {
        return spark_decode_READ_PARAMETER_2_AND_3(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 4 and 5: Read parameter 4 and 5 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_4_AND_5_frame(const spark_can_frame&          in,
                                                                 Spark_READ_PARAMETER_4_AND_5_t* out)
    {
        return spark_decode_READ_PARAMETER_4_AND_5(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 6 and 7: Read parameter 6 and 7 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_6_AND_7_frame(const spark_can_frame&          in,
                                                                 Spark_READ_PARAMETER_6_AND_7_t* out)
    {
        return spark_decode_READ_PARAMETER_6_AND_7(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 8 and 9: Read parameter 8 and 9 at the same time. SPARK MAX does not currently
    // support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_8_AND_9_frame(const spark_can_frame&          in,
                                                                 Spark_READ_PARAMETER_8_AND_9_t* out)
    {
        return spark_decode_READ_PARAMETER_8_AND_9(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 10 and 11: Read parameter 10 and 11 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_10_AND_11_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_10_AND_11_t* out)
    {
        return spark_decode_READ_PARAMETER_10_AND_11(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 12 and 13: Read parameter 12 and 13 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_12_AND_13_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_12_AND_13_t* out)
    {
        return spark_decode_READ_PARAMETER_12_AND_13(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 14 and 15: Read parameter 14 and 15 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_14_AND_15_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_14_AND_15_t* out)
    {
        return spark_decode_READ_PARAMETER_14_AND_15(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 16 and 17: Read parameter 16 and 17 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_16_AND_17_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_16_AND_17_t* out)
    {
        return spark_decode_READ_PARAMETER_16_AND_17(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 18 and 19: Read parameter 18 and 19 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_18_AND_19_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_18_AND_19_t* out)
    {
        return spark_decode_READ_PARAMETER_18_AND_19(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 20 and 21: Read parameter 20 and 21 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_20_AND_21_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_20_AND_21_t* out)
    {
        return spark_decode_READ_PARAMETER_20_AND_21(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 22 and 23: Read parameter 22 and 23 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_22_AND_23_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_22_AND_23_t* out)
    {
        return spark_decode_READ_PARAMETER_22_AND_23(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 24 and 25: Read parameter 24 and 25 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_24_AND_25_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_24_AND_25_t* out)
    {
        return spark_decode_READ_PARAMETER_24_AND_25(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 26 and 27: Read parameter 26 and 27 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_26_AND_27_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_26_AND_27_t* out)
    {
        return spark_decode_READ_PARAMETER_26_AND_27(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 28 and 29: Read parameter 28 and 29 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_28_AND_29_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_28_AND_29_t* out)
    {
        return spark_decode_READ_PARAMETER_28_AND_29(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 30 and 31: Read parameter 30 and 31 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_30_AND_31_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_30_AND_31_t* out)
    {
        return spark_decode_READ_PARAMETER_30_AND_31(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 32 and 33: Read parameter 32 and 33 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_32_AND_33_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_32_AND_33_t* out)
    {
        return spark_decode_READ_PARAMETER_32_AND_33(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 34 and 35: Read parameter 34 and 35 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_34_AND_35_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_34_AND_35_t* out)
    {
        return spark_decode_READ_PARAMETER_34_AND_35(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 36 and 37: Read parameter 36 and 37 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_36_AND_37_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_36_AND_37_t* out)
    {
        return spark_decode_READ_PARAMETER_36_AND_37(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 38 and 39: Read parameter 38 and 39 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_38_AND_39_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_38_AND_39_t* out)
    {
        return spark_decode_READ_PARAMETER_38_AND_39(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 40 and 41: Read parameter 40 and 41 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_40_AND_41_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_40_AND_41_t* out)
    {
        return spark_decode_READ_PARAMETER_40_AND_41(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 42 and 43: Read parameter 42 and 43 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_42_AND_43_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_42_AND_43_t* out)
    {
        return spark_decode_READ_PARAMETER_42_AND_43(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 44 and 45: Read parameter 44 and 45 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_44_AND_45_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_44_AND_45_t* out)
    {
        return spark_decode_READ_PARAMETER_44_AND_45(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 46 and 47: Read parameter 46 and 47 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_46_AND_47_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_46_AND_47_t* out)
    {
        return spark_decode_READ_PARAMETER_46_AND_47(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 48 and 49: Read parameter 48 and 49 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_48_AND_49_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_48_AND_49_t* out)
    {
        return spark_decode_READ_PARAMETER_48_AND_49(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 50 and 51: Read parameter 50 and 51 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_50_AND_51_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_50_AND_51_t* out)
    {
        return spark_decode_READ_PARAMETER_50_AND_51(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 52 and 53: Read parameter 52 and 53 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_52_AND_53_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_52_AND_53_t* out)
    {
        return spark_decode_READ_PARAMETER_52_AND_53(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 54 and 55: Read parameter 54 and 55 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_54_AND_55_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_54_AND_55_t* out)
    {
        return spark_decode_READ_PARAMETER_54_AND_55(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 56 and 57: Read parameter 56 and 57 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_56_AND_57_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_56_AND_57_t* out)
    {
        return spark_decode_READ_PARAMETER_56_AND_57(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 58 and 59: Read parameter 58 and 59 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_58_AND_59_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_58_AND_59_t* out)
    {
        return spark_decode_READ_PARAMETER_58_AND_59(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 60 and 61: Read parameter 60 and 61 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_60_AND_61_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_60_AND_61_t* out)
    {
        return spark_decode_READ_PARAMETER_60_AND_61(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 62 and 63: Read parameter 62 and 63 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_62_AND_63_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_62_AND_63_t* out)
    {
        return spark_decode_READ_PARAMETER_62_AND_63(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 64 and 65: Read parameter 64 and 65 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_64_AND_65_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_64_AND_65_t* out)
    {
        return spark_decode_READ_PARAMETER_64_AND_65(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 66 and 67: Read parameter 66 and 67 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_66_AND_67_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_66_AND_67_t* out)
    {
        return spark_decode_READ_PARAMETER_66_AND_67(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 68 and 69: Read parameter 68 and 69 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_68_AND_69_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_68_AND_69_t* out)
    {
        return spark_decode_READ_PARAMETER_68_AND_69(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 70 and 71: Read parameter 70 and 71 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_70_AND_71_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_70_AND_71_t* out)
    {
        return spark_decode_READ_PARAMETER_70_AND_71(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 72 and 73: Read parameter 72 and 73 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_72_AND_73_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_72_AND_73_t* out)
    {
        return spark_decode_READ_PARAMETER_72_AND_73(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 74 and 75: Read parameter 74 and 75 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_74_AND_75_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_74_AND_75_t* out)
    {
        return spark_decode_READ_PARAMETER_74_AND_75(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 76 and 77: Read parameter 76 and 77 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_76_AND_77_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_76_AND_77_t* out)
    {
        return spark_decode_READ_PARAMETER_76_AND_77(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 78 and 79: Read parameter 78 and 79 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_78_AND_79_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_78_AND_79_t* out)
    {
        return spark_decode_READ_PARAMETER_78_AND_79(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 80 and 81: Read parameter 80 and 81 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_80_AND_81_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_80_AND_81_t* out)
    {
        return spark_decode_READ_PARAMETER_80_AND_81(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 82 and 83: Read parameter 82 and 83 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_82_AND_83_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_82_AND_83_t* out)
    {
        return spark_decode_READ_PARAMETER_82_AND_83(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 84 and 85: Read parameter 84 and 85 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_84_AND_85_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_84_AND_85_t* out)
    {
        return spark_decode_READ_PARAMETER_84_AND_85(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 86 and 87: Read parameter 86 and 87 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_86_AND_87_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_86_AND_87_t* out)
    {
        return spark_decode_READ_PARAMETER_86_AND_87(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 88 and 89: Read parameter 88 and 89 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_88_AND_89_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_88_AND_89_t* out)
    {
        return spark_decode_READ_PARAMETER_88_AND_89(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 90 and 91: Read parameter 90 and 91 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_90_AND_91_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_90_AND_91_t* out)
    {
        return spark_decode_READ_PARAMETER_90_AND_91(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 92 and 93: Read parameter 92 and 93 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_92_AND_93_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_92_AND_93_t* out)
    {
        return spark_decode_READ_PARAMETER_92_AND_93(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 94 and 95: Read parameter 94 and 95 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_94_AND_95_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_94_AND_95_t* out)
    {
        return spark_decode_READ_PARAMETER_94_AND_95(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 96 and 97: Read parameter 96 and 97 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_96_AND_97_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_96_AND_97_t* out)
    {
        return spark_decode_READ_PARAMETER_96_AND_97(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 98 and 99: Read parameter 98 and 99 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_98_AND_99_frame(const spark_can_frame&            in,
                                                                   Spark_READ_PARAMETER_98_AND_99_t* out)
    {
        return spark_decode_READ_PARAMETER_98_AND_99(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 100 and 101: Read parameter 100 and 101 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_100_AND_101_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_100_AND_101_t* out)
    {
        return spark_decode_READ_PARAMETER_100_AND_101(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 102 and 103: Read parameter 102 and 103 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_102_AND_103_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_102_AND_103_t* out)
    {
        return spark_decode_READ_PARAMETER_102_AND_103(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 104 and 105: Read parameter 104 and 105 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_104_AND_105_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_104_AND_105_t* out)
    {
        return spark_decode_READ_PARAMETER_104_AND_105(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 106 and 107: Read parameter 106 and 107 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_106_AND_107_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_106_AND_107_t* out)
    {
        return spark_decode_READ_PARAMETER_106_AND_107(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 108 and 109: Read parameter 108 and 109 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_108_AND_109_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_108_AND_109_t* out)
    {
        return spark_decode_READ_PARAMETER_108_AND_109(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 110 and 111: Read parameter 110 and 111 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_110_AND_111_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_110_AND_111_t* out)
    {
        return spark_decode_READ_PARAMETER_110_AND_111(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 112 and 113: Read parameter 112 and 113 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_112_AND_113_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_112_AND_113_t* out)
    {
        return spark_decode_READ_PARAMETER_112_AND_113(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 114 and 115: Read parameter 114 and 115 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_114_AND_115_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_114_AND_115_t* out)
    {
        return spark_decode_READ_PARAMETER_114_AND_115(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 116 and 117: Read parameter 116 and 117 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_116_AND_117_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_116_AND_117_t* out)
    {
        return spark_decode_READ_PARAMETER_116_AND_117(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 118 and 119: Read parameter 118 and 119 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_118_AND_119_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_118_AND_119_t* out)
    {
        return spark_decode_READ_PARAMETER_118_AND_119(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 120 and 121: Read parameter 120 and 121 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_120_AND_121_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_120_AND_121_t* out)
    {
        return spark_decode_READ_PARAMETER_120_AND_121(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 122 and 123: Read parameter 122 and 123 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_122_AND_123_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_122_AND_123_t* out)
    {
        return spark_decode_READ_PARAMETER_122_AND_123(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 124 and 125: Read parameter 124 and 125 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_124_AND_125_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_124_AND_125_t* out)
    {
        return spark_decode_READ_PARAMETER_124_AND_125(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 126 and 127: Read parameter 126 and 127 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_126_AND_127_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_126_AND_127_t* out)
    {
        return spark_decode_READ_PARAMETER_126_AND_127(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 128 and 129: Read parameter 128 and 129 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_128_AND_129_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_128_AND_129_t* out)
    {
        return spark_decode_READ_PARAMETER_128_AND_129(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 130 and 131: Read parameter 130 and 131 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_130_AND_131_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_130_AND_131_t* out)
    {
        return spark_decode_READ_PARAMETER_130_AND_131(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 132 and 133: Read parameter 132 and 133 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_132_AND_133_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_132_AND_133_t* out)
    {
        return spark_decode_READ_PARAMETER_132_AND_133(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 134 and 135: Read parameter 134 and 135 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_134_AND_135_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_134_AND_135_t* out)
    {
        return spark_decode_READ_PARAMETER_134_AND_135(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 136 and 137: Read parameter 136 and 137 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_136_AND_137_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_136_AND_137_t* out)
    {
        return spark_decode_READ_PARAMETER_136_AND_137(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 138 and 139: Read parameter 138 and 139 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_138_AND_139_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_138_AND_139_t* out)
    {
        return spark_decode_READ_PARAMETER_138_AND_139(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 140 and 141: Read parameter 140 and 141 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_140_AND_141_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_140_AND_141_t* out)
    {
        return spark_decode_READ_PARAMETER_140_AND_141(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 142 and 143: Read parameter 142 and 143 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_142_AND_143_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_142_AND_143_t* out)
    {
        return spark_decode_READ_PARAMETER_142_AND_143(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 144 and 145: Read parameter 144 and 145 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_144_AND_145_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_144_AND_145_t* out)
    {
        return spark_decode_READ_PARAMETER_144_AND_145(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 146 and 147: Read parameter 146 and 147 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_146_AND_147_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_146_AND_147_t* out)
    {
        return spark_decode_READ_PARAMETER_146_AND_147(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 148 and 149: Read parameter 148 and 149 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_148_AND_149_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_148_AND_149_t* out)
    {
        return spark_decode_READ_PARAMETER_148_AND_149(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 150 and 151: Read parameter 150 and 151 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_150_AND_151_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_150_AND_151_t* out)
    {
        return spark_decode_READ_PARAMETER_150_AND_151(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 152 and 153: Read parameter 152 and 153 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_152_AND_153_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_152_AND_153_t* out)
    {
        return spark_decode_READ_PARAMETER_152_AND_153(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 154 and 155: Read parameter 154 and 155 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_154_AND_155_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_154_AND_155_t* out)
    {
        return spark_decode_READ_PARAMETER_154_AND_155(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 156 and 157: Read parameter 156 and 157 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_156_AND_157_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_156_AND_157_t* out)
    {
        return spark_decode_READ_PARAMETER_156_AND_157(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 158 and 159: Read parameter 158 and 159 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_158_AND_159_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_158_AND_159_t* out)
    {
        return spark_decode_READ_PARAMETER_158_AND_159(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 160 and 161: Read parameter 160 and 161 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_160_AND_161_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_160_AND_161_t* out)
    {
        return spark_decode_READ_PARAMETER_160_AND_161(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 162 and 163: Read parameter 162 and 163 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_162_AND_163_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_162_AND_163_t* out)
    {
        return spark_decode_READ_PARAMETER_162_AND_163(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 164 and 165: Read parameter 164 and 165 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_164_AND_165_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_164_AND_165_t* out)
    {
        return spark_decode_READ_PARAMETER_164_AND_165(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 166 and 167: Read parameter 166 and 167 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_166_AND_167_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_166_AND_167_t* out)
    {
        return spark_decode_READ_PARAMETER_166_AND_167(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 168 and 169: Read parameter 168 and 169 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_168_AND_169_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_168_AND_169_t* out)
    {
        return spark_decode_READ_PARAMETER_168_AND_169(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 170 and 171: Read parameter 170 and 171 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_170_AND_171_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_170_AND_171_t* out)
    {
        return spark_decode_READ_PARAMETER_170_AND_171(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 172 and 173: Read parameter 172 and 173 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_172_AND_173_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_172_AND_173_t* out)
    {
        return spark_decode_READ_PARAMETER_172_AND_173(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 174 and 175: Read parameter 174 and 175 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_174_AND_175_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_174_AND_175_t* out)
    {
        return spark_decode_READ_PARAMETER_174_AND_175(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 176 and 177: Read parameter 176 and 177 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_176_AND_177_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_176_AND_177_t* out)
    {
        return spark_decode_READ_PARAMETER_176_AND_177(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 178 and 179: Read parameter 178 and 179 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_178_AND_179_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_178_AND_179_t* out)
    {
        return spark_decode_READ_PARAMETER_178_AND_179(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 180 and 181: Read parameter 180 and 181 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_180_AND_181_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_180_AND_181_t* out)
    {
        return spark_decode_READ_PARAMETER_180_AND_181(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 182 and 183: Read parameter 182 and 183 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_182_AND_183_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_182_AND_183_t* out)
    {
        return spark_decode_READ_PARAMETER_182_AND_183(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 184 and 185: Read parameter 184 and 185 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_184_AND_185_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_184_AND_185_t* out)
    {
        return spark_decode_READ_PARAMETER_184_AND_185(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 186 and 187: Read parameter 186 and 187 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_186_AND_187_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_186_AND_187_t* out)
    {
        return spark_decode_READ_PARAMETER_186_AND_187(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 188 and 189: Read parameter 188 and 189 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_188_AND_189_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_188_AND_189_t* out)
    {
        return spark_decode_READ_PARAMETER_188_AND_189(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 190 and 191: Read parameter 190 and 191 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_190_AND_191_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_190_AND_191_t* out)
    {
        return spark_decode_READ_PARAMETER_190_AND_191(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 192 and 193: Read parameter 192 and 193 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_192_AND_193_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_192_AND_193_t* out)
    {
        return spark_decode_READ_PARAMETER_192_AND_193(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 194 and 195: Read parameter 194 and 195 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_194_AND_195_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_194_AND_195_t* out)
    {
        return spark_decode_READ_PARAMETER_194_AND_195(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 196 and 197: Read parameter 196 and 197 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_196_AND_197_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_196_AND_197_t* out)
    {
        return spark_decode_READ_PARAMETER_196_AND_197(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 198 and 199: Read parameter 198 and 199 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_198_AND_199_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_198_AND_199_t* out)
    {
        return spark_decode_READ_PARAMETER_198_AND_199(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 200 and 201: Read parameter 200 and 201 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_200_AND_201_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_200_AND_201_t* out)
    {
        return spark_decode_READ_PARAMETER_200_AND_201(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 202 and 203: Read parameter 202 and 203 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_202_AND_203_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_202_AND_203_t* out)
    {
        return spark_decode_READ_PARAMETER_202_AND_203(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 204 and 205: Read parameter 204 and 205 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_204_AND_205_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_204_AND_205_t* out)
    {
        return spark_decode_READ_PARAMETER_204_AND_205(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 206 and 207: Read parameter 206 and 207 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_206_AND_207_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_206_AND_207_t* out)
    {
        return spark_decode_READ_PARAMETER_206_AND_207(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 208 and 209: Read parameter 208 and 209 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_208_AND_209_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_208_AND_209_t* out)
    {
        return spark_decode_READ_PARAMETER_208_AND_209(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 210 and 211: Read parameter 210 and 211 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_210_AND_211_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_210_AND_211_t* out)
    {
        return spark_decode_READ_PARAMETER_210_AND_211(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 212 and 213: Read parameter 212 and 213 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_212_AND_213_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_212_AND_213_t* out)
    {
        return spark_decode_READ_PARAMETER_212_AND_213(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 214 and 215: Read parameter 214 and 215 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_214_AND_215_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_214_AND_215_t* out)
    {
        return spark_decode_READ_PARAMETER_214_AND_215(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 216 and 217: Read parameter 216 and 217 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_216_AND_217_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_216_AND_217_t* out)
    {
        return spark_decode_READ_PARAMETER_216_AND_217(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 218 and 219: Read parameter 218 and 219 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_218_AND_219_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_218_AND_219_t* out)
    {
        return spark_decode_READ_PARAMETER_218_AND_219(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 220 and 221: Read parameter 220 and 221 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_220_AND_221_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_220_AND_221_t* out)
    {
        return spark_decode_READ_PARAMETER_220_AND_221(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 222 and 223: Read parameter 222 and 223 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_222_AND_223_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_222_AND_223_t* out)
    {
        return spark_decode_READ_PARAMETER_222_AND_223(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 224 and 225: Read parameter 224 and 225 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_224_AND_225_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_224_AND_225_t* out)
    {
        return spark_decode_READ_PARAMETER_224_AND_225(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 226 and 227: Read parameter 226 and 227 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_226_AND_227_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_226_AND_227_t* out)
    {
        return spark_decode_READ_PARAMETER_226_AND_227(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 228 and 229: Read parameter 228 and 229 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_228_AND_229_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_228_AND_229_t* out)
    {
        return spark_decode_READ_PARAMETER_228_AND_229(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 230 and 231: Read parameter 230 and 231 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_230_AND_231_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_230_AND_231_t* out)
    {
        return spark_decode_READ_PARAMETER_230_AND_231(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 232 and 233: Read parameter 232 and 233 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_232_AND_233_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_232_AND_233_t* out)
    {
        return spark_decode_READ_PARAMETER_232_AND_233(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 234 and 235: Read parameter 234 and 235 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_234_AND_235_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_234_AND_235_t* out)
    {
        return spark_decode_READ_PARAMETER_234_AND_235(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 236 and 237: Read parameter 236 and 237 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_236_AND_237_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_236_AND_237_t* out)
    {
        return spark_decode_READ_PARAMETER_236_AND_237(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 238 and 239: Read parameter 238 and 239 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_238_AND_239_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_238_AND_239_t* out)
    {
        return spark_decode_READ_PARAMETER_238_AND_239(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 240 and 241: Read parameter 240 and 241 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_240_AND_241_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_240_AND_241_t* out)
    {
        return spark_decode_READ_PARAMETER_240_AND_241(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 242 and 243: Read parameter 242 and 243 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_242_AND_243_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_242_AND_243_t* out)
    {
        return spark_decode_READ_PARAMETER_242_AND_243(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 244 and 245: Read parameter 244 and 245 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_244_AND_245_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_244_AND_245_t* out)
    {
        return spark_decode_READ_PARAMETER_244_AND_245(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 246 and 247: Read parameter 246 and 247 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_246_AND_247_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_246_AND_247_t* out)
    {
        return spark_decode_READ_PARAMETER_246_AND_247(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 248 and 249: Read parameter 248 and 249 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_248_AND_249_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_248_AND_249_t* out)
    {
        return spark_decode_READ_PARAMETER_248_AND_249(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 250 and 251: Read parameter 250 and 251 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_250_AND_251_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_250_AND_251_t* out)
    {
        return spark_decode_READ_PARAMETER_250_AND_251(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 252 and 253: Read parameter 252 and 253 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_252_AND_253_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_252_AND_253_t* out)
    {
        return spark_decode_READ_PARAMETER_252_AND_253(in.data, in.dlc, out);
    }

    // Frame values for Read Parameter 254 and 255: Read parameter 254 and 255 at the same time. SPARK MAX does not
    // currently support this in v25.0.0-prerelease.4
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_READ_PARAMETER_254_AND_255_frame(const spark_can_frame&              in,
                                                                     Spark_READ_PARAMETER_254_AND_255_t* out)
    {
        return spark_decode_READ_PARAMETER_254_AND_255(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 0 and 1: Write Parameter 0 and 1 at the same time. Two Write Parameter Response
    ...
    static inline bool spark_decode_WRITE_PARAMETER_0_AND_1_frame(const spark_can_frame&           in,
                                                                  Spark_WRITE_PARAMETER_0_AND_1_t* out)
    {
        return spark_decode_WRITE_PARAMETER_0_AND_1(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 2 and 3: Write Parameter 2 and 3 at the same time. Two Write Parameter Response
    // frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_2_AND_3_frame(const spark_can_frame&           in,
                                                                  Spark_WRITE_PARAMETER_2_AND_3_t* out)
    {
        return spark_decode_WRITE_PARAMETER_2_AND_3(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 4 and 5: Write Parameter 4 and 5 at the same time. Two Write Parameter Response
    // frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_4_AND_5_frame(const spark_can_frame&           in,
                                                                  Spark_WRITE_PARAMETER_4_AND_5_t* out)
    {
        return spark_decode_WRITE_PARAMETER_4_AND_5(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 6 and 7: Write Parameter 6 and 7 at the same time. Two Write Parameter Response
    // frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_6_AND_7_frame(const spark_can_frame&           in,
                                                                  Spark_WRITE_PARAMETER_6_AND_7_t* out)
    {
        return spark_decode_WRITE_PARAMETER_6_AND_7(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 8 and 9: Write Parameter 8 and 9 at the same time. Two Write Parameter Response
    // frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_8_AND_9_frame(const spark_can_frame&           in,
                                                                  Spark_WRITE_PARAMETER_8_AND_9_t* out)
    {
        return spark_decode_WRITE_PARAMETER_8_AND_9(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 10 and 11: Write Parameter 10 and 11 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_10_AND_11_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_10_AND_11_t* out)
    {
        return spark_decode_WRITE_PARAMETER_10_AND_11(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 12 and 13: Write Parameter 12 and 13 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_12_AND_13_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_12_AND_13_t* out)
    {
        return spark_decode_WRITE_PARAMETER_12_AND_13(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 14 and 15: Write Parameter 14 and 15 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_14_AND_15_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_14_AND_15_t* out)
    {
        return spark_decode_WRITE_PARAMETER_14_AND_15(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 16 and 17: Write Parameter 16 and 17 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_16_AND_17_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_16_AND_17_t* out)
    {
        return spark_decode_WRITE_PARAMETER_16_AND_17(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 18 and 19: Write Parameter 18 and 19 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_18_AND_19_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_18_AND_19_t* out)
    {
        return spark_decode_WRITE_PARAMETER_18_AND_19(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 20 and 21: Write Parameter 20 and 21 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_20_AND_21_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_20_AND_21_t* out)
    {
        return spark_decode_WRITE_PARAMETER_20_AND_21(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 22 and 23: Write Parameter 22 and 23 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_22_AND_23_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_22_AND_23_t* out)
    {
        return spark_decode_WRITE_PARAMETER_22_AND_23(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 24 and 25: Write Parameter 24 and 25 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_24_AND_25_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_24_AND_25_t* out)
    {
        return spark_decode_WRITE_PARAMETER_24_AND_25(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 26 and 27: Write Parameter 26 and 27 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_26_AND_27_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_26_AND_27_t* out)
    {
        return spark_decode_WRITE_PARAMETER_26_AND_27(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 28 and 29: Write Parameter 28 and 29 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_28_AND_29_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_28_AND_29_t* out)
    {
        return spark_decode_WRITE_PARAMETER_28_AND_29(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 30 and 31: Write Parameter 30 and 31 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_30_AND_31_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_30_AND_31_t* out)
    {
        return spark_decode_WRITE_PARAMETER_30_AND_31(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 32 and 33: Write Parameter 32 and 33 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_32_AND_33_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_32_AND_33_t* out)
    {
        return spark_decode_WRITE_PARAMETER_32_AND_33(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 34 and 35: Write Parameter 34 and 35 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_34_AND_35_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_34_AND_35_t* out)
    {
        return spark_decode_WRITE_PARAMETER_34_AND_35(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 36 and 37: Write Parameter 36 and 37 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_36_AND_37_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_36_AND_37_t* out)
    {
        return spark_decode_WRITE_PARAMETER_36_AND_37(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 38 and 39: Write Parameter 38 and 39 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_38_AND_39_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_38_AND_39_t* out)
    {
        return spark_decode_WRITE_PARAMETER_38_AND_39(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 40 and 41: Write Parameter 40 and 41 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_40_AND_41_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_40_AND_41_t* out)
    {
        return spark_decode_WRITE_PARAMETER_40_AND_41(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 42 and 43: Write Parameter 42 and 43 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_42_AND_43_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_42_AND_43_t* out)
    {
        return spark_decode_WRITE_PARAMETER_42_AND_43(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 44 and 45: Write Parameter 44 and 45 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_44_AND_45_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_44_AND_45_t* out)
    {
        return spark_decode_WRITE_PARAMETER_44_AND_45(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 46 and 47: Write Parameter 46 and 47 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_46_AND_47_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_46_AND_47_t* out)
    {
        return spark_decode_WRITE_PARAMETER_46_AND_47(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 48 and 49: Write Parameter 48 and 49 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_48_AND_49_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_48_AND_49_t* out)
    {
        return spark_decode_WRITE_PARAMETER_48_AND_49(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 50 and 51: Write Parameter 50 and 51 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_50_AND_51_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_50_AND_51_t* out)
    {
        return spark_decode_WRITE_PARAMETER_50_AND_51(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 52 and 53: Write Parameter 52 and 53 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_52_AND_53_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_52_AND_53_t* out)
    {
        return spark_decode_WRITE_PARAMETER_52_AND_53(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 54 and 55: Write Parameter 54 and 55 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_54_AND_55_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_54_AND_55_t* out)
    {
        return spark_decode_WRITE_PARAMETER_54_AND_55(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 56 and 57: Write Parameter 56 and 57 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_56_AND_57_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_56_AND_57_t* out)
    {
        return spark_decode_WRITE_PARAMETER_56_AND_57(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 58 and 59: Write Parameter 58 and 59 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_58_AND_59_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_58_AND_59_t* out)
    {
        return spark_decode_WRITE_PARAMETER_58_AND_59(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 60 and 61: Write Parameter 60 and 61 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_60_AND_61_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_60_AND_61_t* out)
    {
        return spark_decode_WRITE_PARAMETER_60_AND_61(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 62 and 63: Write Parameter 62 and 63 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_62_AND_63_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_62_AND_63_t* out)
    {
        return spark_decode_WRITE_PARAMETER_62_AND_63(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 64 and 65: Write Parameter 64 and 65 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_64_AND_65_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_64_AND_65_t* out)
    {
        return spark_decode_WRITE_PARAMETER_64_AND_65(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 66 and 67: Write Parameter 66 and 67 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_66_AND_67_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_66_AND_67_t* out)
    {
        return spark_decode_WRITE_PARAMETER_66_AND_67(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 68 and 69: Write Parameter 68 and 69 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_68_AND_69_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_68_AND_69_t* out)
    {
        return spark_decode_WRITE_PARAMETER_68_AND_69(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 70 and 71: Write Parameter 70 and 71 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_70_AND_71_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_70_AND_71_t* out)
    {
        return spark_decode_WRITE_PARAMETER_70_AND_71(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 72 and 73: Write Parameter 72 and 73 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_72_AND_73_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_72_AND_73_t* out)
    {
        return spark_decode_WRITE_PARAMETER_72_AND_73(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 74 and 75: Write Parameter 74 and 75 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_74_AND_75_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_74_AND_75_t* out)
    {
        return spark_decode_WRITE_PARAMETER_74_AND_75(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 76 and 77: Write Parameter 76 and 77 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_76_AND_77_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_76_AND_77_t* out)
    {
        return spark_decode_WRITE_PARAMETER_76_AND_77(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 78 and 79: Write Parameter 78 and 79 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_78_AND_79_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_78_AND_79_t* out)
    {
        return spark_decode_WRITE_PARAMETER_78_AND_79(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 80 and 81: Write Parameter 80 and 81 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_80_AND_81_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_80_AND_81_t* out)
    {
        return spark_decode_WRITE_PARAMETER_80_AND_81(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 82 and 83: Write Parameter 82 and 83 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_82_AND_83_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_82_AND_83_t* out)
    {
        return spark_decode_WRITE_PARAMETER_82_AND_83(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 84 and 85: Write Parameter 84 and 85 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_84_AND_85_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_84_AND_85_t* out)
    {
        return spark_decode_WRITE_PARAMETER_84_AND_85(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 86 and 87: Write Parameter 86 and 87 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_86_AND_87_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_86_AND_87_t* out)
    {
        return spark_decode_WRITE_PARAMETER_86_AND_87(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 88 and 89: Write Parameter 88 and 89 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_88_AND_89_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_88_AND_89_t* out)
    {
        return spark_decode_WRITE_PARAMETER_88_AND_89(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 90 and 91: Write Parameter 90 and 91 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_90_AND_91_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_90_AND_91_t* out)
    {
        return spark_decode_WRITE_PARAMETER_90_AND_91(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 92 and 93: Write Parameter 92 and 93 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_92_AND_93_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_92_AND_93_t* out)
    {
        return spark_decode_WRITE_PARAMETER_92_AND_93(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 94 and 95: Write Parameter 94 and 95 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_94_AND_95_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_94_AND_95_t* out)
    {
        return spark_decode_WRITE_PARAMETER_94_AND_95(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 96 and 97: Write Parameter 96 and 97 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_96_AND_97_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_96_AND_97_t* out)
    {
        return spark_decode_WRITE_PARAMETER_96_AND_97(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 98 and 99: Write Parameter 98 and 99 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_98_AND_99_frame(const spark_can_frame&             in,
                                                                    Spark_WRITE_PARAMETER_98_AND_99_t* out)
    {
        return spark_decode_WRITE_PARAMETER_98_AND_99(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 100 and 101: Write Parameter 100 and 101 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_100_AND_101_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_100_AND_101_t* out)
    {
        return spark_decode_WRITE_PARAMETER_100_AND_101(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 102 and 103: Write Parameter 102 and 103 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_102_AND_103_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_102_AND_103_t* out)
    {
        return spark_decode_WRITE_PARAMETER_102_AND_103(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 104 and 105: Write Parameter 104 and 105 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_104_AND_105_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_104_AND_105_t* out)
    {
        return spark_decode_WRITE_PARAMETER_104_AND_105(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 106 and 107: Write Parameter 106 and 107 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_106_AND_107_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_106_AND_107_t* out)
    {
        return spark_decode_WRITE_PARAMETER_106_AND_107(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 108 and 109: Write Parameter 108 and 109 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_108_AND_109_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_108_AND_109_t* out)
    {
        return spark_decode_WRITE_PARAMETER_108_AND_109(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 110 and 111: Write Parameter 110 and 111 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_110_AND_111_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_110_AND_111_t* out)
    {
        return spark_decode_WRITE_PARAMETER_110_AND_111(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 112 and 113: Write Parameter 112 and 113 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_112_AND_113_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_112_AND_113_t* out)
    {
        return spark_decode_WRITE_PARAMETER_112_AND_113(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 114 and 115: Write Parameter 114 and 115 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_114_AND_115_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_114_AND_115_t* out)
    {
        return spark_decode_WRITE_PARAMETER_114_AND_115(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 116 and 117: Write Parameter 116 and 117 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_116_AND_117_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_116_AND_117_t* out)
    {
        return spark_decode_WRITE_PARAMETER_116_AND_117(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 118 and 119: Write Parameter 118 and 119 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_118_AND_119_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_118_AND_119_t* out)
    {
        return spark_decode_WRITE_PARAMETER_118_AND_119(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 120 and 121: Write Parameter 120 and 121 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_120_AND_121_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_120_AND_121_t* out)
    {
        return spark_decode_WRITE_PARAMETER_120_AND_121(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 122 and 123: Write Parameter 122 and 123 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_122_AND_123_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_122_AND_123_t* out)
    {
        return spark_decode_WRITE_PARAMETER_122_AND_123(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 124 and 125: Write Parameter 124 and 125 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_124_AND_125_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_124_AND_125_t* out)
    {
        return spark_decode_WRITE_PARAMETER_124_AND_125(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 126 and 127: Write Parameter 126 and 127 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_126_AND_127_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_126_AND_127_t* out)
    {
        return spark_decode_WRITE_PARAMETER_126_AND_127(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 128 and 129: Write Parameter 128 and 129 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_128_AND_129_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_128_AND_129_t* out)
    {
        return spark_decode_WRITE_PARAMETER_128_AND_129(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 130 and 131: Write Parameter 130 and 131 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_130_AND_131_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_130_AND_131_t* out)
    {
        return spark_decode_WRITE_PARAMETER_130_AND_131(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 132 and 133: Write Parameter 132 and 133 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_132_AND_133_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_132_AND_133_t* out)
    {
        return spark_decode_WRITE_PARAMETER_132_AND_133(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 134 and 135: Write Parameter 134 and 135 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_134_AND_135_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_134_AND_135_t* out)
    {
        return spark_decode_WRITE_PARAMETER_134_AND_135(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 136 and 137: Write Parameter 136 and 137 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_136_AND_137_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_136_AND_137_t* out)
    {
        return spark_decode_WRITE_PARAMETER_136_AND_137(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 138 and 139: Write Parameter 138 and 139 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_138_AND_139_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_138_AND_139_t* out)
    {
        return spark_decode_WRITE_PARAMETER_138_AND_139(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 140 and 141: Write Parameter 140 and 141 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_140_AND_141_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_140_AND_141_t* out)
    {
        return spark_decode_WRITE_PARAMETER_140_AND_141(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 142 and 143: Write Parameter 142 and 143 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_142_AND_143_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_142_AND_143_t* out)
    {
        return spark_decode_WRITE_PARAMETER_142_AND_143(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 144 and 145: Write Parameter 144 and 145 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_144_AND_145_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_144_AND_145_t* out)
    {
        return spark_decode_WRITE_PARAMETER_144_AND_145(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 146 and 147: Write Parameter 146 and 147 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_146_AND_147_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_146_AND_147_t* out)
    {
        return spark_decode_WRITE_PARAMETER_146_AND_147(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 148 and 149: Write Parameter 148 and 149 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_148_AND_149_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_148_AND_149_t* out)
    {
        return spark_decode_WRITE_PARAMETER_148_AND_149(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 150 and 151: Write Parameter 150 and 151 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_150_AND_151_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_150_AND_151_t* out)
    {
        return spark_decode_WRITE_PARAMETER_150_AND_151(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 152 and 153: Write Parameter 152 and 153 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_152_AND_153_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_152_AND_153_t* out)
    {
        return spark_decode_WRITE_PARAMETER_152_AND_153(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 154 and 155: Write Parameter 154 and 155 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_154_AND_155_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_154_AND_155_t* out)
    {
        return spark_decode_WRITE_PARAMETER_154_AND_155(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 156 and 157: Write Parameter 156 and 157 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_156_AND_157_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_156_AND_157_t* out)
    {
        return spark_decode_WRITE_PARAMETER_156_AND_157(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 158 and 159: Write Parameter 158 and 159 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_158_AND_159_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_158_AND_159_t* out)
    {
        return spark_decode_WRITE_PARAMETER_158_AND_159(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 160 and 161: Write Parameter 160 and 161 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_160_AND_161_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_160_AND_161_t* out)
    {
        return spark_decode_WRITE_PARAMETER_160_AND_161(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 162 and 163: Write Parameter 162 and 163 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_162_AND_163_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_162_AND_163_t* out)
    {
        return spark_decode_WRITE_PARAMETER_162_AND_163(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 164 and 165: Write Parameter 164 and 165 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_164_AND_165_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_164_AND_165_t* out)
    {
        return spark_decode_WRITE_PARAMETER_164_AND_165(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 166 and 167: Write Parameter 166 and 167 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_166_AND_167_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_166_AND_167_t* out)
    {
        return spark_decode_WRITE_PARAMETER_166_AND_167(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 168 and 169: Write Parameter 168 and 169 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_168_AND_169_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_168_AND_169_t* out)
    {
        return spark_decode_WRITE_PARAMETER_168_AND_169(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 170 and 171: Write Parameter 170 and 171 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_170_AND_171_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_170_AND_171_t* out)
    {
        return spark_decode_WRITE_PARAMETER_170_AND_171(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 172 and 173: Write Parameter 172 and 173 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_172_AND_173_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_172_AND_173_t* out)
    {
        return spark_decode_WRITE_PARAMETER_172_AND_173(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 174 and 175: Write Parameter 174 and 175 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_174_AND_175_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_174_AND_175_t* out)
    {
        return spark_decode_WRITE_PARAMETER_174_AND_175(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 176 and 177: Write Parameter 176 and 177 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_176_AND_177_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_176_AND_177_t* out)
    {
        return spark_decode_WRITE_PARAMETER_176_AND_177(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 178 and 179: Write Parameter 178 and 179 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_178_AND_179_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_178_AND_179_t* out)
    {
        return spark_decode_WRITE_PARAMETER_178_AND_179(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 180 and 181: Write Parameter 180 and 181 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_180_AND_181_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_180_AND_181_t* out)
    {
        return spark_decode_WRITE_PARAMETER_180_AND_181(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 182 and 183: Write Parameter 182 and 183 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_182_AND_183_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_182_AND_183_t* out)
    {
        return spark_decode_WRITE_PARAMETER_182_AND_183(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 184 and 185: Write Parameter 184 and 185 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_184_AND_185_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_184_AND_185_t* out)
    {
        return spark_decode_WRITE_PARAMETER_184_AND_185(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 186 and 187: Write Parameter 186 and 187 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_186_AND_187_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_186_AND_187_t* out)
    {
        return spark_decode_WRITE_PARAMETER_186_AND_187(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 188 and 189: Write Parameter 188 and 189 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_188_AND_189_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_188_AND_189_t* out)
    {
        return spark_decode_WRITE_PARAMETER_188_AND_189(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 190 and 191: Write Parameter 190 and 191 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_190_AND_191_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_190_AND_191_t* out)
    {
        return spark_decode_WRITE_PARAMETER_190_AND_191(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 192 and 193: Write Parameter 192 and 193 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_192_AND_193_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_192_AND_193_t* out)
    {
        return spark_decode_WRITE_PARAMETER_192_AND_193(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 194 and 195: Write Parameter 194 and 195 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_194_AND_195_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_194_AND_195_t* out)
    {
        return spark_decode_WRITE_PARAMETER_194_AND_195(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 196 and 197: Write Parameter 196 and 197 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_196_AND_197_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_196_AND_197_t* out)
    {
        return spark_decode_WRITE_PARAMETER_196_AND_197(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 198 and 199: Write Parameter 198 and 199 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_198_AND_199_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_198_AND_199_t* out)
    {
        return spark_decode_WRITE_PARAMETER_198_AND_199(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 200 and 201: Write Parameter 200 and 201 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_200_AND_201_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_200_AND_201_t* out)
    {
        return spark_decode_WRITE_PARAMETER_200_AND_201(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 202 and 203: Write Parameter 202 and 203 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_202_AND_203_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_202_AND_203_t* out)
    {
        return spark_decode_WRITE_PARAMETER_202_AND_203(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 204 and 205: Write Parameter 204 and 205 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_204_AND_205_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_204_AND_205_t* out)
    {
        return spark_decode_WRITE_PARAMETER_204_AND_205(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 206 and 207: Write Parameter 206 and 207 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_206_AND_207_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_206_AND_207_t* out)
    {
        return spark_decode_WRITE_PARAMETER_206_AND_207(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 208 and 209: Write Parameter 208 and 209 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_208_AND_209_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_208_AND_209_t* out)
    {
        return spark_decode_WRITE_PARAMETER_208_AND_209(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 210 and 211: Write Parameter 210 and 211 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_210_AND_211_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_210_AND_211_t* out)
    {
        return spark_decode_WRITE_PARAMETER_210_AND_211(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 212 and 213: Write Parameter 212 and 213 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_212_AND_213_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_212_AND_213_t* out)
    {
        return spark_decode_WRITE_PARAMETER_212_AND_213(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 214 and 215: Write Parameter 214 and 215 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_214_AND_215_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_214_AND_215_t* out)
    {
        return spark_decode_WRITE_PARAMETER_214_AND_215(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 216 and 217: Write Parameter 216 and 217 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_216_AND_217_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_216_AND_217_t* out)
    {
        return spark_decode_WRITE_PARAMETER_216_AND_217(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 218 and 219: Write Parameter 218 and 219 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_218_AND_219_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_218_AND_219_t* out)
    {
        return spark_decode_WRITE_PARAMETER_218_AND_219(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 220 and 221: Write Parameter 220 and 221 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_220_AND_221_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_220_AND_221_t* out)
    {
        return spark_decode_WRITE_PARAMETER_220_AND_221(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 222 and 223: Write Parameter 222 and 223 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_222_AND_223_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_222_AND_223_t* out)
    {
        return spark_decode_WRITE_PARAMETER_222_AND_223(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 224 and 225: Write Parameter 224 and 225 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_224_AND_225_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_224_AND_225_t* out)
    {
        return spark_decode_WRITE_PARAMETER_224_AND_225(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 226 and 227: Write Parameter 226 and 227 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_226_AND_227_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_226_AND_227_t* out)
    {
        return spark_decode_WRITE_PARAMETER_226_AND_227(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 228 and 229: Write Parameter 228 and 229 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_228_AND_229_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_228_AND_229_t* out)
    {
        return spark_decode_WRITE_PARAMETER_228_AND_229(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 230 and 231: Write Parameter 230 and 231 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_230_AND_231_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_230_AND_231_t* out)
    {
        return spark_decode_WRITE_PARAMETER_230_AND_231(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 232 and 233: Write Parameter 232 and 233 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_232_AND_233_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_232_AND_233_t* out)
    {
        return spark_decode_WRITE_PARAMETER_232_AND_233(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 234 and 235: Write Parameter 234 and 235 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_234_AND_235_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_234_AND_235_t* out)
    {
        return spark_decode_WRITE_PARAMETER_234_AND_235(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 236 and 237: Write Parameter 236 and 237 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_236_AND_237_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_236_AND_237_t* out)
    {
        return spark_decode_WRITE_PARAMETER_236_AND_237(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 238 and 239: Write Parameter 238 and 239 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_238_AND_239_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_238_AND_239_t* out)
    {
        return spark_decode_WRITE_PARAMETER_238_AND_239(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 240 and 241: Write Parameter 240 and 241 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_240_AND_241_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_240_AND_241_t* out)
    {
        return spark_decode_WRITE_PARAMETER_240_AND_241(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 242 and 243: Write Parameter 242 and 243 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_242_AND_243_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_242_AND_243_t* out)
    {
        return spark_decode_WRITE_PARAMETER_242_AND_243(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 244 and 245: Write Parameter 244 and 245 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_244_AND_245_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_244_AND_245_t* out)
    {
        return spark_decode_WRITE_PARAMETER_244_AND_245(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 246 and 247: Write Parameter 246 and 247 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_246_AND_247_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_246_AND_247_t* out)
    {
        return spark_decode_WRITE_PARAMETER_246_AND_247(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 248 and 249: Write Parameter 248 and 249 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_248_AND_249_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_248_AND_249_t* out)
    {
        return spark_decode_WRITE_PARAMETER_248_AND_249(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 250 and 251: Write Parameter 250 and 251 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_250_AND_251_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_250_AND_251_t* out)
    {
        return spark_decode_WRITE_PARAMETER_250_AND_251(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 252 and 253: Write Parameter 252 and 253 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_252_AND_253_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_252_AND_253_t* out)
    {
        return spark_decode_WRITE_PARAMETER_252_AND_253(in.data, in.dlc, out);
    }

    // Frame values for Write Parameter 254 and 255: Write Parameter 254 and 255 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    typedef struct
    {
        // First Parameter Value: The actual type of this data depends on the Parameter Type of the parameter in
    ...
    static inline bool spark_decode_WRITE_PARAMETER_254_AND_255_frame(const spark_can_frame&               in,
                                                                      Spark_WRITE_PARAMETER_254_AND_255_t* out)
    {
        return spark_decode_WRITE_PARAMETER_254_AND_255(in.data, in.dlc, out);
    }

    // Frame values for Start Follower Mode: Starts follower mode. The relevant parameters must already be configured.
    // In response, a Start Follower Mode Response frame will be sent. Follower mode will be auto-started on boot if the
    // Follower Mode Leader ID parameter is set to a non-zero value.
    typedef struct
    {
        uint8_t _reserved0; // no payload fields
    ...
    static inline bool spark_decode_START_FOLLOWER_MODE_RESPONSE_frame(const spark_can_frame&                in,
                                                                       Spark_START_FOLLOWER_MODE_RESPONSE_t* out)
    {
        return spark_decode_START_FOLLOWER_MODE_RESPONSE(in.data, in.dlc, out);
    }

    // Frame values for Stop Follower Mode: Exits follower mode and causes the device to resume listening for setpoints
    // addressed directly to it. In response, a Stop Follower Mode Response frame will be sent.
    typedef struct
    {
        uint8_t _reserved0; // no payload fields
    ...
    // Frame values for Persist Parameters: Causes all parameters to be written to non-volatile storage. After the
    // operation (which may take up to a second) completes, a Persist Parameters Response frame will be sent.
    typedef struct
    {
        // Magic Number
        uint16_t MAGIC_NUMBER;
    ...
    static inline bool spark_decode_PERSIST_PARAMETERS_frame(const spark_can_frame& in, Spark_PERSIST_PARAMETERS_t* out)
    {
        return spark_decode_PERSIST_PARAMETERS(in.data, in.dlc, out);
    }
    ...
    // Build frame for Duty Cycle Setpoint: Sets the Control Type to Duty Cycle and sets the target duty cycle (from -1
    // to 1)
    ...
    // Build frame for MAXMotion Position Setpoint: Sets the Control Type to MAXMotion Position Control and sets the
    // target position
    ...
    // Build frame for MAXMotion Velocity Setpoint: Sets the Control Type to MAXMotion Velocity Control and sets the
    // target velocity
    ...
    // Build frame for Set Statuses Enabled: Enable or disable status frames. In response, a Set Statuses Enabled
    // Response frame will be sent.
    ...
    // Build frame for Reset Safe Parameters: Resets most writable parameters to their default values, except CAN ID,
    // Motor Type, Idle Mode, PWM Input Deadband, and Duty Cycle Offset. In response, a Reset Safe Parameters Response
    // frame is sent.
    ...
    // Build frame for Complete Factory Reset: Resets all writable parameters to default values, even CAN ID, Motor
    // Type, Idle Mode, PWM Input Deadband, and Duty Cycle Offset. In response, a Complete Factory Reset Response frame
    // is sent.
    ...
    // Build frame for Identify Unique SPARK: Makes the specified, single SPARK (even if there are multiple SPARKs that
    // have the same CAN ID) temporarily perform a special blink pattern that will make it stand out
    spark_can_frame spark_build_IDENTIFY_UNIQUE_SPARK(uint8_t device_id, const Spark_IDENTIFY_UNIQUE_SPARK_t* values);

    // Build frame for Identify: Makes the SPARK temporarily perform a special blink pattern that will make it stand
    // out. Use Identify Unique Device if there may be multiple SPARKs with the same CAN ID.
    spark_can_frame spark_build_IDENTIFY(uint8_t device_id, const Spark_IDENTIFY_t* values);

    // Build frame for Nack: As of SPARK MAX firmware 1.6.3, this is only used as a potential response to setting the
    // CAN ID
    spark_can_frame spark_build_NACK(uint8_t device_id, const Spark_NACK_t* values);

    // Build frame for Ack: As of SPARK MAX firmware 1.6.3, this is only used as a potential response to setting the CAN
    // ID
    ...
    // Build frame for Set CAN ID: Allows changing the CAN ID when multiple devices on the bus currently have the same
    // CAN ID. Under normal circumstances, the CAN ID parameter can be used.
    ...
    // Build frame for SWDL Data: Broadcast from the host to all SPARKs in SWDL mode, containing a slice of firmware
    // data
    spark_can_frame spark_build_SWDL_DATA(uint8_t device_id, const Spark_SWDL_DATA_t* values);

    // Build frame for SWDL Checksum: Broadcast from the host to all SPARKs in SWDL mode, containing the checksum of the
    // full firmware image that was just sent
    spark_can_frame spark_build_SWDL_CHECKSUM(uint8_t device_id, const Spark_SWDL_CHECKSUM_t* values);

    // Build frame for SWDL Retransmit: Sent by SPARK devices in response to receiving an SWDL Checksum frame that does
    // not match the firmware data they received
    ...
    // Build frame for Secondary Heartbeat: Heartbeat that allows enabling only specific SPARKs, but only gets respected
    ...
    // Build frame for USB Only Identify: The response will only be sent if this command is received directly via USB.
    // This has no relation to the normal Identify command, which displays an LED pattern.
    spark_can_frame spark_build_USB_ONLY_IDENTIFY(uint8_t device_id, const Spark_USB_ONLY_IDENTIFY_t* values);

    // Build frame for USB Only Enter DFU Bootloader: Causes the device to reboot into the DFU bootloader if this
    // command is received directly via USB
    ...
    // Build frame for Write Parameter 102 and 103: Write Parameter 102 and 103 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 104 and 105: Write Parameter 104 and 105 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 106 and 107: Write Parameter 106 and 107 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 108 and 109: Write Parameter 108 and 109 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 110 and 111: Write Parameter 110 and 111 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 112 and 113: Write Parameter 112 and 113 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 114 and 115: Write Parameter 114 and 115 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 116 and 117: Write Parameter 116 and 117 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 118 and 119: Write Parameter 118 and 119 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 120 and 121: Write Parameter 120 and 121 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 122 and 123: Write Parameter 122 and 123 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 124 and 125: Write Parameter 124 and 125 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 126 and 127: Write Parameter 126 and 127 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 128 and 129: Write Parameter 128 and 129 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 130 and 131: Write Parameter 130 and 131 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 132 and 133: Write Parameter 132 and 133 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 134 and 135: Write Parameter 134 and 135 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 136 and 137: Write Parameter 136 and 137 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 138 and 139: Write Parameter 138 and 139 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 140 and 141: Write Parameter 140 and 141 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 142 and 143: Write Parameter 142 and 143 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 144 and 145: Write Parameter 144 and 145 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 146 and 147: Write Parameter 146 and 147 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 148 and 149: Write Parameter 148 and 149 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 150 and 151: Write Parameter 150 and 151 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 152 and 153: Write Parameter 152 and 153 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 154 and 155: Write Parameter 154 and 155 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 156 and 157: Write Parameter 156 and 157 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 158 and 159: Write Parameter 158 and 159 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 160 and 161: Write Parameter 160 and 161 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 162 and 163: Write Parameter 162 and 163 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 164 and 165: Write Parameter 164 and 165 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 166 and 167: Write Parameter 166 and 167 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 168 and 169: Write Parameter 168 and 169 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 170 and 171: Write Parameter 170 and 171 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 172 and 173: Write Parameter 172 and 173 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 174 and 175: Write Parameter 174 and 175 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 176 and 177: Write Parameter 176 and 177 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 178 and 179: Write Parameter 178 and 179 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 180 and 181: Write Parameter 180 and 181 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 182 and 183: Write Parameter 182 and 183 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 184 and 185: Write Parameter 184 and 185 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 186 and 187: Write Parameter 186 and 187 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 188 and 189: Write Parameter 188 and 189 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 190 and 191: Write Parameter 190 and 191 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 192 and 193: Write Parameter 192 and 193 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 194 and 195: Write Parameter 194 and 195 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 196 and 197: Write Parameter 196 and 197 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 198 and 199: Write Parameter 198 and 199 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 200 and 201: Write Parameter 200 and 201 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 202 and 203: Write Parameter 202 and 203 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 204 and 205: Write Parameter 204 and 205 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 206 and 207: Write Parameter 206 and 207 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 208 and 209: Write Parameter 208 and 209 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 210 and 211: Write Parameter 210 and 211 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 212 and 213: Write Parameter 212 and 213 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 214 and 215: Write Parameter 214 and 215 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 216 and 217: Write Parameter 216 and 217 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 218 and 219: Write Parameter 218 and 219 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 220 and 221: Write Parameter 220 and 221 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 222 and 223: Write Parameter 222 and 223 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 224 and 225: Write Parameter 224 and 225 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 226 and 227: Write Parameter 226 and 227 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 228 and 229: Write Parameter 228 and 229 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 230 and 231: Write Parameter 230 and 231 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 232 and 233: Write Parameter 232 and 233 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 234 and 235: Write Parameter 234 and 235 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 236 and 237: Write Parameter 236 and 237 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 238 and 239: Write Parameter 238 and 239 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 240 and 241: Write Parameter 240 and 241 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 242 and 243: Write Parameter 242 and 243 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 244 and 245: Write Parameter 244 and 245 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 246 and 247: Write Parameter 246 and 247 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 248 and 249: Write Parameter 248 and 249 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 250 and 251: Write Parameter 250 and 251 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 252 and 253: Write Parameter 252 and 253 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Write Parameter 254 and 255: Write Parameter 254 and 255 at the same time. Two Write Parameter
    // Response frames will be sent in response.
    ...
    // Build frame for Start Follower Mode: Starts follower mode. The relevant parameters must already be configured. In
    // response, a Start Follower Mode Response frame will be sent. Follower mode will be auto-started on boot if the
    // Follower Mode Leader ID parameter is set to a non-zero value.
    ...
    // Build frame for Stop Follower Mode: Exits follower mode and causes the device to resume listening for setpoints
    // addressed directly to it. In response, a Stop Follower Mode Response frame will be sent.
    ...
    // Build frame for Persist Parameters: Causes all parameters to be written to non-volatile storage. After the
    // operation (which may take up to a second) completes, a Persist Parameters Response frame will be sent.
